...
var (
	...
	fd_EventUpdateCurator_name protoreflect.FieldDescriptor
)

func init() {
	file_regen_ecocredit_basket_v1_events_proto_init()
	md_EventUpdateCurator = File_regen_ecocredit_basket_v1_events_proto.Messages().ByName("EventUpdateCurator")
	fd_EventUpdateCurator_name = md_EventUpdateCurator.Fields().ByName("name")
}
...
func (x *fastReflection_EventUpdateCurator) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.Name != "" {
		...
		if !f(fd_EventUpdateCurator_name, value) {
			return
		}
	}
}
...
func (x *fastReflection_EventUpdateCurator) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "regen.ecocredit.basket.v1.EventUpdateCurator.name":
		return x.Name != ""
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_EventUpdateCurator) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "regen.ecocredit.basket.v1.EventUpdateCurator.name":
		panic(fmt.Errorf("field name of message regen.ecocredit.basket.v1.EventUpdateCurator is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: regen.ecocredit.basket.v1.EventUpdateCurator"))
		}
...
func (x *EventUpdateCurator) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
var file_regen_ecocredit_basket_v1_events_proto_rawDesc = []byte{
	...
	0x09, 0x42, 0x02, 0x18, 0x01, 0x52, 0x06, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x22, 0x28, 0x0a,
	...
	0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x42, 0x81, 0x02, 0x0a, 0x1d, 0x63, 0x6f, 0x6d, 0x2e,
	0x72, 0x65, 0x67, 0x65, 0x6e, 0x2e, 0x65, 0x63, 0x6f, 0x63, 0x72, 0x65, 0x64, 0x69, 0x74, 0x2e,
	0x62, 0x61, 0x73, 0x6b, 0x65, 0x74, 0x2e, 0x76, 0x31, 0x42, 0x0b, 0x45, 0x76, 0x65, 0x6e, 0x74,
