...
func (x *fastReflection_BasketFee) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "regen.ecocredit.basket.v1.BasketFee.denom":
		return x.Denom != ""
	case "regen.ecocredit.basket.v1.BasketFee.amount":
		return x.Amount != ""
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_BasketFee) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "regen.ecocredit.basket.v1.BasketFee.denom":
		panic(fmt.Errorf("field denom of message regen.ecocredit.basket.v1.BasketFee is not mutable"))
	case "regen.ecocredit.basket.v1.BasketFee.amount":
		panic(fmt.Errorf("field amount of message regen.ecocredit.basket.v1.BasketFee is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: regen.ecocredit.basket.v1.BasketFee"))
		}
...
var file_regen_ecocredit_basket_v1_state_proto_rawDesc = []byte{
	...
	0x5f, 0x64, 0x61, 0x74, 0x65, 0x10, 0x01, 0x18, 0x03, 0x22, 0x4c, 0x0a, 0x09, 0x42, 0x61, 0x73,
	0x6b, 0x65, 0x74, 0x46, 0x65, 0x65, 0x12, 0x14, 0x0a, 0x05, 0x64, 0x65, 0x6e, 0x6f, 0x6d, 0x18,
	...
	0x64, 0x65, 0x6e, 0x6f, 0x6d, 0x18, 0x0e, 0x42, 0x80, 0x02, 0x0a, 0x1d, 0x63, 0x6f, 0x6d, 0x2e,
