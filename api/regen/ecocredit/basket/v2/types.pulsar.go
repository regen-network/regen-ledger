...
func init() {
	...
	md_BasketCredit = File_regen_ecocredit_basket_v2_types_proto.Messages().ByName("BasketCredit")
...
func (x *BasketCredit) slowProtoReflect() protoreflect.Message {
	mi := &file_regen_ecocredit_basket_v2_types_proto_msgTypes[0]
...
func (x *fastReflection_BasketCredit) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "regen.ecocredit.basket.v2.BasketCredit.batch_denom":
		return x.BatchDenom != ""
	case "regen.ecocredit.basket.v2.BasketCredit.amount":
		return x.Amount != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: regen.ecocredit.basket.v2.BasketCredit"))
		}
		panic(fmt.Errorf("message regen.ecocredit.basket.v2.BasketCredit does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_BasketCredit) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message regen.ecocredit.basket.v2.BasketCredit does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_BasketCredit) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "regen.ecocredit.basket.v2.BasketCredit.batch_denom":
		panic(fmt.Errorf("field batch_denom of message regen.ecocredit.basket.v2.BasketCredit is not mutable"))
	case "regen.ecocredit.basket.v2.BasketCredit.amount":
		panic(fmt.Errorf("field amount of message regen.ecocredit.basket.v2.BasketCredit is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: regen.ecocredit.basket.v2.BasketCredit"))
		}
...
func (x *fastReflection_BasketCredit) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in regen.ecocredit.basket.v2.BasketCredit", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_regen_ecocredit_basket_v2_types_proto_init()
	md_DateCriteria = File_regen_ecocredit_basket_v2_types_proto.Messages().ByName("DateCriteria")
...
func (x *DateCriteria) slowProtoReflect() protoreflect.Message {
	mi := &file_regen_ecocredit_basket_v2_types_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_DateCriteria) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "regen.ecocredit.basket.v2.DateCriteria.min_start_date":
		return x.MinStartDate != nil
	case "regen.ecocredit.basket.v2.DateCriteria.start_date_window":
		return x.StartDateWindow != nil
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: regen.ecocredit.basket.v2.DateCriteria"))
		}
		panic(fmt.Errorf("message regen.ecocredit.basket.v2.DateCriteria does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_DateCriteria) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message regen.ecocredit.basket.v2.DateCriteria does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_DateCriteria) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in regen.ecocredit.basket.v2.DateCriteria", d.FullName()))
	}
	panic("unreachable")
}
...
func (*BasketCredit) Descriptor() ([]byte, []int) {
	return file_regen_ecocredit_basket_v2_types_proto_rawDescGZIP(), []int{0}
}
...
func (*DateCriteria) Descriptor() ([]byte, []int) {
	return file_regen_ecocredit_basket_v2_types_proto_rawDescGZIP(), []int{1}
}
...
var File_regen_ecocredit_basket_v2_types_proto protoreflect.FileDescriptor

var file_regen_ecocredit_basket_v2_types_proto_rawDesc = []byte{
	0x0a, 0x25, 0x72, 0x65, 0x67, 0x65, 0x6e, 0x2f, 0x65, 0x63, 0x6f, 0x63, 0x72, 0x65, 0x64, 0x69,
	0x74, 0x2f, 0x62, 0x61, 0x73, 0x6b, 0x65, 0x74, 0x2f, 0x76, 0x32, 0x2f, 0x74, 0x79, 0x70, 0x65,
	...
	0x61, 0x73, 0x6b, 0x65, 0x74, 0x2e, 0x76, 0x32, 0x42, 0x0a, 0x54, 0x79, 0x70, 0x65, 0x73, 0x50,
	...
	0x74, 0x2f, 0x62, 0x61, 0x73, 0x6b, 0x65, 0x74, 0x2f, 0x76, 0x32, 0x3b, 0x62, 0x61, 0x73, 0x6b,
	0x65, 0x74, 0x76, 0x32, 0xa2, 0x02, 0x03, 0x52, 0x45, 0x42, 0xaa, 0x02, 0x19, 0x52, 0x65, 0x67,
	0x65, 0x6e, 0x2e, 0x45, 0x63, 0x6f, 0x63, 0x72, 0x65, 0x64, 0x69, 0x74, 0x2e, 0x42, 0x61, 0x73,
	0x6b, 0x65, 0x74, 0x2e, 0x56, 0x32, 0xca, 0x02, 0x19, 0x52, 0x65, 0x67, 0x65, 0x6e, 0x5c, 0x45,
	0x63, 0x6f, 0x63, 0x72, 0x65, 0x64, 0x69, 0x74, 0x5c, 0x42, 0x61, 0x73, 0x6b, 0x65, 0x74, 0x5c,
	0x56, 0x32, 0xe2, 0x02, 0x25, 0x52, 0x65, 0x67, 0x65, 0x6e, 0x5c, 0x45, 0x63, 0x6f, 0x63, 0x72,
	0x65, 0x64, 0x69, 0x74, 0x5c, 0x42, 0x61, 0x73, 0x6b, 0x65, 0x74, 0x5c, 0x56, 0x32, 0x5c, 0x47,
	...
	0x61, 0x73, 0x6b, 0x65, 0x74, 0x3a, 0x3a, 0x56, 0x32, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x33,
}

var (
	file_regen_ecocredit_basket_v2_types_proto_rawDescOnce sync.Once
	file_regen_ecocredit_basket_v2_types_proto_rawDescData = file_regen_ecocredit_basket_v2_types_proto_rawDesc
)

func file_regen_ecocredit_basket_v2_types_proto_rawDescGZIP() []byte {
	file_regen_ecocredit_basket_v2_types_proto_rawDescOnce.Do(func() {
		file_regen_ecocredit_basket_v2_types_proto_rawDescData = protoimpl.X.CompressGZIP(file_regen_ecocredit_basket_v2_types_proto_rawDescData)
	})
	return file_regen_ecocredit_basket_v2_types_proto_rawDescData
}

var file_regen_ecocredit_basket_v2_types_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_regen_ecocredit_basket_v2_types_proto_goTypes = []interface{}{
	(*BasketCredit)(nil),          // 0: regen.ecocredit.basket.v2.BasketCredit
	(*DateCriteria)(nil),          // 1: regen.ecocredit.basket.v2.DateCriteria
	(*timestamppb.Timestamp)(nil), // 2: google.protobuf.Timestamp
	(*durationpb.Duration)(nil),   // 3: google.protobuf.Duration
}
var file_regen_ecocredit_basket_v2_types_proto_depIdxs = []int32{
	2, // 0: regen.ecocredit.basket.v2.DateCriteria.min_start_date:type_name -> google.protobuf.Timestamp
	3, // 1: regen.ecocredit.basket.v2.DateCriteria.start_date_window:type_name -> google.protobuf.Duration
...
func init() { file_regen_ecocredit_basket_v2_types_proto_init() }
func file_regen_ecocredit_basket_v2_types_proto_init() {
	if File_regen_ecocredit_basket_v2_types_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_regen_ecocredit_basket_v2_types_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_regen_ecocredit_basket_v2_types_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_regen_ecocredit_basket_v2_types_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_regen_ecocredit_basket_v2_types_proto_goTypes,
		DependencyIndexes: file_regen_ecocredit_basket_v2_types_proto_depIdxs,
		MessageInfos:      file_regen_ecocredit_basket_v2_types_proto_msgTypes,
	}.Build()
	File_regen_ecocredit_basket_v2_types_proto = out.File
	file_regen_ecocredit_basket_v2_types_proto_rawDesc = nil
	file_regen_ecocredit_basket_v2_types_proto_goTypes = nil
	file_regen_ecocredit_basket_v2_types_proto_depIdxs = nil
}
