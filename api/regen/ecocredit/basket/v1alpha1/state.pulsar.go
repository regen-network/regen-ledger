...
var (
	...
	fd_Basket_credit_type_name    protoreflect.FieldDescriptor
	fd_Basket_min_start_date      protoreflect.FieldDescriptor
	fd_Basket_multiplier          protoreflect.FieldDescriptor
)

func init() {
	file_regen_ecocredit_basket_v1alpha1_state_proto_init()
	md_Basket = File_regen_ecocredit_basket_v1alpha1_state_proto.Messages().ByName("Basket")
	...
	fd_Basket_credit_type_name = md_Basket.Fields().ByName("credit_type_name")
	fd_Basket_min_start_date = md_Basket.Fields().ByName("min_start_date")
	fd_Basket_multiplier = md_Basket.Fields().ByName("multiplier")
}
...
func (x *Basket) slowProtoReflect() protoreflect.Message {
	mi := &file_regen_ecocredit_basket_v1alpha1_state_proto_msgTypes[0]
...
func (x *fastReflection_Basket) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "regen.ecocredit.basket.v1alpha1.Basket.basket_denom":
		return x.BasketDenom != ""
	case "regen.ecocredit.basket.v1alpha1.Basket.disable_auto_retire":
		return x.DisableAutoRetire != false
	case "regen.ecocredit.basket.v1alpha1.Basket.credit_type_name":
		return x.CreditTypeName != ""
	case "regen.ecocredit.basket.v1alpha1.Basket.min_start_date":
		return x.MinStartDate != nil
	case "regen.ecocredit.basket.v1alpha1.Basket.multiplier":
		return x.Multiplier != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: regen.ecocredit.basket.v1alpha1.Basket"))
		}
		panic(fmt.Errorf("message regen.ecocredit.basket.v1alpha1.Basket does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Basket) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message regen.ecocredit.basket.v1alpha1.Basket does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Basket) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "regen.ecocredit.basket.v1alpha1.Basket.basket_denom":
		panic(fmt.Errorf("field basket_denom of message regen.ecocredit.basket.v1alpha1.Basket is not mutable"))
	case "regen.ecocredit.basket.v1alpha1.Basket.disable_auto_retire":
		panic(fmt.Errorf("field disable_auto_retire of message regen.ecocredit.basket.v1alpha1.Basket is not mutable"))
	case "regen.ecocredit.basket.v1alpha1.Basket.credit_type_name":
		panic(fmt.Errorf("field credit_type_name of message regen.ecocredit.basket.v1alpha1.Basket is not mutable"))
	case "regen.ecocredit.basket.v1alpha1.Basket.multiplier":
		panic(fmt.Errorf("field multiplier of message regen.ecocredit.basket.v1alpha1.Basket is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: regen.ecocredit.basket.v1alpha1.Basket"))
		}
...
func (x *fastReflection_Basket) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in regen.ecocredit.basket.v1alpha1.Basket", d.FullName()))
	}
	panic("unreachable")
}
...
var (
	...
	fd_BasketClass_basket_denom protoreflect.FieldDescriptor
	fd_BasketClass_class_id     protoreflect.FieldDescriptor
)

func init() {
	file_regen_ecocredit_basket_v1alpha1_state_proto_init()
	md_BasketClass = File_regen_ecocredit_basket_v1alpha1_state_proto.Messages().ByName("BasketClass")
	fd_BasketClass_basket_denom = md_BasketClass.Fields().ByName("basket_denom")
...
func (x *BasketClass) slowProtoReflect() protoreflect.Message {
	mi := &file_regen_ecocredit_basket_v1alpha1_state_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_BasketClass) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.BasketDenom != "" {
		value := protoreflect.ValueOfString(x.BasketDenom)
		if !f(fd_BasketClass_basket_denom, value) {
			return
		}
	}
	if x.ClassId != "" {
...
func (x *fastReflection_BasketClass) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "regen.ecocredit.basket.v1alpha1.BasketClass.basket_denom":
		return x.BasketDenom != ""
	case "regen.ecocredit.basket.v1alpha1.BasketClass.class_id":
		return x.ClassId != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: regen.ecocredit.basket.v1alpha1.BasketClass"))
		}
		panic(fmt.Errorf("message regen.ecocredit.basket.v1alpha1.BasketClass does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_BasketClass) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message regen.ecocredit.basket.v1alpha1.BasketClass does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_BasketClass) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "regen.ecocredit.basket.v1alpha1.BasketClass.basket_denom":
		panic(fmt.Errorf("field basket_denom of message regen.ecocredit.basket.v1alpha1.BasketClass is not mutable"))
	case "regen.ecocredit.basket.v1alpha1.BasketClass.class_id":
		panic(fmt.Errorf("field class_id of message regen.ecocredit.basket.v1alpha1.BasketClass is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: regen.ecocredit.basket.v1alpha1.BasketClass"))
		}
...
func (x *fastReflection_BasketClass) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in regen.ecocredit.basket.v1alpha1.BasketClass", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_regen_ecocredit_basket_v1alpha1_state_proto_init()
	md_BasketBalance = File_regen_ecocredit_basket_v1alpha1_state_proto.Messages().ByName("BasketBalance")
...
func (x *BasketBalance) slowProtoReflect() protoreflect.Message {
	mi := &file_regen_ecocredit_basket_v1alpha1_state_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_BasketBalance) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "regen.ecocredit.basket.v1alpha1.BasketBalance.basket_denom":
		return x.BasketDenom != ""
	case "regen.ecocredit.basket.v1alpha1.BasketBalance.batch_denom":
		return x.BatchDenom != ""
	case "regen.ecocredit.basket.v1alpha1.BasketBalance.balance":
		return x.Balance != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: regen.ecocredit.basket.v1alpha1.BasketBalance"))
		}
		panic(fmt.Errorf("message regen.ecocredit.basket.v1alpha1.BasketBalance does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_BasketBalance) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message regen.ecocredit.basket.v1alpha1.BasketBalance does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_BasketBalance) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "regen.ecocredit.basket.v1alpha1.BasketBalance.basket_denom":
		panic(fmt.Errorf("field basket_denom of message regen.ecocredit.basket.v1alpha1.BasketBalance is not mutable"))
	case "regen.ecocredit.basket.v1alpha1.BasketBalance.batch_denom":
		panic(fmt.Errorf("field batch_denom of message regen.ecocredit.basket.v1alpha1.BasketBalance is not mutable"))
	case "regen.ecocredit.basket.v1alpha1.BasketBalance.balance":
		panic(fmt.Errorf("field balance of message regen.ecocredit.basket.v1alpha1.BasketBalance is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: regen.ecocredit.basket.v1alpha1.BasketBalance"))
		}
...
func (x *fastReflection_BasketBalance) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in regen.ecocredit.basket.v1alpha1.BasketBalance", d.FullName()))
	}
	panic("unreachable")
}
...
func (*Basket) Descriptor() ([]byte, []int) {
	return file_regen_ecocredit_basket_v1alpha1_state_proto_rawDescGZIP(), []int{0}
}
...
func (x *Basket) GetMinStartDate() *timestamppb.Timestamp {
	if x != nil {
...
func (x *Basket) GetMultiplier() string {
	if x != nil {
		return x.Multiplier
	}
	return ""
...
func (*BasketClass) Descriptor() ([]byte, []int) {
	return file_regen_ecocredit_basket_v1alpha1_state_proto_rawDescGZIP(), []int{1}
}

func (x *BasketClass) GetBasketDenom() string {
	if x != nil {
		return x.BasketDenom
	}
	return ""
...
func (*BasketBalance) Descriptor() ([]byte, []int) {
	return file_regen_ecocredit_basket_v1alpha1_state_proto_rawDescGZIP(), []int{2}
}
...
var File_regen_ecocredit_basket_v1alpha1_state_proto protoreflect.FileDescriptor

var file_regen_ecocredit_basket_v1alpha1_state_proto_rawDesc = []byte{
	...
	0x31, 0x2f, 0x73, 0x74, 0x61, 0x74, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x1f, 0x72,
	0x65, 0x67, 0x65, 0x6e, 0x2e, 0x65, 0x63, 0x6f, 0x63, 0x72, 0x65, 0x64, 0x69, 0x74, 0x2e, 0x62,
	0x61, 0x73, 0x6b, 0x65, 0x74, 0x2e, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x31, 0x1a, 0x1d,
	...
	,
	...
	,
	...
	0x42, 0x0a, 0x53, 0x74, 0x61, 0x74, 0x65, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x58,
	...
	,
}

var (
	file_regen_ecocredit_basket_v1alpha1_state_proto_rawDescOnce sync.Once
	file_regen_ecocredit_basket_v1alpha1_state_proto_rawDescData = file_regen_ecocredit_basket_v1alpha1_state_proto_rawDesc
)

func file_regen_ecocredit_basket_v1alpha1_state_proto_rawDescGZIP() []byte {
	file_regen_ecocredit_basket_v1alpha1_state_proto_rawDescOnce.Do(func() {
		file_regen_ecocredit_basket_v1alpha1_state_proto_rawDescData = protoimpl.X.CompressGZIP(file_regen_ecocredit_basket_v1alpha1_state_proto_rawDescData)
	})
	return file_regen_ecocredit_basket_v1alpha1_state_proto_rawDescData
}

var file_regen_ecocredit_basket_v1alpha1_state_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_regen_ecocredit_basket_v1alpha1_state_proto_goTypes = []interface{}{
	(*Basket)(nil),                // 0: regen.ecocredit.basket.v1alpha1.Basket
	(*BasketClass)(nil),           // 1: regen.ecocredit.basket.v1alpha1.BasketClass
	(*BasketBalance)(nil),         // 2: regen.ecocredit.basket.v1alpha1.BasketBalance
	(*timestamppb.Timestamp)(nil), // 3: google.protobuf.Timestamp
}
var file_regen_ecocredit_basket_v1alpha1_state_proto_depIdxs = []int32{
	3, // 0: regen.ecocredit.basket.v1alpha1.Basket.min_start_date:type_name -> google.protobuf.Timestamp
...
func init() { file_regen_ecocredit_basket_v1alpha1_state_proto_init() }
func file_regen_ecocredit_basket_v1alpha1_state_proto_init() {
	if File_regen_ecocredit_basket_v1alpha1_state_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_regen_ecocredit_basket_v1alpha1_state_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Basket); i {
			case 0:
				return &v.state
			case 1:
		...
		file_regen_ecocredit_basket_v1alpha1_state_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_regen_ecocredit_basket_v1alpha1_state_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_regen_ecocredit_basket_v1alpha1_state_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_regen_ecocredit_basket_v1alpha1_state_proto_goTypes,
		DependencyIndexes: file_regen_ecocredit_basket_v1alpha1_state_proto_depIdxs,
		MessageInfos:      file_regen_ecocredit_basket_v1alpha1_state_proto_msgTypes,
	}.Build()
	File_regen_ecocredit_basket_v1alpha1_state_proto = out.File
	file_regen_ecocredit_basket_v1alpha1_state_proto_rawDesc = nil
	file_regen_ecocredit_basket_v1alpha1_state_proto_goTypes = nil
	file_regen_ecocredit_basket_v1alpha1_state_proto_depIdxs = nil
}
