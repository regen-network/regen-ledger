...
func (x *fastReflection_BasketCredit) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "regen.ecocredit.basket.v1alpha1.BasketCredit.batch_denom":
		return x.BatchDenom != ""
	case "regen.ecocredit.basket.v1alpha1.BasketCredit.tradable_amount":
...
func (x *fastReflection_BasketCredit) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "regen.ecocredit.basket.v1alpha1.BasketCredit.tradable_amount":
		panic(fmt.Errorf("field tradable_amount of message regen.ecocredit.basket.v1alpha1.BasketCredit is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: regen.ecocredit.basket.v1alpha1.BasketCredit"))
		}
...
var file_regen_ecocredit_basket_v1alpha1_types_proto_rawDesc = []byte{
	...
	0x61, 0x73, 0x6b, 0x65, 0x74, 0x2e, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x31, 0x22, 0x58,
	...
	0x6c, 0x65, 0x41, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x42, 0xaa, 0x02, 0x0a, 0x23, 0x63, 0x6f, 0x6d,
	...
	0x42, 0x0a, 0x54, 0x79, 0x70, 0x65, 0x73, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x58,
