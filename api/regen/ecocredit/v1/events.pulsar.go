...
var (
	...
	fd_EventBurnRegen_from   protoreflect.FieldDescriptor
...
func init() {
	...
	fd_EventBurnRegen_from = md_EventBurnRegen.Fields().ByName("from")
...
func (x *fastReflection_EventBurnRegen) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.From != "" {
		...
		if !f(fd_EventBurnRegen_from, value) {
			return
		}
	}
	if x.Amount != "" {
...
func (x *fastReflection_EventBurnRegen) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "regen.ecocredit.v1.EventBurnRegen.from":
		return x.From != ""
...
func (x *fastReflection_EventBurnRegen) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "regen.ecocredit.v1.EventBurnRegen.from":
		panic(fmt.Errorf("field from of message regen.ecocredit.v1.EventBurnRegen is not mutable"))
	case "regen.ecocredit.v1.EventBurnRegen.amount":
...
type EventBurnRegen struct {
	...
	// from is the address that burned REGEN.
...
func (x *EventBurnRegen) GetFrom() string {
	if x != nil {
		return x.From
	}
	return ""
...
var file_regen_ecocredit_v1_events_proto_rawDesc = []byte{
	...
	0x6e, 0x54, 0x78, 0x22, 0x54, 0x0a, 0x0e, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x42, 0x75, 0x72, 0x6e,
	0x52, 0x65, 0x67, 0x65, 0x6e, 0x12, 0x12, 0x0a, 0x04, 0x66, 0x72, 0x6f, 0x6d, 0x18, 0x01, 0x20,
	...
	0x09, 0x52, 0x06, 0x72, 0x65, 0x61, 0x73, 0x6f, 0x6e, 0x42, 0xd9, 0x01, 0x0a, 0x16, 0x63, 0x6f,
	0x6d, 0x2e, 0x72, 0x65, 0x67, 0x65, 0x6e, 0x2e, 0x65, 0x63, 0x6f, 0x63, 0x72, 0x65, 0x64, 0x69,
	0x74, 0x2e, 0x76, 0x31, 0x42, 0x0b, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x73, 0x50, 0x72, 0x6f, 0x74,
