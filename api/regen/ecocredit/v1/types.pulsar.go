...
var (
	...
	fd_Params_allowed_ask_denoms     protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_Params_allowed_ask_denoms = md_Params.Fields().ByName("allowed_ask_denoms")
}
...
func (x *fastReflection_Params) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if len(x.AllowedAskDenoms) != 0 {
		value := protoreflect.ValueOfList(&_Params_6_list{list: &x.AllowedAskDenoms})
		if !f(fd_Params_allowed_ask_denoms, value) {
			return
		}
	}
}
...
func (x *fastReflection_Params) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "regen.ecocredit.v1.Params.allowed_ask_denoms":
		return len(x.AllowedAskDenoms) != 0
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_Params) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "regen.ecocredit.v1.Params.allowed_ask_denoms":
		...
		listValue := &_Params_6_list{list: &x.AllowedAskDenoms}
		return protoreflect.ValueOfList(listValue)
	default:
...
func (x *fastReflection_Params) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "regen.ecocredit.v1.Params.credit_types":
		...
		return protoreflect.ValueOfList(value)
	case "regen.ecocredit.v1.Params.allowed_ask_denoms":
		if x.AllowedAskDenoms == nil {
			x.AllowedAskDenoms = []*AskDenom{}
		}
		value := &_Params_6_list{list: &x.AllowedAskDenoms}
		return protoreflect.ValueOfList(value)
	case "regen.ecocredit.v1.Params.allowlist_enabled":
...
func (x *fastReflection_Params) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		...
		if len(x.AllowedAskDenoms) > 0 {
			for _, e := range x.AllowedAskDenoms {
				l = options.Size(e)
				n += 1 + l + runtime.Sov(uint64(l))
			}
		}
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.AllowedAskDenoms) > 0 {
			for iNdEx := len(x.AllowedAskDenoms) - 1; iNdEx >= 0; iNdEx-- {
				encoded, err := options.Marshal(x.AllowedAskDenoms[iNdEx])
				if err != nil {
					return protoiface.MarshalOutput{
						NoUnkeyedLiterals: input.NoUnkeyedLiterals,
						Buf:               input.Buf,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 6:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field AllowedAskDenoms", wireType)
				}
				var msglen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.AllowedAskDenoms = append(x.AllowedAskDenoms, &AskDenom{})
				if err := options.Unmarshal(dAtA[iNdEx:postIndex], x.AllowedAskDenoms[len(x.AllowedAskDenoms)-1]); err != nil {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, err
				}
				iNdEx = postIndex
			default:
...
func init() {
	file_regen_ecocredit_v1_types_proto_init()
	md_AskDenom = File_regen_ecocredit_v1_types_proto.Messages().ByName("AskDenom")
...
func (x *fastReflection_AskDenom) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "regen.ecocredit.v1.AskDenom.denom":
		return x.Denom != ""
	case "regen.ecocredit.v1.AskDenom.display_denom":
		return x.DisplayDenom != ""
	case "regen.ecocredit.v1.AskDenom.exponent":
		return x.Exponent != uint32(0)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: regen.ecocredit.v1.AskDenom"))
		}
		panic(fmt.Errorf("message regen.ecocredit.v1.AskDenom does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_AskDenom) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message regen.ecocredit.v1.AskDenom does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_AskDenom) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "regen.ecocredit.v1.AskDenom.denom":
		panic(fmt.Errorf("field denom of message regen.ecocredit.v1.AskDenom is not mutable"))
	case "regen.ecocredit.v1.AskDenom.display_denom":
		panic(fmt.Errorf("field display_denom of message regen.ecocredit.v1.AskDenom is not mutable"))
	case "regen.ecocredit.v1.AskDenom.exponent":
		panic(fmt.Errorf("field exponent of message regen.ecocredit.v1.AskDenom is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: regen.ecocredit.v1.AskDenom"))
		}
...
func (x *fastReflection_AskDenom) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in regen.ecocredit.v1.AskDenom", d.FullName()))
	}
	panic("unreachable")
}
...
var (
	...
	fd_OriginTx_typ protoreflect.FieldDescriptor
...
func init() {
	...
	fd_OriginTx_typ = md_OriginTx.Fields().ByName("typ")
...
func (x *fastReflection_OriginTx) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "regen.ecocredit.v1.OriginTx.typ":
		return x.Typ != ""
...
func (x *fastReflection_OriginTx) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "regen.ecocredit.v1.OriginTx.typ":
		panic(fmt.Errorf("field typ of message regen.ecocredit.v1.OriginTx is not mutable"))
	case "regen.ecocredit.v1.OriginTx.id":
...
var (
	md_ToucanPayload                       protoreflect.MessageDescriptor
	fd_ToucanPayload_recipient             protoreflect.FieldDescriptor
	fd_ToucanPayload_tco2_contract_address protoreflect.FieldDescriptor
	fd_ToucanPayload_amount                protoreflect.FieldDescriptor
	fd_ToucanPayload_note                  protoreflect.FieldDescriptor
)

func init() {
	file_regen_ecocredit_v1_types_proto_init()
	md_ToucanPayload = File_regen_ecocredit_v1_types_proto.Messages().ByName("ToucanPayload")
	fd_ToucanPayload_recipient = md_ToucanPayload.Fields().ByName("recipient")
	fd_ToucanPayload_tco2_contract_address = md_ToucanPayload.Fields().ByName("tco2_contract_address")
	fd_ToucanPayload_amount = md_ToucanPayload.Fields().ByName("amount")
	fd_ToucanPayload_note = md_ToucanPayload.Fields().ByName("note")
}

var _ protoreflect.Message = (*fastReflection_ToucanPayload)(nil)

type fastReflection_ToucanPayload ToucanPayload

func (x *ToucanPayload) ProtoReflect() protoreflect.Message {
	return (*fastReflection_ToucanPayload)(x)
}

func (x *ToucanPayload) slowProtoReflect() protoreflect.Message {
...
var _fastReflection_ToucanPayload_messageType fastReflection_ToucanPayload_messageType
var _ protoreflect.MessageType = fastReflection_ToucanPayload_messageType{}

type fastReflection_ToucanPayload_messageType struct{}

func (x fastReflection_ToucanPayload_messageType) Zero() protoreflect.Message {
	return (*fastReflection_ToucanPayload)(nil)
}
func (x fastReflection_ToucanPayload_messageType) New() protoreflect.Message {
	return new(fastReflection_ToucanPayload)
}
func (x fastReflection_ToucanPayload_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_ToucanPayload
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_ToucanPayload) Descriptor() protoreflect.MessageDescriptor {
	return md_ToucanPayload
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_ToucanPayload) Type() protoreflect.MessageType {
	return _fastReflection_ToucanPayload_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_ToucanPayload) New() protoreflect.Message {
	return new(fastReflection_ToucanPayload)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_ToucanPayload) Interface() protoreflect.ProtoMessage {
	return (*ToucanPayload)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_ToucanPayload) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.Recipient != "" {
		value := protoreflect.ValueOfString(x.Recipient)
		if !f(fd_ToucanPayload_recipient, value) {
			return
		}
	}
	if x.Tco2ContractAddress != "" {
		value := protoreflect.ValueOfString(x.Tco2ContractAddress)
		if !f(fd_ToucanPayload_tco2_contract_address, value) {
			return
		}
	}
	if x.Amount != "" {
		value := protoreflect.ValueOfString(x.Amount)
		if !f(fd_ToucanPayload_amount, value) {
			return
		}
	}
	if x.Note != "" {
		value := protoreflect.ValueOfString(x.Note)
		if !f(fd_ToucanPayload_note, value) {
			return
		}
	}
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_ToucanPayload) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "regen.ecocredit.v1.ToucanPayload.recipient":
		return x.Recipient != ""
	case "regen.ecocredit.v1.ToucanPayload.tco2_contract_address":
		return x.Tco2ContractAddress != ""
	case "regen.ecocredit.v1.ToucanPayload.amount":
		return x.Amount != ""
	case "regen.ecocredit.v1.ToucanPayload.note":
		return x.Note != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: regen.ecocredit.v1.ToucanPayload"))
		}
		panic(fmt.Errorf("message regen.ecocredit.v1.ToucanPayload does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_ToucanPayload) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "regen.ecocredit.v1.ToucanPayload.recipient":
		x.Recipient = ""
	case "regen.ecocredit.v1.ToucanPayload.tco2_contract_address":
		x.Tco2ContractAddress = ""
	case "regen.ecocredit.v1.ToucanPayload.amount":
		x.Amount = ""
	case "regen.ecocredit.v1.ToucanPayload.note":
		x.Note = ""
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_ToucanPayload) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "regen.ecocredit.v1.ToucanPayload.recipient":
		value := x.Recipient
		return protoreflect.ValueOfString(value)
	case "regen.ecocredit.v1.ToucanPayload.tco2_contract_address":
		value := x.Tco2ContractAddress
		return protoreflect.ValueOfString(value)
	case "regen.ecocredit.v1.ToucanPayload.amount":
		value := x.Amount
		return protoreflect.ValueOfString(value)
	...
	default:
		...
		panic(fmt.Errorf("message regen.ecocredit.v1.ToucanPayload does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_ToucanPayload) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "regen.ecocredit.v1.ToucanPayload.recipient":
		x.Recipient = value.Interface().(string)
	case "regen.ecocredit.v1.ToucanPayload.tco2_contract_address":
		x.Tco2ContractAddress = value.Interface().(string)
	case "regen.ecocredit.v1.ToucanPayload.amount":
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_ToucanPayload) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "regen.ecocredit.v1.ToucanPayload.recipient":
		panic(fmt.Errorf("field recipient of message regen.ecocredit.v1.ToucanPayload is not mutable"))
	case "regen.ecocredit.v1.ToucanPayload.tco2_contract_address":
		panic(fmt.Errorf("field tco2_contract_address of message regen.ecocredit.v1.ToucanPayload is not mutable"))
	case "regen.ecocredit.v1.ToucanPayload.amount":
		panic(fmt.Errorf("field amount of message regen.ecocredit.v1.ToucanPayload is not mutable"))
	case "regen.ecocredit.v1.ToucanPayload.note":
		panic(fmt.Errorf("field note of message regen.ecocredit.v1.ToucanPayload is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: regen.ecocredit.v1.ToucanPayload"))
		}
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_ToucanPayload) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "regen.ecocredit.v1.ToucanPayload.recipient":
		return protoreflect.ValueOfString("")
	case "regen.ecocredit.v1.ToucanPayload.tco2_contract_address":
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_ToucanPayload) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in regen.ecocredit.v1.ToucanPayload", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_ToucanPayload) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_ToucanPayload) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_ToucanPayload) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_ToucanPayload) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*ToucanPayload)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.Tco2ContractAddress) > 0 {
			i -= len(x.Tco2ContractAddress)
			copy(dAtA[i:], x.Tco2ContractAddress)
			i = runtime.EncodeVarint(dAtA, i, uint64(len(x.Tco2ContractAddress)))
			i--
			dAtA[i] = 0x12
		}
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: ToucanPayload: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: ToucanPayload: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 2 {
			...
			case 2:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field Tco2ContractAddress", wireType)
				}
				var stringLen uint64
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.Tco2ContractAddress = string(dAtA[iNdEx:postIndex])
				iNdEx = postIndex
			case 3:
				if wireType != 2 {
...
func (x *Params) GetAllowedAskDenoms() []*AskDenom {
	if x != nil {
		return x.AllowedAskDenoms
	}
	return nil
}
...
type ToucanPayload struct {
	...
	Tco2ContractAddress string `protobuf:"bytes,2,opt,name=tco2_contract_address,json=tco2ContractAddress,proto3" json:"tco2_contract_address,omitempty"`
...
func (x *ToucanPayload) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ToucanPayload) ProtoMessage() {}

// Deprecated: Use ToucanPayload.ProtoReflect.Descriptor instead.
func (*ToucanPayload) Descriptor() ([]byte, []int) {
	return file_regen_ecocredit_v1_types_proto_rawDescGZIP(), []int{4}
}

func (x *ToucanPayload) GetRecipient() string {
	if x != nil {
		return x.Recipient
	}
	return ""
...
func (x *ToucanPayload) GetTco2ContractAddress() string {
	if x != nil {
		return x.Tco2ContractAddress
	}
	return ""
...
func (x *ToucanPayload) GetAmount() string {
	if x != nil {
		return x.Amount
	}
	return ""
...
func (x *ToucanPayload) GetNote() string {
	if x != nil {
		return x.Note
	}
	return ""
...
var file_regen_ecocredit_v1_types_proto_rawDesc = []byte{
	...
	0x74, 0x61, 0x74, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xdd, 0x03, 0x0a, 0x06, 0x50,
	...
	,
	...
	,
...
var file_regen_ecocredit_v1_types_proto_goTypes = []interface{}{
	...
	(*AskDenom)(nil),           // 1: regen.ecocredit.v1.AskDenom
	(*OriginTx)(nil),           // 2: regen.ecocredit.v1.OriginTx
	(*CreditTypeProposal)(nil), // 3: regen.ecocredit.v1.CreditTypeProposal
	(*ToucanPayload)(nil),      // 4: regen.ecocredit.v1.ToucanPayload
...
var file_regen_ecocredit_v1_types_proto_depIdxs = []int32{
	...
	6, // 2: regen.ecocredit.v1.Params.credit_types:type_name -> regen.ecocredit.v1.CreditType
	1, // 3: regen.ecocredit.v1.Params.allowed_ask_denoms:type_name -> regen.ecocredit.v1.AskDenom
	6, // 4: regen.ecocredit.v1.CreditTypeProposal.credit_type:type_name -> regen.ecocredit.v1.CreditType
