...
var (
	...
	fd_Fee_denom  protoreflect.FieldDescriptor
	fd_Fee_amount protoreflect.FieldDescriptor
)

func init() {
	file_regen_ecocredit_v1_types_proto_init()
	md_Fee = File_regen_ecocredit_v1_types_proto.Messages().ByName("Fee")
	fd_Fee_denom = md_Fee.Fields().ByName("denom")
...
func (x *fastReflection_Fee) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "regen.ecocredit.v1.Fee.denom":
		return x.Denom != ""
	case "regen.ecocredit.v1.Fee.amount":
		return x.Amount != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: regen.ecocredit.v1.Fee"))
		}
		panic(fmt.Errorf("message regen.ecocredit.v1.Fee does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Fee) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message regen.ecocredit.v1.Fee does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Fee) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "regen.ecocredit.v1.Fee.denom":
		panic(fmt.Errorf("field denom of message regen.ecocredit.v1.Fee is not mutable"))
	case "regen.ecocredit.v1.Fee.amount":
		panic(fmt.Errorf("field amount of message regen.ecocredit.v1.Fee is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: regen.ecocredit.v1.Fee"))
		}
...
func (x *fastReflection_Fee) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in regen.ecocredit.v1.Fee", d.FullName()))
	}
	panic("unreachable")
}
...
var file_regen_ecocredit_v1_types_proto_rawDesc = []byte{
	...
	0x65, 0x73, 0x22, 0x33, 0x0a, 0x03, 0x46, 0x65, 0x65, 0x12, 0x14, 0x0a, 0x05, 0x64, 0x65, 0x6e,
	...
	0x06, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x42, 0xd8, 0x01, 0x0a, 0x16, 0x63, 0x6f, 0x6d, 0x2e,
...
var file_regen_ecocredit_v1_types_proto_goTypes = []interface{}{
	...
	(*Fee)(nil),          // 1: regen.ecocredit.v1.Fee
