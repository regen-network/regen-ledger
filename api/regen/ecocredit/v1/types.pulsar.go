...
var (
	md_CreditClass             protoreflect.MessageDescriptor
	fd_CreditClass_name        protoreflect.FieldDescriptor
	fd_CreditClass_admin       protoreflect.FieldDescriptor
	fd_CreditClass_metadata    protoreflect.FieldDescriptor
	fd_CreditClass_credit_type protoreflect.FieldDescriptor
)

func init() {
	file_regen_ecocredit_v1_types_proto_init()
	md_CreditClass = File_regen_ecocredit_v1_types_proto.Messages().ByName("CreditClass")
	fd_CreditClass_name = md_CreditClass.Fields().ByName("name")
	fd_CreditClass_admin = md_CreditClass.Fields().ByName("admin")
	fd_CreditClass_metadata = md_CreditClass.Fields().ByName("metadata")
	fd_CreditClass_credit_type = md_CreditClass.Fields().ByName("credit_type")
}

var _ protoreflect.Message = (*fastReflection_CreditClass)(nil)

type fastReflection_CreditClass CreditClass

func (x *CreditClass) ProtoReflect() protoreflect.Message {
	return (*fastReflection_CreditClass)(x)
}

func (x *CreditClass) slowProtoReflect() protoreflect.Message {
...
var _fastReflection_CreditClass_messageType fastReflection_CreditClass_messageType
var _ protoreflect.MessageType = fastReflection_CreditClass_messageType{}

type fastReflection_CreditClass_messageType struct{}

func (x fastReflection_CreditClass_messageType) Zero() protoreflect.Message {
	return (*fastReflection_CreditClass)(nil)
}
func (x fastReflection_CreditClass_messageType) New() protoreflect.Message {
	return new(fastReflection_CreditClass)
}
func (x fastReflection_CreditClass_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_CreditClass
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_CreditClass) Descriptor() protoreflect.MessageDescriptor {
	return md_CreditClass
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_CreditClass) Type() protoreflect.MessageType {
	return _fastReflection_CreditClass_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_CreditClass) New() protoreflect.Message {
	return new(fastReflection_CreditClass)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_CreditClass) Interface() protoreflect.ProtoMessage {
	return (*CreditClass)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_CreditClass) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.Name != "" {
		value := protoreflect.ValueOfString(x.Name)
		if !f(fd_CreditClass_name, value) {
			return
		}
	}
	if len(x.Admin) != 0 {
		value := protoreflect.ValueOfBytes(x.Admin)
		if !f(fd_CreditClass_admin, value) {
			return
		}
	}
	if x.Metadata != "" {
		value := protoreflect.ValueOfString(x.Metadata)
		if !f(fd_CreditClass_metadata, value) {
			return
		}
	}
	if x.CreditType != "" {
		value := protoreflect.ValueOfString(x.CreditType)
		if !f(fd_CreditClass_credit_type, value) {
			return
		}
	}
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_CreditClass) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "regen.ecocredit.v1.CreditClass.name":
		return x.Name != ""
	case "regen.ecocredit.v1.CreditClass.admin":
		return len(x.Admin) != 0
	case "regen.ecocredit.v1.CreditClass.metadata":
		return x.Metadata != ""
	case "regen.ecocredit.v1.CreditClass.credit_type":
		return x.CreditType != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: regen.ecocredit.v1.CreditClass"))
		}
		panic(fmt.Errorf("message regen.ecocredit.v1.CreditClass does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_CreditClass) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "regen.ecocredit.v1.CreditClass.name":
		x.Name = ""
	case "regen.ecocredit.v1.CreditClass.admin":
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_CreditClass) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "regen.ecocredit.v1.CreditClass.name":
		value := x.Name
	...
	default:
		...
		panic(fmt.Errorf("message regen.ecocredit.v1.CreditClass does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_CreditClass) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "regen.ecocredit.v1.CreditClass.name":
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_CreditClass) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "regen.ecocredit.v1.CreditClass.name":
		panic(fmt.Errorf("field name of message regen.ecocredit.v1.CreditClass is not mutable"))
	case "regen.ecocredit.v1.CreditClass.admin":
		panic(fmt.Errorf("field admin of message regen.ecocredit.v1.CreditClass is not mutable"))
	case "regen.ecocredit.v1.CreditClass.metadata":
		panic(fmt.Errorf("field metadata of message regen.ecocredit.v1.CreditClass is not mutable"))
	case "regen.ecocredit.v1.CreditClass.credit_type":
		panic(fmt.Errorf("field credit_type of message regen.ecocredit.v1.CreditClass is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: regen.ecocredit.v1.CreditClass"))
		}
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_CreditClass) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "regen.ecocredit.v1.CreditClass.name":
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_CreditClass) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in regen.ecocredit.v1.CreditClass", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_CreditClass) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_CreditClass) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_CreditClass) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_CreditClass) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*CreditClass)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: CreditClass: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: CreditClass: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 2 {
...
func (x *CreditClass) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *CreditClass) GetAdmin() []byte {
	if x != nil {
		return x.Admin
	}
	return nil
...
func (x *CreditClass) GetMetadata() string {
	if x != nil {
		return x.Metadata
	}
	return ""
...
func (x *CreditClass) GetCreditType() string {
	if x != nil {
		return x.CreditType
	}
	return ""
...
var file_regen_ecocredit_v1_types_proto_rawDesc = []byte{
	...
	0x65, 0x73, 0x22, 0x74, 0x0a, 0x0b, 0x43, 0x72, 0x65, 0x64, 0x69, 0x74, 0x43, 0x6c, 0x61, 0x73,
	0x73, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x04, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x14, 0x0a, 0x05, 0x61, 0x64, 0x6d, 0x69, 0x6e, 0x18, 0x02,
	...
	0x65, 0x64, 0x69, 0x74, 0x54, 0x79, 0x70, 0x65, 0x42, 0xd8, 0x01, 0x0a, 0x16, 0x63, 0x6f, 0x6d,
...
var file_regen_ecocredit_v1_types_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_regen_ecocredit_v1_types_proto_goTypes = []interface{}{
	(*Params)(nil),       // 0: regen.ecocredit.v1.Params
	(*CreditClass)(nil),  // 1: regen.ecocredit.v1.CreditClass
	(*v1beta1.Coin)(nil), // 2: cosmos.base.v1beta1.Coin
	(*CreditType)(nil),   // 3: regen.ecocredit.v1.CreditType
}
var file_regen_ecocredit_v1_types_proto_depIdxs = []int32{
	2, // 0: regen.ecocredit.v1.Params.credit_class_fee:type_name -> cosmos.base.v1beta1.Coin
	3, // 1: regen.ecocredit.v1.Params.credit_types:type_name -> regen.ecocredit.v1.CreditType
