...
var (
	...
	fd_ProjectClass_credit_class_metadata protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_ProjectClass_credit_class_metadata = md_ProjectClass.Fields().ByName("credit_class_metadata")
}
...
func (x *fastReflection_ProjectClass) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.CreditClassMetadata != "" {
		value := protoreflect.ValueOfString(x.CreditClassMetadata)
		if !f(fd_ProjectClass_credit_class_metadata, value) {
			return
		}
	}
}
...
func (x *fastReflection_ProjectClass) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "regen.ecocredit.v1.ProjectClass.credit_class_metadata":
		return x.CreditClassMetadata != ""
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_ProjectClass) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "regen.ecocredit.v1.ProjectClass.credit_class_metadata":
		x.CreditClassMetadata = value.Interface().(string)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: regen.ecocredit.v1.ProjectClass"))
		}
...
func (x *fastReflection_ProjectClass) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "regen.ecocredit.v1.ProjectClass.credit_class_metadata":
		panic(fmt.Errorf("field credit_class_metadata of message regen.ecocredit.v1.ProjectClass is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: regen.ecocredit.v1.ProjectClass"))
		}
...
func (x *fastReflection_ProjectClass) ProtoMethods() *protoiface.Methods {
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.CreditClassMetadata) > 0 {
			i -= len(x.CreditClassMetadata)
			copy(dAtA[i:], x.CreditClassMetadata)
			i = runtime.EncodeVarint(dAtA, i, uint64(len(x.CreditClassMetadata)))
			i--
			dAtA[i] = 0x32
		}
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 6:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field CreditClassMetadata", wireType)
				}
				var stringLen uint64
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.CreditClassMetadata = string(dAtA[iNdEx:postIndex])
				iNdEx = postIndex
			default:
				iNdEx = preIndex
				skippy, err := runtime.Skip(dAtA[iNdEx:])
...
type ProjectClass struct {
	...
	ProjectMetadata string `protobuf:"bytes,5,opt,name=project_metadata,json=projectMetadata,proto3" json:"project_metadata,omitempty"`
	// credit_class_metadata is any arbitrary metadata set by a credit
	// class issuer. This should primarily be used to store metadata regarding the
	// project's application to the credit class.
	CreditClassMetadata string `protobuf:"bytes,6,opt,name=credit_class_metadata,json=creditClassMetadata,proto3" json:"credit_class_metadata,omitempty"`
}
...
func (x *ProjectClass) GetCreditClassMetadata() string {
	if x != nil {
		return x.CreditClassMetadata
	}
	return ""
...
var file_regen_ecocredit_v1_state_proto_rawDesc = []byte{
	...
	,
...
var file_regen_ecocredit_v1_state_proto_depIdxs = []int32{
	18, // 0: regen.ecocredit.v1.Batch.start_date:type_name -> google.protobuf.Timestamp
