...
var (
	...
	fd_Batch_batch_denom   protoreflect.FieldDescriptor
...
func init() {
	...
	fd_Batch_batch_denom = md_Batch.Fields().ByName("batch_denom")
...
func (x *fastReflection_Batch) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.BatchDenom != "" {
		...
		if !f(fd_Batch_batch_denom, value) {
			return
		}
	}
	if x.Metadata != "" {
...
func (x *fastReflection_Batch) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "regen.ecocredit.v1.Batch.batch_denom":
		return x.BatchDenom != ""
...
func (x *fastReflection_Batch) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "regen.ecocredit.v1.Batch.batch_denom":
		panic(fmt.Errorf("field batch_denom of message regen.ecocredit.v1.Batch is not mutable"))
	case "regen.ecocredit.v1.Batch.metadata":
...
func (x *Batch) GetBatchDenom() string {
	if x != nil {
		return x.BatchDenom
	}
	return ""
...
var file_regen_ecocredit_v1_state_proto_rawDesc = []byte{
	...
	0x12, 0x09, 0x0a, 0x05, 0x61, 0x64, 0x6d, 0x69, 0x6e, 0x10, 0x03, 0x18, 0x04, 0x22, 0xa9, 0x03,
	...
	0x65, 0x79, 0x12, 0x1f, 0x0a, 0x0b, 0x62, 0x61, 0x74, 0x63, 0x68, 0x5f, 0x64, 0x65, 0x6e, 0x6f,
	...
	0x52, 0x04, 0x6f, 0x70, 0x65, 0x6e, 0x3a, 0x51, 0xf2, 0x9e, 0xd3, 0x8e, 0x03, 0x4b, 0x0a, 0x07,
	0x0a, 0x03, 0x6b, 0x65, 0x79, 0x10, 0x01, 0x12, 0x11, 0x0a, 0x0b, 0x62, 0x61, 0x74, 0x63, 0x68,
	0x5f, 0x64, 0x65, 0x6e, 0x6f, 0x6d, 0x10, 0x01, 0x18, 0x01, 0x12, 0x0f, 0x0a, 0x0b, 0x70, 0x72,
