...
var (
	...
	fd_BatchSupply_escrwowed_amount protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_BatchSupply_escrwowed_amount = md_BatchSupply.Fields().ByName("escrwowed_amount")
}
...
func (x *fastReflection_BatchSupply) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.EscrwowedAmount != "" {
		value := protoreflect.ValueOfString(x.EscrwowedAmount)
		if !f(fd_BatchSupply_escrwowed_amount, value) {
			return
		}
	}
}
...
func (x *fastReflection_BatchSupply) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "regen.ecocredit.v1.BatchSupply.escrwowed_amount":
		return x.EscrwowedAmount != ""
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_BatchSupply) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "regen.ecocredit.v1.BatchSupply.escrwowed_amount":
		x.EscrwowedAmount = value.Interface().(string)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: regen.ecocredit.v1.BatchSupply"))
		}
...
func (x *fastReflection_BatchSupply) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "regen.ecocredit.v1.BatchSupply.escrwowed_amount":
		panic(fmt.Errorf("field escrwowed_amount of message regen.ecocredit.v1.BatchSupply is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: regen.ecocredit.v1.BatchSupply"))
		}
...
func (x *fastReflection_BatchSupply) ProtoMethods() *protoiface.Methods {
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.EscrwowedAmount) > 0 {
			i -= len(x.EscrwowedAmount)
			copy(dAtA[i:], x.EscrwowedAmount)
			i = runtime.EncodeVarint(dAtA, i, uint64(len(x.EscrwowedAmount)))
			i--
			dAtA[i] = 0x2a
		}
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 5:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field EscrwowedAmount", wireType)
				}
				var stringLen uint64
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.EscrwowedAmount = string(dAtA[iNdEx:postIndex])
				iNdEx = postIndex
			default:
				iNdEx = preIndex
				skippy, err := runtime.Skip(dAtA[iNdEx:])
...
func (x *BatchSupply) GetEscrwowedAmount() string {
	if x != nil {
		return x.EscrwowedAmount
	}
	return ""
...
var file_regen_ecocredit_v1_state_proto_rawDesc = []byte{
	...
	0x18, 0x08, 0x22, 0xc9, 0x01, 0x0a, 0x0c, 0x42, 0x61, 0x74, 0x63, 0x68, 0x42, 0x61, 0x6c, 0x61,
	...
	0x52, 0x08, 0x65, 0x73, 0x63, 0x72, 0x6f, 0x77, 0x65, 0x64, 0x3a, 0x32, 0xf2, 0x9e, 0xd3, 0x8e,
	...
	0x69, 0x64, 0x2c, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x10, 0x01, 0x18, 0x09, 0x22, 0xe4,
	...
	0x6f, 0x75, 0x6e, 0x74, 0x12, 0x29, 0x0a, 0x10, 0x65, 0x73, 0x63, 0x72, 0x77, 0x6f, 0x77, 0x65,
	0x64, 0x5f, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0f,
	0x65, 0x73, 0x63, 0x72, 0x77, 0x6f, 0x77, 0x65, 0x64, 0x41, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x3a,
