...
var (
	...
	fd_BatchOriginTx_contract    protoreflect.FieldDescriptor
...
func init() {
	...
	fd_BatchOriginTx_contract = md_BatchOriginTx.Fields().ByName("contract")
...
func (x *fastReflection_BatchOriginTx) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.Contract != "" {
		...
		if !f(fd_BatchOriginTx_contract, value) {
			return
		}
	}
	if x.BatchDenom != "" {
...
func (x *fastReflection_BatchOriginTx) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "regen.ecocredit.v1.BatchOriginTx.source":
		return x.Source != ""
	case "regen.ecocredit.v1.BatchOriginTx.contract":
		return x.Contract != ""
...
func (x *fastReflection_BatchOriginTx) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "regen.ecocredit.v1.BatchOriginTx.contract":
		panic(fmt.Errorf("field contract of message regen.ecocredit.v1.BatchOriginTx is not mutable"))
	case "regen.ecocredit.v1.BatchOriginTx.batch_denom":
...
func (x *BatchOriginTx) GetContract() string {
	if x != nil {
		return x.Contract
	}
	return ""
...
var file_regen_ecocredit_v1_state_proto_rawDesc = []byte{
	...
	0x0a, 0x22, 0x9c, 0x01, 0x0a, 0x0d, 0x42, 0x61, 0x74, 0x63, 0x68, 0x4f, 0x72, 0x69, 0x67, 0x69,
	...
	0x6f, 0x6e, 0x74, 0x72, 0x61, 0x63, 0x74, 0x12, 0x1f, 0x0a, 0x0b, 0x62, 0x61, 0x74, 0x63, 0x68,
	0x5f, 0x64, 0x65, 0x6e, 0x6f, 0x6d, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x62, 0x61,
	0x74, 0x63, 0x68, 0x44, 0x65, 0x6e, 0x6f, 0x6d, 0x3a, 0x26, 0xf2, 0x9e, 0xd3, 0x8e, 0x03, 0x20,
	0x0a, 0x0b, 0x0a, 0x09, 0x69, 0x64, 0x2c, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x12, 0x0f, 0x0a,
	0x0b, 0x62, 0x61, 0x74, 0x63, 0x68, 0x5f, 0x64, 0x65, 0x6e, 0x6f, 0x6d, 0x10, 0x01, 0x18, 0x0b,
