...
var (
	...
	fd_MsgBridge_msg_cancel protoreflect.FieldDescriptor
...
func init() {
	...
	fd_MsgBridge_msg_cancel = md_MsgBridge.Fields().ByName("msg_cancel")
...
func (x *fastReflection_MsgBridge) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.MsgCancel != nil {
		...
		if !f(fd_MsgBridge_msg_cancel, value) {
			return
		}
	}
	if x.Target != "" {
...
func (x *fastReflection_MsgBridge) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "regen.ecocredit.v1.MsgBridge.msg_cancel":
...
func (x *MsgBridge) GetMsgCancel() *MsgCancel {
	if x != nil {
		return x.MsgCancel
	}
	return nil
...
var file_regen_ecocredit_v1_tx_proto_rawDesc = []byte{
	...
	0x65, 0x22, 0x9b, 0x01, 0x0a, 0x09, 0x4d, 0x73, 0x67, 0x42, 0x72, 0x69, 0x64, 0x67, 0x65, 0x12,
	0x3c, 0x0a, 0x0a, 0x6d, 0x73, 0x67, 0x5f, 0x63, 0x61, 0x6e, 0x63, 0x65, 0x6c, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x0b, 0x32, 0x1d, 0x2e, 0x72, 0x65, 0x67, 0x65, 0x6e, 0x2e, 0x65, 0x63, 0x6f, 0x63,
	0x72, 0x65, 0x64, 0x69, 0x74, 0x2e, 0x76, 0x31, 0x2e, 0x4d, 0x73, 0x67, 0x43, 0x61, 0x6e, 0x63,
	0x65, 0x6c, 0x52, 0x09, 0x6d, 0x73, 0x67, 0x43, 0x61, 0x6e, 0x63, 0x65, 0x6c, 0x12, 0x16, 0x0a,
	...
	0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x63, 0x6f, 0x6e, 0x74, 0x72, 0x61, 0x63, 0x74, 0x22,
...
var file_regen_ecocredit_v1_tx_proto_depIdxs = []int32{
	...
	15, // 10: regen.ecocredit.v1.MsgBridge.msg_cancel:type_name -> regen.ecocredit.v1.MsgCancel
