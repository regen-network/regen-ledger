...
type ClassIssuerIssuerIndexKey struct {
	vs []interface{}
}

func (x ClassIssuerIssuerIndexKey) id() uint32            { return 1 }
func (x ClassIssuerIssuerIndexKey) values() []interface{} { return x.vs }
func (x ClassIssuerIssuerIndexKey) classIssuerIndexKey()  {}

func (this ClassIssuerIssuerIndexKey) WithIssuer(issuer []byte) ClassIssuerIssuerIndexKey {
