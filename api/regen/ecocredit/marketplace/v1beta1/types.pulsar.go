...
func (x *_Filter_1_list) Set(i int, value protoreflect.Value) {
	...
	concreteValue := valueUnwrapped.Interface().(*Filter_Selector)
...
var _ protoreflect.List = (*_Filter_2_list)(nil)

type _Filter_2_list struct {
	list *[]string
}

func (x *_Filter_2_list) Len() int {
	if x.list == nil {
		return 0
	}
	return len(*x.list)
...
func (x *_Filter_2_list) Get(i int) protoreflect.Value {
	return protoreflect.ValueOfString((*x.list)[i])
}

func (x *_Filter_2_list) Set(i int, value protoreflect.Value) {
	valueUnwrapped := value.String()
	concreteValue := valueUnwrapped
	(*x.list)[i] = concreteValue
}

func (x *_Filter_2_list) Append(value protoreflect.Value) {
	valueUnwrapped := value.String()
	concreteValue := valueUnwrapped
	*x.list = append(*x.list, concreteValue)
}

func (x *_Filter_2_list) AppendMutable() protoreflect.Value {
	panic(fmt.Errorf("AppendMutable can not be called on message Filter at list field ProjectLocations as it is not of Message kind"))
}

func (x *_Filter_2_list) Truncate(n int) {
	*x.list = (*x.list)[:n]
}

func (x *_Filter_2_list) NewElement() protoreflect.Value {
	v := ""
	return protoreflect.ValueOfString(v)
}

func (x *_Filter_2_list) IsValid() bool {
	return x.list != nil
}
...
var (
	...
	fd_Filter_project_locations protoreflect.FieldDescriptor
	fd_Filter_min_start_date    protoreflect.FieldDescriptor
	fd_Filter_max_end_date      protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_Filter_project_locations = md_Filter.Fields().ByName("project_locations")
	fd_Filter_min_start_date = md_Filter.Fields().ByName("min_start_date")
	fd_Filter_max_end_date = md_Filter.Fields().ByName("max_end_date")
}
...
func (x *fastReflection_Filter) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if len(x.ProjectLocations) != 0 {
		value := protoreflect.ValueOfList(&_Filter_2_list{list: &x.ProjectLocations})
		if !f(fd_Filter_project_locations, value) {
			return
		}
	}
	if x.MinStartDate != nil {
		value := protoreflect.ValueOfMessage(x.MinStartDate.ProtoReflect())
		if !f(fd_Filter_min_start_date, value) {
			return
		}
	}
	if x.MaxEndDate != nil {
		value := protoreflect.ValueOfMessage(x.MaxEndDate.ProtoReflect())
		if !f(fd_Filter_max_end_date, value) {
			return
		}
	}
}
...
func (x *fastReflection_Filter) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "regen.ecocredit.marketplace.v1beta1.Filter.or":
		return len(x.Or) != 0
	case "regen.ecocredit.marketplace.v1beta1.Filter.project_locations":
		return len(x.ProjectLocations) != 0
	case "regen.ecocredit.marketplace.v1beta1.Filter.min_start_date":
		return x.MinStartDate != nil
	case "regen.ecocredit.marketplace.v1beta1.Filter.max_end_date":
...
func (x *fastReflection_Filter) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "regen.ecocredit.marketplace.v1beta1.Filter.project_locations":
		if len(x.ProjectLocations) == 0 {
			return protoreflect.ValueOfList(&_Filter_2_list{})
		}
		listValue := &_Filter_2_list{list: &x.ProjectLocations}
		return protoreflect.ValueOfList(listValue)
	case "regen.ecocredit.marketplace.v1beta1.Filter.min_start_date":
...
func (x *fastReflection_Filter) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "regen.ecocredit.marketplace.v1beta1.Filter.project_locations":
		lv := value.List()
		clv := lv.(*_Filter_2_list)
		x.ProjectLocations = *clv.list
	case "regen.ecocredit.marketplace.v1beta1.Filter.min_start_date":
...
func (x *fastReflection_Filter) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "regen.ecocredit.marketplace.v1beta1.Filter.or":
		if x.Or == nil {
			x.Or = []*Filter_Selector{}
		}
		value := &_Filter_1_list{list: &x.Or}
		return protoreflect.ValueOfList(value)
	case "regen.ecocredit.marketplace.v1beta1.Filter.project_locations":
		if x.ProjectLocations == nil {
			x.ProjectLocations = []string{}
		}
		value := &_Filter_2_list{list: &x.ProjectLocations}
		return protoreflect.ValueOfList(value)
	case "regen.ecocredit.marketplace.v1beta1.Filter.min_start_date":
		if x.MinStartDate == nil {
...
func (x *fastReflection_Filter) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "regen.ecocredit.marketplace.v1beta1.Filter.project_locations":
		list := []string{}
		return protoreflect.ValueOfList(&_Filter_2_list{list: &list})
	case "regen.ecocredit.marketplace.v1beta1.Filter.min_start_date":
...
func (x *fastReflection_Filter) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		...
		if len(x.ProjectLocations) > 0 {
			for _, s := range x.ProjectLocations {
				l = len(s)
				n += 1 + l + runtime.Sov(uint64(l))
			}
		}
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.ProjectLocations) > 0 {
			for iNdEx := len(x.ProjectLocations) - 1; iNdEx >= 0; iNdEx-- {
				i -= len(x.ProjectLocations[iNdEx])
				copy(dAtA[i:], x.ProjectLocations[iNdEx])
				i = runtime.EncodeVarint(dAtA, i, uint64(len(x.ProjectLocations[iNdEx])))
				i--
				dAtA[i] = 0x12
			}
		}
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 1:
				...
				x.Or = append(x.Or, &Filter_Selector{})
			...
			case 2:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field ProjectLocations", wireType)
				}
				...
				x.ProjectLocations = append(x.ProjectLocations, string(dAtA[iNdEx:postIndex]))
				iNdEx = postIndex
			case 3:
				if wireType != 2 {
...
var (
	md_Filter_Selector                  protoreflect.MessageDescriptor
	fd_Filter_Selector_class_selector   protoreflect.FieldDescriptor
	fd_Filter_Selector_project_selector protoreflect.FieldDescriptor
)

func init() {
	file_regen_ecocredit_marketplace_v1beta1_types_proto_init()
	md_Filter_Selector = File_regen_ecocredit_marketplace_v1beta1_types_proto.Messages().ByName("Filter").Messages().ByName("Selector")
	fd_Filter_Selector_class_selector = md_Filter_Selector.Fields().ByName("class_selector")
	fd_Filter_Selector_project_selector = md_Filter_Selector.Fields().ByName("project_selector")
}

var _ protoreflect.Message = (*fastReflection_Filter_Selector)(nil)

type fastReflection_Filter_Selector Filter_Selector

func (x *Filter_Selector) ProtoReflect() protoreflect.Message {
	return (*fastReflection_Filter_Selector)(x)
}

func (x *Filter_Selector) slowProtoReflect() protoreflect.Message {
...
var _fastReflection_Filter_Selector_messageType fastReflection_Filter_Selector_messageType
var _ protoreflect.MessageType = fastReflection_Filter_Selector_messageType{}

type fastReflection_Filter_Selector_messageType struct{}

func (x fastReflection_Filter_Selector_messageType) Zero() protoreflect.Message {
	return (*fastReflection_Filter_Selector)(nil)
}
func (x fastReflection_Filter_Selector_messageType) New() protoreflect.Message {
	return new(fastReflection_Filter_Selector)
}
func (x fastReflection_Filter_Selector_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_Filter_Selector
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_Filter_Selector) Descriptor() protoreflect.MessageDescriptor {
	return md_Filter_Selector
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_Filter_Selector) Type() protoreflect.MessageType {
	return _fastReflection_Filter_Selector_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_Filter_Selector) New() protoreflect.Message {
	return new(fastReflection_Filter_Selector)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_Filter_Selector) Interface() protoreflect.ProtoMessage {
	return (*Filter_Selector)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_Filter_Selector) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.Selector != nil {
		switch o := x.Selector.(type) {
		case *Filter_Selector_ClassSelector:
			v := o.ClassSelector
			value := protoreflect.ValueOfMessage(v.ProtoReflect())
			if !f(fd_Filter_Selector_class_selector, value) {
				return
			}
		case *Filter_Selector_ProjectSelector:
			v := o.ProjectSelector
			value := protoreflect.ValueOfMessage(v.ProtoReflect())
			if !f(fd_Filter_Selector_project_selector, value) {
				return
			}
		}
	}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_Filter_Selector) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "regen.ecocredit.marketplace.v1beta1.Filter.Selector.class_selector":
		if x.Selector == nil {
			return false
		} else if _, ok := x.Selector.(*Filter_Selector_ClassSelector); ok {
			return true
		} else {
			return false
		}
	case "regen.ecocredit.marketplace.v1beta1.Filter.Selector.project_selector":
		if x.Selector == nil {
			return false
		} else if _, ok := x.Selector.(*Filter_Selector_ProjectSelector); ok {
			return true
		} else {
			return false
		}
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: regen.ecocredit.marketplace.v1beta1.Filter.Selector"))
		}
		panic(fmt.Errorf("message regen.ecocredit.marketplace.v1beta1.Filter.Selector does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_Filter_Selector) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "regen.ecocredit.marketplace.v1beta1.Filter.Selector.class_selector":
		x.Selector = nil
	case "regen.ecocredit.marketplace.v1beta1.Filter.Selector.project_selector":
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_Filter_Selector) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "regen.ecocredit.marketplace.v1beta1.Filter.Selector.class_selector":
		if x.Selector == nil {
			return protoreflect.ValueOfMessage((*ClassSelector)(nil).ProtoReflect())
		} else if v, ok := x.Selector.(*Filter_Selector_ClassSelector); ok {
	...
	case "regen.ecocredit.marketplace.v1beta1.Filter.Selector.project_selector":
		...
		} else if v, ok := x.Selector.(*Filter_Selector_ProjectSelector); ok {
	...
	default:
		...
		panic(fmt.Errorf("message regen.ecocredit.marketplace.v1beta1.Filter.Selector does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_Filter_Selector) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "regen.ecocredit.marketplace.v1beta1.Filter.Selector.class_selector":
		cv := value.Message().Interface().(*ClassSelector)
		x.Selector = &Filter_Selector_ClassSelector{ClassSelector: cv}
	case "regen.ecocredit.marketplace.v1beta1.Filter.Selector.project_selector":
		cv := value.Message().Interface().(*ProjectSelector)
		x.Selector = &Filter_Selector_ProjectSelector{ProjectSelector: cv}
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: regen.ecocredit.marketplace.v1beta1.Filter.Selector"))
		}
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_Filter_Selector) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "regen.ecocredit.marketplace.v1beta1.Filter.Selector.class_selector":
		if x.Selector == nil {
			value := &ClassSelector{}
			oneofValue := &Filter_Selector_ClassSelector{ClassSelector: value}
	...
	case "regen.ecocredit.marketplace.v1beta1.Filter.Selector.project_selector":
		if x.Selector == nil {
			...
			oneofValue := &Filter_Selector_ProjectSelector{ProjectSelector: value}
			x.Selector = oneofValue
			return protoreflect.ValueOfMessage(value.ProtoReflect())
		}
		switch m := x.Selector.(type) {
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_Filter_Selector) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "regen.ecocredit.marketplace.v1beta1.Filter.Selector.class_selector":
		value := &ClassSelector{}
		return protoreflect.ValueOfMessage(value.ProtoReflect())
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_Filter_Selector) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	case "regen.ecocredit.marketplace.v1beta1.Filter.Selector.selector":
		if x.Selector == nil {
			return nil
		}
	...
	default:
		panic(fmt.Errorf("%s is not a oneof field in regen.ecocredit.marketplace.v1beta1.Filter.Selector", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_Filter_Selector) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_Filter_Selector) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_Filter_Selector) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_Filter_Selector) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*Filter_Selector)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: Filter_Selector: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: Filter_Selector: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 2 {
				...
				x.Selector = &Filter_Selector_ClassSelector{v}
				iNdEx = postIndex
			case 2:
				if wireType != 2 {
				...
				x.Selector = &Filter_Selector_ProjectSelector{v}
				iNdEx = postIndex
			default:
				iNdEx = preIndex
				skippy, err := runtime.Skip(dAtA[iNdEx:])
...
type Filter struct {
	...
	Or []*Filter_Selector `protobuf:"bytes,1,rep,name=or,proto3" json:"or,omitempty"`
	// project_locations can be specified in three levels of granularity:
	...
	ProjectLocations []string `protobuf:"bytes,2,rep,name=project_locations,json=projectLocations,proto3" json:"project_locations,omitempty"`
...
func (x *Filter) GetOr() []*Filter_Selector {
	if x != nil {
		return x.Or
	}
	return nil
...
func (x *Filter) GetProjectLocations() []string {
	if x != nil {
		return x.ProjectLocations
	}
	return nil
}

func (x *Filter) GetMinStartDate() *timestamppb.Timestamp {
	if x != nil {
...
func (x *Filter) GetMaxEndDate() *timestamppb.Timestamp {
	if x != nil {
		return x.MaxEndDate
	}
	return nil
...
// Selector is a simple filter selector for matching a credit batch.
type Filter_Selector struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	//	*Filter_Selector_ClassSelector
	//	*Filter_Selector_ProjectSelector
	Selector isFilter_Selector_Selector `protobuf_oneof:"selector"`
}

func (x *Filter_Selector) Reset() {
	*x = Filter_Selector{}
	if protoimpl.UnsafeEnabled {
		mi := &file_regen_ecocredit_marketplace_v1beta1_types_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
...
func (x *Filter_Selector) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Filter_Selector) ProtoMessage() {}

// Deprecated: Use Filter_Selector.ProtoReflect.Descriptor instead.
func (*Filter_Selector) Descriptor() ([]byte, []int) {
	return file_regen_ecocredit_marketplace_v1beta1_types_proto_rawDescGZIP(), []int{0, 0}
}

func (x *Filter_Selector) GetSelector() isFilter_Selector_Selector {
	if x != nil {
		return x.Selector
	}
	return nil
...
func (x *Filter_Selector) GetClassSelector() *ClassSelector {
	if x, ok := x.GetSelector().(*Filter_Selector_ClassSelector); ok {
		return x.ClassSelector
	}
	return nil
}

func (x *Filter_Selector) GetProjectSelector() *ProjectSelector {
	if x, ok := x.GetSelector().(*Filter_Selector_ProjectSelector); ok {
		return x.ProjectSelector
	}
	return nil
}

type isFilter_Selector_Selector interface {
	isFilter_Selector_Selector()
}

type Filter_Selector_ClassSelector struct {
...
type Filter_Selector_ProjectSelector struct {
...
func (*Filter_Selector_ClassSelector) isFilter_Selector_Selector() {}

func (*Filter_Selector_ProjectSelector) isFilter_Selector_Selector() {}
...
var file_regen_ecocredit_marketplace_v1beta1_types_proto_rawDesc = []byte{
	...
	0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xd4, 0x03, 0x0a, 0x06, 0x46, 0x69, 0x6c, 0x74,
	...
	0x65, 0x74, 0x61, 0x31, 0x2e, 0x46, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x2e, 0x53, 0x65, 0x6c, 0x65,
	0x63, 0x74, 0x6f, 0x72, 0x52, 0x02, 0x6f, 0x72, 0x12, 0x2b, 0x0a, 0x11, 0x70, 0x72, 0x6f, 0x6a,
	0x65, 0x63, 0x74, 0x5f, 0x6c, 0x6f, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x18, 0x02, 0x20,
	0x03, 0x28, 0x09, 0x52, 0x10, 0x70, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x4c, 0x6f, 0x63, 0x61,
	0x74, 0x69, 0x6f, 0x6e, 0x73, 0x12, 0x40, 0x0a, 0x0e, 0x6d, 0x69, 0x6e, 0x5f, 0x73, 0x74, 0x61,
	...
	0x64, 0x44, 0x61, 0x74, 0x65, 0x1a, 0xd6, 0x01, 0x0a, 0x08, 0x53, 0x65, 0x6c, 0x65, 0x63, 0x74,
	0x6f, 0x72, 0x12, 0x5b, 0x0a, 0x0e, 0x63, 0x6c, 0x61, 0x73, 0x73, 0x5f, 0x73, 0x65, 0x6c, 0x65,
	0x63, 0x74, 0x6f, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x32, 0x2e, 0x72, 0x65, 0x67,
	...
	,
	...
	,
	...
	,
...
var file_regen_ecocredit_marketplace_v1beta1_types_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_regen_ecocredit_marketplace_v1beta1_types_proto_goTypes = []interface{}{
	...
	(*Filter_Selector)(nil),       // 3: regen.ecocredit.marketplace.v1beta1.Filter.Selector
	(*timestamppb.Timestamp)(nil), // 4: google.protobuf.Timestamp
}
var file_regen_ecocredit_marketplace_v1beta1_types_proto_depIdxs = []int32{
	3, // 0: regen.ecocredit.marketplace.v1beta1.Filter.or:type_name -> regen.ecocredit.marketplace.v1beta1.Filter.Selector
	4, // 1: regen.ecocredit.marketplace.v1beta1.Filter.min_start_date:type_name -> google.protobuf.Timestamp
	4, // 2: regen.ecocredit.marketplace.v1beta1.Filter.max_end_date:type_name -> google.protobuf.Timestamp
	4, // 3: regen.ecocredit.marketplace.v1beta1.ClassSelector.min_start_date:type_name -> google.protobuf.Timestamp
	4, // 4: regen.ecocredit.marketplace.v1beta1.ClassSelector.max_end_date:type_name -> google.protobuf.Timestamp
	1, // 5: regen.ecocredit.marketplace.v1beta1.Filter.Selector.class_selector:type_name -> regen.ecocredit.marketplace.v1beta1.ClassSelector
	2, // 6: regen.ecocredit.marketplace.v1beta1.Filter.Selector.project_selector:type_name -> regen.ecocredit.marketplace.v1beta1.ProjectSelector
...
func file_regen_ecocredit_marketplace_v1beta1_types_proto_init() {
	...
	file_regen_ecocredit_marketplace_v1beta1_types_proto_msgTypes[3].OneofWrappers = []interface{}{
		(*Filter_Selector_ClassSelector)(nil),
		(*Filter_Selector_ProjectSelector)(nil),
	}
	type x struct{}
