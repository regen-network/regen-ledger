...
var (
	...
	fd_EventAllowDenom_allowed_denom protoreflect.FieldDescriptor
)

func init() {
	file_regen_ecocredit_marketplace_v1_events_proto_init()
	md_EventAllowDenom = File_regen_ecocredit_marketplace_v1_events_proto.Messages().ByName("EventAllowDenom")
	fd_EventAllowDenom_allowed_denom = md_EventAllowDenom.Fields().ByName("allowed_denom")
}
...
func (x *fastReflection_EventAllowDenom) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.AllowedDenom != "" {
		value := protoreflect.ValueOfString(x.AllowedDenom)
		if !f(fd_EventAllowDenom_allowed_denom, value) {
			return
		}
	}
}
...
func (x *fastReflection_EventAllowDenom) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "regen.ecocredit.marketplace.v1.EventAllowDenom.allowed_denom":
...
func (x *fastReflection_EventAllowDenom) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "regen.ecocredit.marketplace.v1.EventAllowDenom.allowed_denom":
		x.AllowedDenom = value.Interface().(string)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: regen.ecocredit.marketplace.v1.EventAllowDenom"))
		}
...
func (x *fastReflection_EventAllowDenom) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "regen.ecocredit.marketplace.v1.EventAllowDenom.allowed_denom":
		panic(fmt.Errorf("field allowed_denom of message regen.ecocredit.marketplace.v1.EventAllowDenom is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: regen.ecocredit.marketplace.v1.EventAllowDenom"))
		}
...
func (x *fastReflection_EventAllowDenom) ProtoMethods() *protoiface.Methods {
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.AllowedDenom) > 0 {
			i -= len(x.AllowedDenom)
			copy(dAtA[i:], x.AllowedDenom)
			i = runtime.EncodeVarint(dAtA, i, uint64(len(x.AllowedDenom)))
			i--
			dAtA[i] = 0xa
		}
		if input.Buf != nil {
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 1:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field AllowedDenom", wireType)
				}
				...
				x.AllowedDenom = string(dAtA[iNdEx:postIndex])
				iNdEx = postIndex
			default:
				iNdEx = preIndex
				skippy, err := runtime.Skip(dAtA[iNdEx:])
...
func (x *EventAllowDenom) GetAllowedDenom() string {
	if x != nil {
		return x.AllowedDenom
	}
	return ""
...
var file_regen_ecocredit_marketplace_v1_events_proto_rawDesc = []byte{
	...
	0x07, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x49, 0x64, 0x22, 0x36, 0x0a, 0x0f, 0x45, 0x76, 0x65, 0x6e,
	0x74, 0x41, 0x6c, 0x6c, 0x6f, 0x77, 0x44, 0x65, 0x6e, 0x6f, 0x6d, 0x12, 0x23, 0x0a, 0x0d, 0x61,
	0x6c, 0x6c, 0x6f, 0x77, 0x65, 0x64, 0x5f, 0x64, 0x65, 0x6e, 0x6f, 0x6d, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x0c, 0x61, 0x6c, 0x6c, 0x6f, 0x77, 0x65, 0x64, 0x44, 0x65, 0x6e, 0x6f, 0x6d,
