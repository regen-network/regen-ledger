...
var (
	...
	fd_EventAllowAskDenom_ask_denom protoreflect.FieldDescriptor
)

func init() {
	file_regen_ecocredit_marketplace_v1_events_proto_init()
	md_EventAllowAskDenom = File_regen_ecocredit_marketplace_v1_events_proto.Messages().ByName("EventAllowAskDenom")
	fd_EventAllowAskDenom_ask_denom = md_EventAllowAskDenom.Fields().ByName("ask_denom")
}
...
func (x *fastReflection_EventAllowAskDenom) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.AskDenom != "" {
		...
		if !f(fd_EventAllowAskDenom_ask_denom, value) {
			return
		}
	}
}
...
func (x *fastReflection_EventAllowAskDenom) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "regen.ecocredit.marketplace.v1.EventAllowAskDenom.ask_denom":
		return x.AskDenom != ""
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_EventAllowAskDenom) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "regen.ecocredit.marketplace.v1.EventAllowAskDenom.ask_denom":
		panic(fmt.Errorf("field ask_denom of message regen.ecocredit.marketplace.v1.EventAllowAskDenom is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: regen.ecocredit.marketplace.v1.EventAllowAskDenom"))
		}
...
func (x *EventAllowAskDenom) GetAskDenom() string {
	if x != nil {
		return x.AskDenom
	}
	return ""
...
var file_regen_ecocredit_marketplace_v1_events_proto_rawDesc = []byte{
	...
	0x07, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x49, 0x64, 0x22, 0x31, 0x0a, 0x12, 0x45, 0x76, 0x65, 0x6e,
	0x74, 0x41, 0x6c, 0x6c, 0x6f, 0x77, 0x41, 0x73, 0x6b, 0x44, 0x65, 0x6e, 0x6f, 0x6d, 0x12, 0x1b,
	0x0a, 0x09, 0x61, 0x73, 0x6b, 0x5f, 0x64, 0x65, 0x6e, 0x6f, 0x6d, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x08, 0x61, 0x73, 0x6b, 0x44, 0x65, 0x6e, 0x6f, 0x6d, 0x42, 0xa4, 0x02, 0x0a, 0x22,
