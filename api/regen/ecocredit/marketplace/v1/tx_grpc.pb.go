...
const (
	...
	Msg_SetMarketplaceFees_FullMethodName = "/regen.ecocredit.marketplace.v1.Msg/SetMarketplaceFees"
)
...
func (c *msgClient) UpdateSellOrders(ctx context.Context, in *MsgUpdateSellOrders, opts ...grpc.CallOption) (*MsgUpdateSellOrdersResponse, error) {
	...
	err := c.cc.Invoke(ctx, Msg_UpdateSellOrders_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) BuyDirect(ctx context.Context, in *MsgBuyDirect, opts ...grpc.CallOption) (*MsgBuyDirectResponse, error) {
	...
	err := c.cc.Invoke(ctx, Msg_BuyDirect_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) AddAllowedDenom(ctx context.Context, in *MsgAddAllowedDenom, opts ...grpc.CallOption) (*MsgAddAllowedDenomResponse, error) {
	...
	err := c.cc.Invoke(ctx, Msg_AddAllowedDenom_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) RemoveAllowedDenom(ctx context.Context, in *MsgRemoveAllowedDenom, opts ...grpc.CallOption) (*MsgRemoveAllowedDenomResponse, error) {
	...
	err := c.cc.Invoke(ctx, Msg_RemoveAllowedDenom_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) SetMarketplaceFees(ctx context.Context, in *MsgSetMarketplaceFees, opts ...grpc.CallOption) (*MsgSetMarketplaceFeesResponse, error) {
	...
	err := c.cc.Invoke(ctx, Msg_SetMarketplaceFees_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedMsgServer) SetMarketplaceFees(context.Context, *MsgSetMarketplaceFees) (*MsgSetMarketplaceFeesResponse, error) {
...
func _Msg_SetMarketplaceFees_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Msg_SetMarketplaceFees_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
