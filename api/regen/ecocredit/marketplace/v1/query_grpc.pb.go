...
const (
	Query_SellOrder_FullMethodName          = "/regen.ecocredit.marketplace.v1.Query/SellOrder"
	Query_SellOrders_FullMethodName         = "/regen.ecocredit.marketplace.v1.Query/SellOrders"
	Query_SellOrdersByBatch_FullMethodName  = "/regen.ecocredit.marketplace.v1.Query/SellOrdersByBatch"
	Query_SellOrdersBySeller_FullMethodName = "/regen.ecocredit.marketplace.v1.Query/SellOrdersBySeller"
	Query_AllowedDenoms_FullMethodName      = "/regen.ecocredit.marketplace.v1.Query/AllowedDenoms"
)
...
func (c *queryClient) SellOrder(ctx context.Context, in *QuerySellOrderRequest, opts ...grpc.CallOption) (*QuerySellOrderResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_SellOrder_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) SellOrders(ctx context.Context, in *QuerySellOrdersRequest, opts ...grpc.CallOption) (*QuerySellOrdersResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_SellOrders_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) SellOrdersByBatch(ctx context.Context, in *QuerySellOrdersByBatchRequest, opts ...grpc.CallOption) (*QuerySellOrdersByBatchResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_SellOrdersByBatch_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) SellOrdersBySeller(ctx context.Context, in *QuerySellOrdersBySellerRequest, opts ...grpc.CallOption) (*QuerySellOrdersBySellerResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_SellOrdersBySeller_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedQueryServer) SellOrder(context.Context, *QuerySellOrderRequest) (*QuerySellOrderResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method SellOrder not implemented")
}
func (UnimplementedQueryServer) SellOrders(context.Context, *QuerySellOrdersRequest) (*QuerySellOrdersResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method SellOrders not implemented")
}
func (UnimplementedQueryServer) SellOrdersByBatch(context.Context, *QuerySellOrdersByBatchRequest) (*QuerySellOrdersByBatchResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method SellOrdersByBatch not implemented")
}
func (UnimplementedQueryServer) SellOrdersBySeller(context.Context, *QuerySellOrdersBySellerRequest) (*QuerySellOrdersBySellerResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method SellOrdersBySeller not implemented")
}
func (UnimplementedQueryServer) AllowedDenoms(context.Context, *QueryAllowedDenomsRequest) (*QueryAllowedDenomsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method AllowedDenoms not implemented")
}
...
func _Query_SellOrders_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Query_SellOrders_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_SellOrdersByBatch_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Query_SellOrdersByBatch_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_SellOrdersBySeller_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Query_SellOrdersBySeller_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
