...
var (
	...
	fd_AllowedDenomProposal_denom       protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_AllowedDenomProposal_denom = md_AllowedDenomProposal.Fields().ByName("denom")
}
...
func (x *fastReflection_AllowedDenomProposal) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.Denom != nil {
		...
		if !f(fd_AllowedDenomProposal_denom, value) {
			return
		}
	}
}
...
func (x *fastReflection_AllowedDenomProposal) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "regen.ecocredit.marketplace.v1.AllowedDenomProposal.denom":
		return x.Denom != nil
	default:
		if fd.IsExtension() {
...
func (x *AllowedDenomProposal) GetDenom() *AllowedDenom {
	if x != nil {
		return x.Denom
	}
	return nil
...
var file_regen_ecocredit_marketplace_v1_types_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x2f, 0x67, 0x6f, 0x67, 0x6f, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x98,
	...
	0x42, 0x0a, 0x05, 0x64, 0x65, 0x6e, 0x6f, 0x6d, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2c,
	...
	0x41, 0x6c, 0x6c, 0x6f, 0x77, 0x65, 0x64, 0x44, 0x65, 0x6e, 0x6f, 0x6d, 0x52, 0x05, 0x64, 0x65,
	0x6e, 0x6f, 0x6d, 0x3a, 0x04, 0x98, 0xa0, 0x1f, 0x00, 0x42, 0xa3, 0x02, 0x0a, 0x22, 0x63, 0x6f,
	...
	0x42, 0x0a, 0x54, 0x79, 0x70, 0x65, 0x73, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x56,
...
var file_regen_ecocredit_marketplace_v1_types_proto_depIdxs = []int32{
	1, // 0: regen.ecocredit.marketplace.v1.AllowedDenomProposal.denom:type_name -> regen.ecocredit.marketplace.v1.AllowedDenom
