...
func (x *fastReflection_AskDenomProposal) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "regen.ecocredit.marketplace.v1.AskDenomProposal.ask_denom":
...
func init() {
	file_regen_ecocredit_marketplace_v1_types_proto_init()
	md_AskDenom = File_regen_ecocredit_marketplace_v1_types_proto.Messages().ByName("AskDenom")
...
func (x *fastReflection_AskDenom) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "regen.ecocredit.marketplace.v1.AskDenom.denom":
		return x.Denom != ""
	case "regen.ecocredit.marketplace.v1.AskDenom.display_denom":
		return x.DisplayDenom != ""
	case "regen.ecocredit.marketplace.v1.AskDenom.exponent":
		return x.Exponent != uint32(0)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: regen.ecocredit.marketplace.v1.AskDenom"))
		}
		panic(fmt.Errorf("message regen.ecocredit.marketplace.v1.AskDenom does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_AskDenom) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message regen.ecocredit.marketplace.v1.AskDenom does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_AskDenom) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "regen.ecocredit.marketplace.v1.AskDenom.denom":
		panic(fmt.Errorf("field denom of message regen.ecocredit.marketplace.v1.AskDenom is not mutable"))
	case "regen.ecocredit.marketplace.v1.AskDenom.display_denom":
		panic(fmt.Errorf("field display_denom of message regen.ecocredit.marketplace.v1.AskDenom is not mutable"))
	case "regen.ecocredit.marketplace.v1.AskDenom.exponent":
		panic(fmt.Errorf("field exponent of message regen.ecocredit.marketplace.v1.AskDenom is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: regen.ecocredit.marketplace.v1.AskDenom"))
		}
...
func (x *fastReflection_AskDenom) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in regen.ecocredit.marketplace.v1.AskDenom", d.FullName()))
	}
	panic("unreachable")
}
...
var file_regen_ecocredit_marketplace_v1_types_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x22, 0x97, 0x01, 0x0a, 0x10, 0x41, 0x73, 0x6b, 0x44, 0x65, 0x6e, 0x6f, 0x6d, 0x50,
	...
	0x45, 0x0a, 0x09, 0x61, 0x73, 0x6b, 0x5f, 0x64, 0x65, 0x6e, 0x6f, 0x6d, 0x18, 0x03, 0x20, 0x01,
	...
	0x2e, 0x76, 0x31, 0x2e, 0x41, 0x73, 0x6b, 0x44, 0x65, 0x6e, 0x6f, 0x6d, 0x52, 0x08, 0x61, 0x73,
	0x6b, 0x44, 0x65, 0x6e, 0x6f, 0x6d, 0x3a, 0x04, 0x98, 0xa0, 0x1f, 0x00, 0x22, 0x61, 0x0a, 0x08,
	...
	0x61, 0x63, 0x65, 0x2e, 0x76, 0x31, 0x42, 0x0a, 0x54, 0x79, 0x70, 0x65, 0x73, 0x50, 0x72, 0x6f,
...
var file_regen_ecocredit_marketplace_v1_types_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_regen_ecocredit_marketplace_v1_types_proto_goTypes = []interface{}{
	...
	(*AskDenom)(nil),         // 1: regen.ecocredit.marketplace.v1.AskDenom
}
var file_regen_ecocredit_marketplace_v1_types_proto_depIdxs = []int32{
	1, // 0: regen.ecocredit.marketplace.v1.AskDenomProposal.ask_denom:type_name -> regen.ecocredit.marketplace.v1.AskDenom
