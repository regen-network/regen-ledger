...
func (x *fastReflection_AllowedDenomProposal) ProtoMethods() *protoiface.Methods {
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if x.AllowedDenom != nil {
			encoded, err := options.Marshal(x.AllowedDenom)
			if err != nil {
				return protoiface.MarshalOutput{
					NoUnkeyedLiterals: input.NoUnkeyedLiterals,
					Buf:               input.Buf,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 3:
				...
				if x.AllowedDenom == nil {
					x.AllowedDenom = &AllowedDenom{}
				}
				if err := options.Unmarshal(dAtA[iNdEx:postIndex], x.AllowedDenom); err != nil {
