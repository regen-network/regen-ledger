...
func (x *fastReflection_SellOrder) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "regen.ecocredit.marketplace.v1.SellOrder.batch_id":
	...
	case "regen.ecocredit.marketplace.v1.SellOrder.ask_price":
		return x.AskPrice != ""
...
func (x *fastReflection_SellOrder) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "regen.ecocredit.marketplace.v1.SellOrder.batch_id":
		panic(fmt.Errorf("field batch_id of message regen.ecocredit.marketplace.v1.SellOrder is not mutable"))
	case "regen.ecocredit.marketplace.v1.SellOrder.quantity":
	...
	case "regen.ecocredit.marketplace.v1.SellOrder.ask_price":
		panic(fmt.Errorf("field ask_price of message regen.ecocredit.marketplace.v1.SellOrder is not mutable"))
	case "regen.ecocredit.marketplace.v1.SellOrder.disable_auto_retire":
...
func init() {
	file_regen_ecocredit_marketplace_v1_state_proto_init()
	md_BuyOrder = File_regen_ecocredit_marketplace_v1_state_proto.Messages().ByName("BuyOrder")
...
func (x *fastReflection_BuyOrder) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "regen.ecocredit.marketplace.v1.BuyOrder.id":
		return x.Id != uint64(0)
	case "regen.ecocredit.marketplace.v1.BuyOrder.buyer":
		return len(x.Buyer) != 0
	case "regen.ecocredit.marketplace.v1.BuyOrder.selection":
		return x.Selection != nil
	case "regen.ecocredit.marketplace.v1.BuyOrder.quantity":
		return x.Quantity != ""
	case "regen.ecocredit.marketplace.v1.BuyOrder.market_id":
		return x.MarketId != uint64(0)
	case "regen.ecocredit.marketplace.v1.BuyOrder.bid_price":
		return x.BidPrice != ""
	case "regen.ecocredit.marketplace.v1.BuyOrder.disable_auto_retire":
		return x.DisableAutoRetire != false
	case "regen.ecocredit.marketplace.v1.BuyOrder.disable_partial_fill":
		return x.DisablePartialFill != false
	case "regen.ecocredit.marketplace.v1.BuyOrder.expiration":
		return x.Expiration != nil
	case "regen.ecocredit.marketplace.v1.BuyOrder.maker":
		return x.Maker != false
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: regen.ecocredit.marketplace.v1.BuyOrder"))
		}
		panic(fmt.Errorf("message regen.ecocredit.marketplace.v1.BuyOrder does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_BuyOrder) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message regen.ecocredit.marketplace.v1.BuyOrder does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_BuyOrder) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "regen.ecocredit.marketplace.v1.BuyOrder.expiration":
		...
		return protoreflect.ValueOfMessage(x.Expiration.ProtoReflect())
	case "regen.ecocredit.marketplace.v1.BuyOrder.id":
		panic(fmt.Errorf("field id of message regen.ecocredit.marketplace.v1.BuyOrder is not mutable"))
	case "regen.ecocredit.marketplace.v1.BuyOrder.buyer":
		panic(fmt.Errorf("field buyer of message regen.ecocredit.marketplace.v1.BuyOrder is not mutable"))
	case "regen.ecocredit.marketplace.v1.BuyOrder.quantity":
		panic(fmt.Errorf("field quantity of message regen.ecocredit.marketplace.v1.BuyOrder is not mutable"))
	case "regen.ecocredit.marketplace.v1.BuyOrder.market_id":
		panic(fmt.Errorf("field market_id of message regen.ecocredit.marketplace.v1.BuyOrder is not mutable"))
	case "regen.ecocredit.marketplace.v1.BuyOrder.bid_price":
		panic(fmt.Errorf("field bid_price of message regen.ecocredit.marketplace.v1.BuyOrder is not mutable"))
	case "regen.ecocredit.marketplace.v1.BuyOrder.disable_auto_retire":
		panic(fmt.Errorf("field disable_auto_retire of message regen.ecocredit.marketplace.v1.BuyOrder is not mutable"))
	case "regen.ecocredit.marketplace.v1.BuyOrder.disable_partial_fill":
		panic(fmt.Errorf("field disable_partial_fill of message regen.ecocredit.marketplace.v1.BuyOrder is not mutable"))
	case "regen.ecocredit.marketplace.v1.BuyOrder.maker":
		panic(fmt.Errorf("field maker of message regen.ecocredit.marketplace.v1.BuyOrder is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: regen.ecocredit.marketplace.v1.BuyOrder"))
		}
...
func (x *fastReflection_BuyOrder) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in regen.ecocredit.marketplace.v1.BuyOrder", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_regen_ecocredit_marketplace_v1_state_proto_init()
	md_BuyOrder_Selection = File_regen_ecocredit_marketplace_v1_state_proto.Messages().ByName("BuyOrder").Messages().ByName("Selection")
...
func (x *BuyOrder_Selection) slowProtoReflect() protoreflect.Message {
	mi := &file_regen_ecocredit_marketplace_v1_state_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_BuyOrder_Selection) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "regen.ecocredit.marketplace.v1.BuyOrder.Selection.sell_order_id":
		if x.Sum == nil {
			return false
	...
	case "regen.ecocredit.marketplace.v1.BuyOrder.Selection.filter":
		if x.Sum == nil {
			return false
	...
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: regen.ecocredit.marketplace.v1.BuyOrder.Selection"))
		}
		panic(fmt.Errorf("message regen.ecocredit.marketplace.v1.BuyOrder.Selection does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_BuyOrder_Selection) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message regen.ecocredit.marketplace.v1.BuyOrder.Selection does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_BuyOrder_Selection) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "regen.ecocredit.marketplace.v1.BuyOrder.Selection.sell_order_id":
		panic(fmt.Errorf("field sell_order_id of message regen.ecocredit.marketplace.v1.BuyOrder.Selection is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: regen.ecocredit.marketplace.v1.BuyOrder.Selection"))
		}
...
func (x *fastReflection_BuyOrder_Selection) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	case "regen.ecocredit.marketplace.v1.BuyOrder.Selection.sum":
		if x.Sum == nil {
			return nil
		}
		switch x.Sum.(type) {
	...
	default:
		panic(fmt.Errorf("%s is not a oneof field in regen.ecocredit.marketplace.v1.BuyOrder.Selection", d.FullName()))
	}
	panic("unreachable")
}
...
var (
	...
	fd_AllowedDenom_base_currency protoreflect.FieldDescriptor
...
func init() {
	...
	fd_AllowedDenom_base_currency = md_AllowedDenom.Fields().ByName("base_currency")
...
func (x *fastReflection_AllowedDenom) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.BaseCurrency != "" {
		...
		if !f(fd_AllowedDenom_base_currency, value) {
			return
		}
	}
	if x.DisplayDenom != "" {
...
func (x *fastReflection_AllowedDenom) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "regen.ecocredit.marketplace.v1.AllowedDenom.base_currency":
...
func (x *fastReflection_AllowedDenom) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "regen.ecocredit.marketplace.v1.AllowedDenom.base_currency":
		panic(fmt.Errorf("field base_currency of message regen.ecocredit.marketplace.v1.AllowedDenom is not mutable"))
	case "regen.ecocredit.marketplace.v1.AllowedDenom.display_denom":
...
var (
	...
	fd_Market_base_currency      protoreflect.FieldDescriptor
...
func init() {
	...
	fd_Market_base_currency = md_Market.Fields().ByName("base_currency")
...
func (x *Market) slowProtoReflect() protoreflect.Message {
	mi := &file_regen_ecocredit_marketplace_v1_state_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_Market) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.BaseCurrency != "" {
		value := protoreflect.ValueOfString(x.BaseCurrency)
		if !f(fd_Market_base_currency, value) {
			return
		}
	}
...
func (x *fastReflection_Market) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "regen.ecocredit.marketplace.v1.Market.id":
		return x.Id != uint64(0)
	case "regen.ecocredit.marketplace.v1.Market.credit_type":
		return x.CreditType != ""
	case "regen.ecocredit.marketplace.v1.Market.base_currency":
		return x.BaseCurrency != ""
...
func (x *fastReflection_Market) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "regen.ecocredit.marketplace.v1.Market.credit_type":
		panic(fmt.Errorf("field credit_type of message regen.ecocredit.marketplace.v1.Market is not mutable"))
	case "regen.ecocredit.marketplace.v1.Market.base_currency":
		panic(fmt.Errorf("field base_currency of message regen.ecocredit.marketplace.v1.Market is not mutable"))
	case "regen.ecocredit.marketplace.v1.Market.precision_modifier":
...
func (x *SellOrder) GetAskPrice() string {
	if x != nil {
		return x.AskPrice
	}
	return ""
...
func (x *AllowedDenom) GetBaseCurrency() string {
	if x != nil {
		return x.BaseCurrency
	}
	return ""
...
func (*Market) Descriptor() ([]byte, []int) {
	return file_regen_ecocredit_marketplace_v1_state_proto_rawDescGZIP(), []int{3}
}
...
func (*BuyOrder_Selection) Descriptor() ([]byte, []int) {
	return file_regen_ecocredit_marketplace_v1_state_proto_rawDescGZIP(), []int{1, 0}
}
...
var file_regen_ecocredit_marketplace_v1_state_proto_rawDesc = []byte{
	...
	,
	...
	0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x61, 0x73, 0x6b, 0x50, 0x72, 0x69, 0x63, 0x65, 0x12,
	...
	,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x71, 0x75, 0x61, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x12, 0x1b,
	0x0a, 0x09, 0x6d, 0x61, 0x72, 0x6b, 0x65, 0x74, 0x5f, 0x69, 0x64, 0x18, 0x05, 0x20, 0x01, 0x28,
	0x04, 0x52, 0x08, 0x6d, 0x61, 0x72, 0x6b, 0x65, 0x74, 0x49, 0x64, 0x12, 0x1b, 0x0a, 0x09, 0x62,
	0x69, 0x64, 0x5f, 0x70, 0x72, 0x69, 0x63, 0x65, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08,
	...
	0x07, 0x20, 0x01, 0x28, 0x08, 0x52, 0x11, 0x64, 0x69, 0x73, 0x61, 0x62, 0x6c, 0x65, 0x41, 0x75,
	...
	0x18, 0x08, 0x20, 0x01, 0x28, 0x08, 0x52, 0x12, 0x64, 0x69, 0x73, 0x61, 0x62, 0x6c, 0x65, 0x50,
	0x61, 0x72, 0x74, 0x69, 0x61, 0x6c, 0x46, 0x69, 0x6c, 0x6c, 0x12, 0x3a, 0x0a, 0x0a, 0x65, 0x78,
	...
	0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x14, 0x0a, 0x05, 0x6d, 0x61, 0x6b, 0x65, 0x72, 0x18,
	0x0a, 0x20, 0x01, 0x28, 0x08, 0x52, 0x05, 0x6d, 0x61, 0x6b, 0x65, 0x72, 0x1a, 0x7a, 0x0a, 0x09,
	...
	0x72, 0x42, 0x05, 0x0a, 0x03, 0x73, 0x75, 0x6d, 0x3a, 0x2b, 0xf2, 0x9e, 0xd3, 0x8e, 0x03, 0x25,
	0x0a, 0x06, 0x0a, 0x02, 0x69, 0x64, 0x10, 0x01, 0x12, 0x09, 0x0a, 0x05, 0x62, 0x75, 0x79, 0x65,
	0x72, 0x10, 0x01, 0x12, 0x0e, 0x0a, 0x0a, 0x65, 0x78, 0x70, 0x69, 0x72, 0x61, 0x74, 0x69, 0x6f,
	0x6e, 0x10, 0x02, 0x18, 0x02, 0x22, 0xa4, 0x01, 0x0a, 0x0c, 0x41, 0x6c, 0x6c, 0x6f, 0x77, 0x65,
	0x64, 0x44, 0x65, 0x6e, 0x6f, 0x6d, 0x12, 0x23, 0x0a, 0x0d, 0x62, 0x61, 0x73, 0x65, 0x5f, 0x63,
	0x75, 0x72, 0x72, 0x65, 0x6e, 0x63, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0c, 0x62,
	0x61, 0x73, 0x65, 0x43, 0x75, 0x72, 0x72, 0x65, 0x6e, 0x63, 0x79, 0x12, 0x23, 0x0a, 0x0d, 0x64,
	...
	0x28, 0x0d, 0x52, 0x08, 0x65, 0x78, 0x70, 0x6f, 0x6e, 0x65, 0x6e, 0x74, 0x3a, 0x2e, 0xf2, 0x9e,
	0xd3, 0x8e, 0x03, 0x28, 0x0a, 0x0f, 0x0a, 0x0d, 0x62, 0x61, 0x73, 0x65, 0x5f, 0x63, 0x75, 0x72,
	0x72, 0x65, 0x6e, 0x63, 0x79, 0x12, 0x13, 0x0a, 0x0d, 0x64, 0x69, 0x73, 0x70, 0x6c, 0x61, 0x79,
	0x5f, 0x64, 0x65, 0x6e, 0x6f, 0x6d, 0x10, 0x01, 0x18, 0x01, 0x18, 0x03, 0x22, 0xc0, 0x01, 0x0a,
	...
	,
	...
	0x61, 0x63, 0x65, 0x2e, 0x76, 0x31, 0x42, 0x0a, 0x53, 0x74, 0x61, 0x74, 0x65, 0x50, 0x72, 0x6f,
...
var file_regen_ecocredit_marketplace_v1_state_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_regen_ecocredit_marketplace_v1_state_proto_goTypes = []interface{}{
	...
	(*BuyOrder)(nil),              // 1: regen.ecocredit.marketplace.v1.BuyOrder
	(*AllowedDenom)(nil),          // 2: regen.ecocredit.marketplace.v1.AllowedDenom
	(*Market)(nil),                // 3: regen.ecocredit.marketplace.v1.Market
	(*BuyOrder_Selection)(nil),    // 4: regen.ecocredit.marketplace.v1.BuyOrder.Selection
	(*timestamppb.Timestamp)(nil), // 5: google.protobuf.Timestamp
	(*Filter)(nil),                // 6: regen.ecocredit.marketplace.v1.Filter
}
var file_regen_ecocredit_marketplace_v1_state_proto_depIdxs = []int32{
	5, // 0: regen.ecocredit.marketplace.v1.SellOrder.expiration:type_name -> google.protobuf.Timestamp
	4, // 1: regen.ecocredit.marketplace.v1.BuyOrder.selection:type_name -> regen.ecocredit.marketplace.v1.BuyOrder.Selection
	5, // 2: regen.ecocredit.marketplace.v1.BuyOrder.expiration:type_name -> google.protobuf.Timestamp
	6, // 3: regen.ecocredit.marketplace.v1.BuyOrder.Selection.filter:type_name -> regen.ecocredit.marketplace.v1.Filter
...
func file_regen_ecocredit_marketplace_v1_state_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_regen_ecocredit_marketplace_v1_state_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Market); i {
			case 0:
				return &v.state
			case 1:
		...
		file_regen_ecocredit_marketplace_v1_state_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	file_regen_ecocredit_marketplace_v1_state_proto_msgTypes[4].OneofWrappers = []interface{}{
