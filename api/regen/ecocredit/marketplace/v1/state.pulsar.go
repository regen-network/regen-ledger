...
var (
	...
	fd_FeeParams_buyer_percentage_fee  protoreflect.FieldDescriptor
	fd_FeeParams_seller_percentage_fee protoreflect.FieldDescriptor
)

func init() {
	file_regen_ecocredit_marketplace_v1_state_proto_init()
	md_FeeParams = File_regen_ecocredit_marketplace_v1_state_proto.Messages().ByName("FeeParams")
	fd_FeeParams_buyer_percentage_fee = md_FeeParams.Fields().ByName("buyer_percentage_fee")
	fd_FeeParams_seller_percentage_fee = md_FeeParams.Fields().ByName("seller_percentage_fee")
}
...
func (x *fastReflection_FeeParams) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.BuyerPercentageFee != "" {
		value := protoreflect.ValueOfString(x.BuyerPercentageFee)
		if !f(fd_FeeParams_buyer_percentage_fee, value) {
			return
		}
	}
	if x.SellerPercentageFee != "" {
		value := protoreflect.ValueOfString(x.SellerPercentageFee)
		if !f(fd_FeeParams_seller_percentage_fee, value) {
			return
		}
	}
}
...
func (x *fastReflection_FeeParams) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "regen.ecocredit.marketplace.v1.FeeParams.buyer_percentage_fee":
		return x.BuyerPercentageFee != ""
	case "regen.ecocredit.marketplace.v1.FeeParams.seller_percentage_fee":
		return x.SellerPercentageFee != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: regen.ecocredit.marketplace.v1.FeeParams"))
		}
		panic(fmt.Errorf("message regen.ecocredit.marketplace.v1.FeeParams does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_FeeParams) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "regen.ecocredit.marketplace.v1.FeeParams.buyer_percentage_fee":
		x.BuyerPercentageFee = ""
	case "regen.ecocredit.marketplace.v1.FeeParams.seller_percentage_fee":
		x.SellerPercentageFee = ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: regen.ecocredit.marketplace.v1.FeeParams"))
		}
...
func (x *fastReflection_FeeParams) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "regen.ecocredit.marketplace.v1.FeeParams.buyer_percentage_fee":
		value := x.BuyerPercentageFee
		return protoreflect.ValueOfString(value)
	case "regen.ecocredit.marketplace.v1.FeeParams.seller_percentage_fee":
		value := x.SellerPercentageFee
		return protoreflect.ValueOfString(value)
	default:
		if descriptor.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: regen.ecocredit.marketplace.v1.FeeParams"))
		}
		panic(fmt.Errorf("message regen.ecocredit.marketplace.v1.FeeParams does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_FeeParams) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "regen.ecocredit.marketplace.v1.FeeParams.buyer_percentage_fee":
		x.BuyerPercentageFee = value.Interface().(string)
	case "regen.ecocredit.marketplace.v1.FeeParams.seller_percentage_fee":
		x.SellerPercentageFee = value.Interface().(string)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: regen.ecocredit.marketplace.v1.FeeParams"))
		}
...
func (x *fastReflection_FeeParams) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "regen.ecocredit.marketplace.v1.FeeParams.buyer_percentage_fee":
		panic(fmt.Errorf("field buyer_percentage_fee of message regen.ecocredit.marketplace.v1.FeeParams is not mutable"))
	case "regen.ecocredit.marketplace.v1.FeeParams.seller_percentage_fee":
		panic(fmt.Errorf("field seller_percentage_fee of message regen.ecocredit.marketplace.v1.FeeParams is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: regen.ecocredit.marketplace.v1.FeeParams"))
		}
...
func (x *fastReflection_FeeParams) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in regen.ecocredit.marketplace.v1.FeeParams", d.FullName()))
	}
	panic("unreachable")
}
...
func (x *fastReflection_FeeParams) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		...
		var l int
		_ = l
		l = len(x.BuyerPercentageFee)
		if l > 0 {
			n += 1 + l + runtime.Sov(uint64(l))
		}
		l = len(x.SellerPercentageFee)
		if l > 0 {
			n += 1 + l + runtime.Sov(uint64(l))
		}
		if x.unknownFields != nil {
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.SellerPercentageFee) > 0 {
			i -= len(x.SellerPercentageFee)
			copy(dAtA[i:], x.SellerPercentageFee)
			i = runtime.EncodeVarint(dAtA, i, uint64(len(x.SellerPercentageFee)))
			i--
			dAtA[i] = 0x12
		}
		if len(x.BuyerPercentageFee) > 0 {
			i -= len(x.BuyerPercentageFee)
			copy(dAtA[i:], x.BuyerPercentageFee)
			i = runtime.EncodeVarint(dAtA, i, uint64(len(x.BuyerPercentageFee)))
			i--
			dAtA[i] = 0xa
		}
		if input.Buf != nil {
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 1:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field BuyerPercentageFee", wireType)
				}
				var stringLen uint64
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.BuyerPercentageFee = string(dAtA[iNdEx:postIndex])
				iNdEx = postIndex
			case 2:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field SellerPercentageFee", wireType)
				}
				var stringLen uint64
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.SellerPercentageFee = string(dAtA[iNdEx:postIndex])
				iNdEx = postIndex
			default:
				iNdEx = preIndex
				skippy, err := runtime.Skip(dAtA[iNdEx:])
...
func (x *FeeParams) GetBuyerPercentageFee() string {
	if x != nil {
		return x.BuyerPercentageFee
	}
	return ""
...
func (x *FeeParams) GetSellerPercentageFee() string {
	if x != nil {
		return x.SellerPercentageFee
	}
	return ""
...
var file_regen_ecocredit_marketplace_v1_state_proto_rawDesc = []byte{
	...
	,
	...
	0x64, 0x12, 0x1d, 0x0a, 0x0a, 0x61, 0x73, 0x6b, 0x5f, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x18,
	0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x61, 0x73, 0x6b, 0x41, 0x6d, 0x6f, 0x75, 0x6e, 0x74,
	0x12, 0x2e, 0x0a, 0x13, 0x64, 0x69, 0x73, 0x61, 0x62, 0x6c, 0x65, 0x5f, 0x61, 0x75, 0x74, 0x6f,
	0x5f, 0x72, 0x65, 0x74, 0x69, 0x72, 0x65, 0x18, 0x07, 0x20, 0x01, 0x28, 0x08, 0x52, 0x11, 0x64,
	...
	0x65, 0x72, 0x3a, 0x3b, 0xf2, 0x9e, 0xd3, 0x8e, 0x03, 0x35, 0x0a, 0x06, 0x0a, 0x02, 0x69, 0x64,
	0x10, 0x01, 0x12, 0x0d, 0x0a, 0x09, 0x62, 0x61, 0x74, 0x63, 0x68, 0x5f, 0x6b, 0x65, 0x79, 0x10,
	0x01, 0x12, 0x0a, 0x0a, 0x06, 0x73, 0x65, 0x6c, 0x6c, 0x65, 0x72, 0x10, 0x02, 0x12, 0x0e, 0x0a,
	...
	,
	...
	0x64, 0x67, 0x65, 0x72, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x76, 0x32, 0x2f, 0x72, 0x65, 0x67, 0x65,
...
var file_regen_ecocredit_marketplace_v1_state_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_regen_ecocredit_marketplace_v1_state_proto_goTypes = []interface{}{
	...
	(*FeeParams)(nil),             // 3: regen.ecocredit.marketplace.v1.FeeParams
	(*timestamppb.Timestamp)(nil), // 4: google.protobuf.Timestamp
}
var file_regen_ecocredit_marketplace_v1_state_proto_depIdxs = []int32{
	4, // 0: regen.ecocredit.marketplace.v1.SellOrder.expiration:type_name -> google.protobuf.Timestamp
