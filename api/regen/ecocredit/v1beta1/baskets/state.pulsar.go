...
func init() {
	file_regen_ecocredit_v1beta1_baskets_state_proto_init()
	md_BasketBalance = File_regen_ecocredit_v1beta1_baskets_state_proto.Messages().ByName("BasketBalance")
...
func (x *BasketBalance) slowProtoReflect() protoreflect.Message {
	mi := &file_regen_ecocredit_v1beta1_baskets_state_proto_msgTypes[0]
...
func (x *fastReflection_BasketBalance) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "regen.ecocredit.v1beta1.baskets.BasketBalance.basket_denom":
		return x.BasketDenom != ""
	case "regen.ecocredit.v1beta1.baskets.BasketBalance.batch_id":
		return x.BatchId != uint64(0)
	case "regen.ecocredit.v1beta1.baskets.BasketBalance.balance":
		return x.Balance != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: regen.ecocredit.v1beta1.baskets.BasketBalance"))
		}
		panic(fmt.Errorf("message regen.ecocredit.v1beta1.baskets.BasketBalance does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_BasketBalance) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message regen.ecocredit.v1beta1.baskets.BasketBalance does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_BasketBalance) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "regen.ecocredit.v1beta1.baskets.BasketBalance.basket_denom":
		panic(fmt.Errorf("field basket_denom of message regen.ecocredit.v1beta1.baskets.BasketBalance is not mutable"))
	case "regen.ecocredit.v1beta1.baskets.BasketBalance.batch_id":
		panic(fmt.Errorf("field batch_id of message regen.ecocredit.v1beta1.baskets.BasketBalance is not mutable"))
	case "regen.ecocredit.v1beta1.baskets.BasketBalance.balance":
		panic(fmt.Errorf("field balance of message regen.ecocredit.v1beta1.baskets.BasketBalance is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: regen.ecocredit.v1beta1.baskets.BasketBalance"))
		}
...
func (x *fastReflection_BasketBalance) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in regen.ecocredit.v1beta1.baskets.BasketBalance", d.FullName()))
	}
	panic("unreachable")
}
...
// 	protoc        (unknown)
// source: regen/ecocredit/v1beta1/baskets/state.proto
...
func (*BasketBalance) Descriptor() ([]byte, []int) {
	return file_regen_ecocredit_v1beta1_baskets_state_proto_rawDescGZIP(), []int{0}
}
...
var File_regen_ecocredit_v1beta1_baskets_state_proto protoreflect.FileDescriptor

var file_regen_ecocredit_v1beta1_baskets_state_proto_rawDesc = []byte{
	,
	...
	,
	...
	,
}

var (
	file_regen_ecocredit_v1beta1_baskets_state_proto_rawDescOnce sync.Once
	file_regen_ecocredit_v1beta1_baskets_state_proto_rawDescData = file_regen_ecocredit_v1beta1_baskets_state_proto_rawDesc
)

func file_regen_ecocredit_v1beta1_baskets_state_proto_rawDescGZIP() []byte {
	file_regen_ecocredit_v1beta1_baskets_state_proto_rawDescOnce.Do(func() {
		file_regen_ecocredit_v1beta1_baskets_state_proto_rawDescData = protoimpl.X.CompressGZIP(file_regen_ecocredit_v1beta1_baskets_state_proto_rawDescData)
	})
	return file_regen_ecocredit_v1beta1_baskets_state_proto_rawDescData
}

var file_regen_ecocredit_v1beta1_baskets_state_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_regen_ecocredit_v1beta1_baskets_state_proto_goTypes = []interface{}{
	(*BasketBalance)(nil), // 0: regen.ecocredit.v1beta1.baskets.BasketBalance
}
var file_regen_ecocredit_v1beta1_baskets_state_proto_depIdxs = []int32{
...
func init() { file_regen_ecocredit_v1beta1_baskets_state_proto_init() }
func file_regen_ecocredit_v1beta1_baskets_state_proto_init() {
	if File_regen_ecocredit_v1beta1_baskets_state_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_regen_ecocredit_v1beta1_baskets_state_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_regen_ecocredit_v1beta1_baskets_state_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_regen_ecocredit_v1beta1_baskets_state_proto_goTypes,
		DependencyIndexes: file_regen_ecocredit_v1beta1_baskets_state_proto_depIdxs,
		MessageInfos:      file_regen_ecocredit_v1beta1_baskets_state_proto_msgTypes,
	}.Build()
	File_regen_ecocredit_v1beta1_baskets_state_proto = out.File
	file_regen_ecocredit_v1beta1_baskets_state_proto_rawDesc = nil
	file_regen_ecocredit_v1beta1_baskets_state_proto_goTypes = nil
	file_regen_ecocredit_v1beta1_baskets_state_proto_depIdxs = nil
}
