...
func (x *ContentHash_Graph) slowProtoReflect() protoreflect.Message {
	mi := &file_regen_data_v1alpha2_types_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
var (
	...
	fd_Content_raw_data protoreflect.FieldDescriptor
)

func init() {
	file_regen_data_v1alpha2_types_proto_init()
	md_Content = File_regen_data_v1alpha2_types_proto.Messages().ByName("Content")
	fd_Content_raw_data = md_Content.Fields().ByName("raw_data")
}
...
func (x *fastReflection_Content) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.Sum != nil {
		switch o := x.Sum.(type) {
		case *Content_RawData:
			v := o.RawData
			value := protoreflect.ValueOfBytes(v)
			if !f(fd_Content_raw_data, value) {
				return
			}
		}
	}
...
func (x *fastReflection_Content) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "regen.data.v1alpha2.Content.raw_data":
		if x.Sum == nil {
			return false
		} else if _, ok := x.Sum.(*Content_RawData); ok {
			return true
		} else {
			return false
		}
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: regen.data.v1alpha2.Content"))
		}
		panic(fmt.Errorf("message regen.data.v1alpha2.Content does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Content) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "regen.data.v1alpha2.Content.raw_data":
		if x.Sum == nil {
			return protoreflect.ValueOfBytes(nil)
		} else if v, ok := x.Sum.(*Content_RawData); ok {
			return protoreflect.ValueOfBytes(v.RawData)
		} else {
			return protoreflect.ValueOfBytes(nil)
		}
	default:
		...
		panic(fmt.Errorf("message regen.data.v1alpha2.Content does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Content) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "regen.data.v1alpha2.Content.raw_data":
		cv := value.Bytes()
		x.Sum = &Content_RawData{RawData: cv}
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: regen.data.v1alpha2.Content"))
		}
...
func (x *fastReflection_Content) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "regen.data.v1alpha2.Content.raw_data":
		panic(fmt.Errorf("field raw_data of message regen.data.v1alpha2.Content is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: regen.data.v1alpha2.Content"))
		}
...
func (x *fastReflection_Content) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	case "regen.data.v1alpha2.Content.sum":
		if x.Sum == nil {
			return nil
		}
		switch x.Sum.(type) {
		case *Content_RawData:
			return x.Descriptor().Fields().ByName("raw_data")
		}
	default:
		panic(fmt.Errorf("%s is not a oneof field in regen.data.v1alpha2.Content", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_regen_data_v1alpha2_types_proto_init()
	md_ContentHashes = File_regen_data_v1alpha2_types_proto.Messages().ByName("ContentHashes")
...
func (x *fastReflection_ContentHashes) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "regen.data.v1alpha2.ContentHashes.data":
		return len(x.Data) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: regen.data.v1alpha2.ContentHashes"))
		}
		panic(fmt.Errorf("message regen.data.v1alpha2.ContentHashes does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_ContentHashes) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message regen.data.v1alpha2.ContentHashes does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_ContentHashes) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in regen.data.v1alpha2.ContentHashes", d.FullName()))
	}
	panic("unreachable")
}
...
func (x *Content) GetRawData() []byte {
	if x, ok := x.GetSum().(*Content_RawData); ok {
		return x.RawData
	}
	return nil
}
...
var file_regen_data_v1alpha2_types_proto_rawDesc = []byte{
	...
	,
	...
	0x54, 0x48, 0x4d, 0x5f, 0x42, 0x4c, 0x41, 0x4b, 0x45, 0x32, 0x42, 0x5f, 0x32, 0x35, 0x36, 0x10,
	0x01, 0x42, 0xdf, 0x01, 0x0a, 0x17, 0x63, 0x6f, 0x6d, 0x2e, 0x72, 0x65, 0x67, 0x65, 0x6e, 0x2e,
	0x64, 0x61, 0x74, 0x61, 0x2e, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x32, 0x42, 0x0a, 0x54,
...
var file_regen_data_v1alpha2_types_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_regen_data_v1alpha2_types_proto_goTypes = []interface{}{
	...
	(*Content)(nil),                     // 5: regen.data.v1alpha2.Content
	(*SignerEntry)(nil),                 // 6: regen.data.v1alpha2.SignerEntry
	(*ContentHash_Raw)(nil),             // 7: regen.data.v1alpha2.ContentHash.Raw
...
var file_regen_data_v1alpha2_types_proto_depIdxs = []int32{
	7, // 0: regen.data.v1alpha2.ContentHash.raw:type_name -> regen.data.v1alpha2.ContentHash.Raw
	8, // 1: regen.data.v1alpha2.ContentHash.graph:type_name -> regen.data.v1alpha2.ContentHash.Graph
	9, // 2: regen.data.v1alpha2.SignerEntry.timestamp:type_name -> google.protobuf.Timestamp
...
func file_regen_data_v1alpha2_types_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_regen_data_v1alpha2_types_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	file_regen_data_v1alpha2_types_proto_msgTypes[1].OneofWrappers = []interface{}{
		(*Content_RawData)(nil),
	}
	type x struct{}
