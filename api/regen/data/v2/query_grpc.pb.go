...
const (
	Query_AnchorByIRI_FullMethodName            = "/regen.data.v2.Query/AnchorByIRI"
	Query_AnchorByHash_FullMethodName           = "/regen.data.v2.Query/AnchorByHash"
	Query_AttestationsByAttestor_FullMethodName = "/regen.data.v2.Query/AttestationsByAttestor"
	Query_AttestationsByIRI_FullMethodName      = "/regen.data.v2.Query/AttestationsByIRI"
	Query_AttestationsByHash_FullMethodName     = "/regen.data.v2.Query/AttestationsByHash"
	Query_Resolver_FullMethodName               = "/regen.data.v2.Query/Resolver"
	Query_ResolversByIRI_FullMethodName         = "/regen.data.v2.Query/ResolversByIRI"
	Query_ResolversByHash_FullMethodName        = "/regen.data.v2.Query/ResolversByHash"
	Query_ResolversByURL_FullMethodName         = "/regen.data.v2.Query/ResolversByURL"
	Query_ConvertIRIToHash_FullMethodName       = "/regen.data.v2.Query/ConvertIRIToHash"
	Query_ConvertHashToIRI_FullMethodName       = "/regen.data.v2.Query/ConvertHashToIRI"
)
...
func (c *queryClient) AnchorByIRI(ctx context.Context, in *QueryAnchorByIRIRequest, opts ...grpc.CallOption) (*QueryAnchorByIRIResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_AnchorByIRI_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) AnchorByHash(ctx context.Context, in *QueryAnchorByHashRequest, opts ...grpc.CallOption) (*QueryAnchorByHashResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_AnchorByHash_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) AttestationsByIRI(ctx context.Context, in *QueryAttestationsByIRIRequest, opts ...grpc.CallOption) (*QueryAttestationsByIRIResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_AttestationsByIRI_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) AttestationsByHash(ctx context.Context, in *QueryAttestationsByHashRequest, opts ...grpc.CallOption) (*QueryAttestationsByHashResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_AttestationsByHash_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) Resolver(ctx context.Context, in *QueryResolverRequest, opts ...grpc.CallOption) (*QueryResolverResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_Resolver_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) ResolversByIRI(ctx context.Context, in *QueryResolversByIRIRequest, opts ...grpc.CallOption) (*QueryResolversByIRIResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_ResolversByIRI_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) ResolversByHash(ctx context.Context, in *QueryResolversByHashRequest, opts ...grpc.CallOption) (*QueryResolversByHashResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_ResolversByHash_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) ResolversByURL(ctx context.Context, in *QueryResolversByURLRequest, opts ...grpc.CallOption) (*QueryResolversByURLResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_ResolversByURL_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) ConvertIRIToHash(ctx context.Context, in *ConvertIRIToHashRequest, opts ...grpc.CallOption) (*ConvertIRIToHashResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_ConvertIRIToHash_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) ConvertHashToIRI(ctx context.Context, in *ConvertHashToIRIRequest, opts ...grpc.CallOption) (*ConvertHashToIRIResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_ConvertHashToIRI_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedQueryServer) AnchorByIRI(context.Context, *QueryAnchorByIRIRequest) (*QueryAnchorByIRIResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method AnchorByIRI not implemented")
}
func (UnimplementedQueryServer) AnchorByHash(context.Context, *QueryAnchorByHashRequest) (*QueryAnchorByHashResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method AnchorByHash not implemented")
}
...
func (UnimplementedQueryServer) AttestationsByIRI(context.Context, *QueryAttestationsByIRIRequest) (*QueryAttestationsByIRIResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method AttestationsByIRI not implemented")
}
func (UnimplementedQueryServer) AttestationsByHash(context.Context, *QueryAttestationsByHashRequest) (*QueryAttestationsByHashResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method AttestationsByHash not implemented")
}
func (UnimplementedQueryServer) Resolver(context.Context, *QueryResolverRequest) (*QueryResolverResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method Resolver not implemented")
}
func (UnimplementedQueryServer) ResolversByIRI(context.Context, *QueryResolversByIRIRequest) (*QueryResolversByIRIResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ResolversByIRI not implemented")
}
func (UnimplementedQueryServer) ResolversByHash(context.Context, *QueryResolversByHashRequest) (*QueryResolversByHashResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ResolversByHash not implemented")
}
func (UnimplementedQueryServer) ResolversByURL(context.Context, *QueryResolversByURLRequest) (*QueryResolversByURLResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ResolversByURL not implemented")
}
func (UnimplementedQueryServer) ConvertIRIToHash(context.Context, *ConvertIRIToHashRequest) (*ConvertIRIToHashResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ConvertIRIToHash not implemented")
}
func (UnimplementedQueryServer) ConvertHashToIRI(context.Context, *ConvertHashToIRIRequest) (*ConvertHashToIRIResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ConvertHashToIRI not implemented")
}
