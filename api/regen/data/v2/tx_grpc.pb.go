...
const (
	Msg_Anchor_FullMethodName           = "/regen.data.v2.Msg/Anchor"
	Msg_Attest_FullMethodName           = "/regen.data.v2.Msg/Attest"
	Msg_DefineResolver_FullMethodName   = "/regen.data.v2.Msg/DefineResolver"
	Msg_RegisterResolver_FullMethodName = "/regen.data.v2.Msg/RegisterResolver"
)
...
func (c *msgClient) Anchor(ctx context.Context, in *MsgAnchor, opts ...grpc.CallOption) (*MsgAnchorResponse, error) {
	...
	err := c.cc.Invoke(ctx, Msg_Anchor_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) Attest(ctx context.Context, in *MsgAttest, opts ...grpc.CallOption) (*MsgAttestResponse, error) {
	...
	err := c.cc.Invoke(ctx, Msg_Attest_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) DefineResolver(ctx context.Context, in *MsgDefineResolver, opts ...grpc.CallOption) (*MsgDefineResolverResponse, error) {
	...
	err := c.cc.Invoke(ctx, Msg_DefineResolver_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) RegisterResolver(ctx context.Context, in *MsgRegisterResolver, opts ...grpc.CallOption) (*MsgRegisterResolverResponse, error) {
	...
	err := c.cc.Invoke(ctx, Msg_RegisterResolver_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedMsgServer) Anchor(context.Context, *MsgAnchor) (*MsgAnchorResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method Anchor not implemented")
}
...
func (UnimplementedMsgServer) DefineResolver(context.Context, *MsgDefineResolver) (*MsgDefineResolverResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method DefineResolver not implemented")
}
func (UnimplementedMsgServer) RegisterResolver(context.Context, *MsgRegisterResolver) (*MsgRegisterResolverResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method RegisterResolver not implemented")
}
