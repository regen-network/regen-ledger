...
const (
	...
	ormListPkg  = protogen.GoImportPath("github.com/regen-network/regen-ledger/api/v2/orm/model/ormlist")
	ormErrPkg   = protogen.GoImportPath("github.com/regen-network/regen-ledger/api/v2/orm/types/ormerrors")
	ormTablePkg = protogen.GoImportPath("github.com/regen-network/regen-ledger/api/v2/orm/model/ormtable")
)
