...
require (
	...
	github.com/evmos/evmos/v19 v19.2.1
...
replace (
	...
	// use the regen fork of the evmos fork
	github.com/cosmos/cosmos-sdk => github.com/regen-network/cosmos-sdk v0.47.15-evmos-regen
	// dgrijalva/jwt-go is deprecated and doesn't receive security updates.
	github.com/dgrijalva/jwt-go => github.com/golang-jwt/jwt/v4 v4.4.2
	// use evmos fork of go-ethereum
