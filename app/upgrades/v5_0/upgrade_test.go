...
import (
	...
	ecocredit "github.com/regen-network/regen-ledger/x/ecocredit/v3/base/types/v1"
)
...
func (suite *UpgradeTestSuite) TestV5Upgrade() {
	...
	ss.SetParamSet(suite.Ctx, &ecocredit.Params{CreditClassFee: fees, BasketFee: fees})
