...
func NewRegenApp(logger logger.Logger, db dbm.DB, traceStore io.Writer, loadLatest bool,
	...
	icaControllerIBCModule := icacontroller.NewIBCMiddleware(icaControllerStack, app.ICAControllerKeeper)
...
func (app *RegenApp) setAnteHandler(txConfig client.TxConfig, wasmConfig wasmtypes.WasmConfig, txCounterStoreKey corestoretypes.KVStoreService) {
