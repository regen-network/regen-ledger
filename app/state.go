...
func AppStateFn(cdc codec.JSONMarshaler, simManager *regensimulation.SimulationManager) simtypes.AppStateFn {
...
func AppStateRandomizedFn(
	simManager *regensimulation.SimulationManager, r *rand.Rand, cdc codec.JSONMarshaler,
