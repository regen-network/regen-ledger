...
func (app *XrnApp) ExportAppStateAndValidators(forZeroHeight bool, jailWhiteList []string,
...
func (app *XrnApp) prepForZeroHeightGenesis(ctx sdk.Context, jailWhiteList []string) {
