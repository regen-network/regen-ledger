...
## [v5.0.0](https://github.com/regen-network/regen-ledger/releases/tag/v5.0.0) - TBD <!-- TODO -->
...
- [#1354](https://github.com/regen-network/regen-ledger/pull/1354) Add `UpdateClassFees` msg-based gov proposal
  - [#1466](https://github.com/regen-network/regen-ledger/pull/1466) Rename to `UpdateClassFees` to `UpdateClassFee`
- [#1391](https://github.com/regen-network/regen-ledger/pull/1391) Add `BasketFees` params query
  - [#1465](https://github.com/regen-network/regen-ledger/pull/1465) Rename to `BasketFees` to `BasketFee`
...
- [#1423](https://github.com/regen-network/regen-ledger/pull/1423) Add `CreditClassAllowlistEnabled` params query
  - [#1463](https://github.com/regen-network/regen-ledger/pull/1463) Rename to `CreditClassAllowlistEnabled` to `ClassCreatorAllowlist`
...
- [#1423](https://github.com/regen-network/regen-ledger/pull/1423) Add `CreditClassFees` params query
  - [#1466](https://github.com/regen-network/regen-ledger/pull/1466) Rename to `CreditClassFees` to `ClassFee`
- [#1423](https://github.com/regen-network/regen-ledger/pull/1423) Add `CreditClassAllowlistEnabled` params query
