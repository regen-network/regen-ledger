...
[#2190](https://github.com/regen-network/regen-ledger/pull/2190) the `convert-iri-to-hash` and `convert-hash-to-iri` query commands now work offline and don't need to talk to a node.
...
- [#1851](https://github.com/regen-network/regen-ledger/pull/1851) Update all modules to cosmos-sdk v0.46.11-regen-1
- [#1851](https://github.com/regen-network/regen-ledger/pull/1851) Update all modules to cometbft v0.34.27 (previously tendermint)
...
- [#1340](https://github.com/regen-network/regen-ledger/pull/1340) Add Cosmos SDK `group` module
- [#1441](https://github.com/regen-network/regen-ledger/pull/1441) Add ICA `host` module
...
- [#1590](https://github.com/regen-network/regen-ledger/pull/1590) Fix `NewDecFromString` to error if not finite
