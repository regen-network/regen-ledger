...
// Ints_Reals theory: http://smtlib.cs.uiowa.edu/theories-Reals_Ints.shtml
data class IntegerE(val x: Integer): RExpr<Integer>()
data class RealE(val x: Real): RExpr<Real>()
...
data class RealDiv(val x: RExpr<Real>, val y: RExpr<Real>): RExpr<Real>()
...
data class ToReal(val x: RExpr<Integer>): RExpr<Real>()
data class IoInt(val x: RExpr<Real>): RExpr<Integer>()
data class IsInt(val x: RExpr<Real>): RExpr<Boolean>()
