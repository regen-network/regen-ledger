...
type MsgCreateProposalRequest_Exec int32

const (
	// An empty value means that there should be separate MsgVote
	// and MsgExec requests for the proposal to execute.
	MsgCreateProposalRequest_EXEC_UNSPECIFIED MsgCreateProposalRequest_Exec = 0
	// Proposers signatures are considered as Yes votes and
	// we'll try to execute the proposal on creation.
	// If the proposal is not allowed per the DecisionPolicy,
	// the proposal will still be open for new votes and could
	// be executed separately at a later point.
	MsgCreateProposalRequest_EXEC_TRY MsgCreateProposalRequest_Exec = 1
	// Proposers signatures are considered as Yes votes and
	// we'll try to execute the proposal on creation.
	// But if the proposal is not allowed, it will be considered as
	// rejected.
	MsgCreateProposalRequest_EXEC_MUST MsgCreateProposalRequest_Exec = 2
)

var MsgCreateProposalRequest_Exec_name = map[int32]string{
	0: "EXEC_UNSPECIFIED",
	1: "EXEC_TRY",
	2: "EXEC_MUST",
}

var MsgCreateProposalRequest_Exec_value = map[string]int32{
	"EXEC_UNSPECIFIED": 0,
	"EXEC_TRY":         1,
	"EXEC_MUST":        2,
}

func (x MsgCreateProposalRequest_Exec) String() string {
	return proto.EnumName(MsgCreateProposalRequest_Exec_name, int32(x))
}

func (MsgCreateProposalRequest_Exec) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_b4673626e7797578, []int{16, 0}
}
...
type MsgCreateProposalRequest struct {
	...
	// exec is the mode of execution of the proposal, whether it should be executed
	// immediately on creation or not.
	Exec MsgCreateProposalRequest_Exec `protobuf:"varint,5,opt,name=exec,proto3,enum=regen.group.v1alpha1.MsgCreateProposalRequest_Exec" json:"exec,omitempty"`
}
...
func init() {
	proto.RegisterEnum("regen.group.v1alpha1.MsgCreateProposalRequest_Exec", MsgCreateProposalRequest_Exec_name, MsgCreateProposalRequest_Exec_value)
...
var fileDescriptor_b4673626e7797578 = []byte{
	...
	,
}
	...
	for iNdEx < l {
		...
		case 5:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Exec |= MsgCreateProposalRequest_Exec(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
