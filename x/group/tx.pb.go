...
type MsgCreateProposalRequest struct {
	...
	// try_exec defines the mode of execution of the proposal,
	// whether it should be executed immediately on creation or not.
	// Proposers signatures are considered as Yes votes.
	// If the proposal is not allowed per the DecisionPolicy,
	// the proposal will still be open for new votes and could
	// be executed at a later point.
	TryExec bool `protobuf:"varint,5,opt,name=try_exec,json=tryExec,proto3" json:"try_exec,omitempty"`
}
...
type MsgVoteRequest struct {
	...
	// try_exec will try to execute the proposal immediately
	// after the vote, if set to true.
	TryExec bool `protobuf:"varint,5,opt,name=try_exec,json=tryExec,proto3" json:"try_exec,omitempty"`
}
...
func (m *MsgVoteRequest) GetTryExec() bool {
	if m != nil {
		return m.TryExec
	}
	return false
...
var fileDescriptor_b4673626e7797578 = []byte{
	...
	,
}
...
func (m *MsgCreateProposalRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field TryExec", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
