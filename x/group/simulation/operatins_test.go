...
func (suite *SimTestSuite) SetupTest() {
	...
	// suite.msgClient = group.NewMsgClient(app.)
	// suite.queryClient = group.NewQueryClient(suite.ctx)
}
...
func (suite *SimTestSuite) TestWeightedOperations() {
	...
	weightedOps := simulation.WeightedOperations(appParams, cdc, suite.app.AccountKeeper,
		suite.app.BankKeeper, suite.app.GovKeeper, nil,
	)
...
func (suite *SimTestSuite) TestSimulateCreateGroupAccount() {
	...
	// execute operation
	op := simulation.SimulateMsgCreateGroupAccount(suite.app.AccountKeeper, suite.app.BankKeeper, nil)
	operationMsg, futureOperations, err := op(r, suite.app.BaseApp, suite.ctx, accounts, "")
	suite.Require().NoError(err)
