...
var (
	pattern_Query_Params_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"regenledger", "bond", "v1alpha1", "params"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_Bonds_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"regen.bond.v1alpha1.Query", "Bonds"}, "", runtime.AssumeColonVerbOpt(false)))
)
