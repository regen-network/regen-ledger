...
type BatchSupply struct {
	...
	// escrwowed_amount is the amount of credits in the batch that have been
	// locked up in escrow for use in the marketplace.
	EscrwowedAmount string `protobuf:"bytes,5,opt,name=escrwowed_amount,json=escrwowedAmount,proto3" json:"escrwowed_amount,omitempty"`
}
...
func (m *BatchSupply) GetEscrwowedAmount() string {
	if m != nil {
		return m.EscrwowedAmount
	}
	return ""
}
...
var fileDescriptor_6cfdca0a4aaabb36 = []byte{
	...
	,
}
...
func (m *BatchSupply) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.EscrwowedAmount) > 0 {
		i -= len(m.EscrwowedAmount)
		copy(dAtA[i:], m.EscrwowedAmount)
		i = encodeVarintState(dAtA, i, uint64(len(m.EscrwowedAmount)))
		i--
		dAtA[i] = 0x2a
	}
...
func (m *BatchSupply) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field EscrwowedAmount", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.EscrwowedAmount = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipState(dAtA[iNdEx:])
