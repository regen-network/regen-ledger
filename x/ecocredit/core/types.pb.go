...
func (m *CreditBalances) Reset()         { *m = CreditBalances{} }
func (m *CreditBalances) String() string { return proto.CompactTextString(m) }
func (*CreditBalances) ProtoMessage()    {}
func (*CreditBalances) Descriptor() ([]byte, []int) {
	return fileDescriptor_7b044b6b740b984f, []int{5}
}
func (m *CreditBalances) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *CreditBalances) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_CreditBalances.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *CreditBalances) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CreditBalances.Merge(m, src)
}
func (m *CreditBalances) XXX_Size() int {
	return m.Size()
}
func (m *CreditBalances) XXX_DiscardUnknown() {
	xxx_messageInfo_CreditBalances.DiscardUnknown(m)
}

var xxx_messageInfo_CreditBalances proto.InternalMessageInfo

func (m *CreditBalances) GetAddress() string {
	if m != nil {
		return m.Address
	}
	return ""
...
func (m *CreditBalances) GetBalances() *CreditBalance {
	if m != nil {
		return m.Balances
	}
	return nil
...
func (*CreditBalance) Descriptor() ([]byte, []int) {
	return fileDescriptor_7b044b6b740b984f, []int{6}
}
...
func (m *CreditBalance) GetBatchDenoms() []string {
	if m != nil {
		return m.BatchDenoms
	}
	return nil
}

func (m *CreditBalance) GetTradableAmount() string {
	if m != nil {
		return m.TradableAmount
	}
	return ""
...
func (m *CreditBalance) GetRetiredAmount() string {
	if m != nil {
		return m.RetiredAmount
	}
	return ""
...
func (m *CreditBalance) GetEscrowedAmount() string {
	if m != nil {
...
func init() {
	...
	proto.RegisterType((*CreditBalances)(nil), "regen.ecocredit.v1.CreditBalances")
	proto.RegisterType((*CreditBalance)(nil), "regen.ecocredit.v1.CreditBalance")
}
...
var fileDescriptor_7b044b6b740b984f = []byte{
	...
	,
}
...
func (m *CreditBalances) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *CreditBalances) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *CreditBalances) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *CreditBalance) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.EscrowedAmount) > 0 {
		...
		i = encodeVarintTypes(dAtA, i, uint64(len(m.EscrowedAmount)))
		i--
		dAtA[i] = 0x22
	}
	if len(m.RetiredAmount) > 0 {
	...
	if len(m.BatchDenoms) > 0 {
		for iNdEx := len(m.BatchDenoms) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.BatchDenoms[iNdEx])
			copy(dAtA[i:], m.BatchDenoms[iNdEx])
			i = encodeVarintTypes(dAtA, i, uint64(len(m.BatchDenoms[iNdEx])))
			i--
			dAtA[i] = 0xa
		}
	}
...
func (m *CreditBalances) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *CreditBalances) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: CreditBalances: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: CreditBalances: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *CreditBalance) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field BatchDenoms", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.BatchDenoms = append(m.BatchDenoms, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field TradableAmount", wireType)
