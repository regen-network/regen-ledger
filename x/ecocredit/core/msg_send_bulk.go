...
var _ legacytx.LegacyMsg = &MsgSendBulk{}

// Route implements the LegacyMsg interface.
func (m MsgSendBulk) Route() string { return sdk.MsgTypeURL(&m) }

// Type implements the LegacyMsg interface.
func (m MsgSendBulk) Type() string { return sdk.MsgTypeURL(&m) }

// GetSignBytes implements the LegacyMsg interface.
func (m MsgSendBulk) GetSignBytes() []byte {
	return sdk.MustSortJSON(ecocredit.ModuleCdc.MustMarshalJSON(&m))
}

// ValidateBasic does a sanity check on the provided data.
func (m *MsgSendBulk) ValidateBasic() error {
...
func (m *MsgSendBulk) GetSigners() []sdk.AccAddress {
