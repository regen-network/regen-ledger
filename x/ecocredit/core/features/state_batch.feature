Feature: Batch
  ...
  Scenario: an error is returned if project key is empty
    ...
    """
    When the batch is validated
    Then expect the error "project key cannot be zero"
  ...
  Scenario: an error is returned if start date is empty
    ...
    """
    When the batch is validated
    Then expect the error "must provide a start date for the credit batch"
  ...
  Scenario: an error is returned if end date is empty
    ...
    """
    When the batch is validated
    Then expect the error "must provide an end date for the credit batch"
  ...
  Scenario: an error is returned if start date is equal to end date
    ...
    """
    When the batch is validated
    Then expect the error "the batch end date (2020-01-01T00:00:00Z) must be the same as or after the batch start date (2020-01-01T00:00:00Z)"
  ...
  Scenario: an error is returned if start date after end date
    ...
    """
    When the batch is validated
    Then expect the error "the batch end date (2020-01-01T00:00:00Z) must be the same as or after the batch start date (2021-01-01T00:00:00Z)"
  ...
  Scenario: an error is returned if issuer is empty
    ...
    """
    When the batch is validated
    Then expect the error "issuer: empty address string is not allowed"
