...
func TestMigrations(t *testing.T) {
	...
	bd1, _ := core.FormatDenom("C01-001", 1, &startDate, &endDate)
	bd2, _ := core.FormatDenom("C01-001", 2, &startDate, &endDate)
	bd3, _ := core.FormatDenom("C01-001", 3, &startDate, &endDate)
