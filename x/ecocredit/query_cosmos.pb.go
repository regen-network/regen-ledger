...
type QueryClassInfoRequest struct {
	ClassId QueryClassInfoRequest_ClassId
}

type QueryClassInfoResponse struct {
	Info QueryClassInfoResponse_Info
}

type QueryBatchInfoRequest struct {
	BatchDenom QueryBatchInfoRequest_BatchDenom
}

type QueryBatchInfoResponse struct {
	Info QueryBatchInfoResponse_Info
}

type QueryBalanceRequest struct {
	Account    QueryBalanceRequest_Account
	BatchDenom QueryBalanceRequest_BatchDenom
}

type QueryBalanceResponse struct {
	TradableUnits QueryBalanceResponse_TradableUnits
	RetiredUnits  QueryBalanceResponse_RetiredUnits
}

type QuerySupplyRequest struct {
	BatchDenom QuerySupplyRequest_BatchDenom
}

type QuerySupplyResponse struct {
	TradableSupply QuerySupplyResponse_TradableSupply
	RetiredSupply  QuerySupplyResponse_RetiredSupply
}

type QueryPrecisionRequest struct {
	BatchDenom QueryPrecisionRequest_BatchDenom
}

type QueryPrecisionResponse struct {
	MaxDecimalPlaces QueryPrecisionResponse_MaxDecimalPlaces
}
