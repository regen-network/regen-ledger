...
func (k Keeper) SetMarketplaceFees(ctx context.Context, msg *types.MsgSetMarketplaceFees) (*types.MsgSetMarketplaceFeesResponse, error) {
	...
	return &types.MsgSetMarketplaceFeesResponse{}, nil
}
