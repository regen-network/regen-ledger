...
type EventBuyDirect struct {
	...
	SellerFeePaid *types.Coin `protobuf:"bytes,3,opt,name=seller_fee_paid,json=sellerFeePaid,proto3" json:"seller_fee_paid,omitempty"`
	...
	// to the marketplace as a fee for facilitating the sale.
	BuyerFeePaid *types.Coin `protobuf:"bytes,5,opt,name=buyer_fee_paid,json=buyerFeePaid,proto3" json:"buyer_fee_paid,omitempty"`
}
...
func (m *EventBuyDirect) GetSeller() string {
	if m != nil {
		return m.Seller
	}
	return ""
...
func (m *EventBuyDirect) GetSellerFeePaid() *types.Coin {
	if m != nil {
		return m.SellerFeePaid
	}
	return nil
}

func (m *EventBuyDirect) GetBuyer() string {
	if m != nil {
		return m.Buyer
	}
	return ""
...
func (m *EventBuyDirect) GetBuyerFeePaid() *types.Coin {
	if m != nil {
		return m.BuyerFeePaid
	}
	return nil
}
...
var fileDescriptor_68b71b54d42cf1d9 = []byte{
	...
	,
}
...
func (m *EventBuyDirect) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.BuyerFeePaid != nil {
		{
			size, err := m.BuyerFeePaid.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	if m.SellerFeePaid != nil {
		{
			size, err := m.SellerFeePaid.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *EventBuyDirect) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SellerFeePaid", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.SellerFeePaid == nil {
				m.SellerFeePaid = &types.Coin{}
			}
			if err := m.SellerFeePaid.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 4:
		...
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field BuyerFeePaid", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.BuyerFeePaid == nil {
				m.BuyerFeePaid = &types.Coin{}
			}
			if err := m.BuyerFeePaid.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
