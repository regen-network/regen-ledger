...
type ClassInfo struct {
	...
	CreditType *CreditType `protobuf:"bytes,5,opt,name=credit_type,proto3" json:"credit_type,omitempty"`
	// The number of batches issued in this credit class.
	NumBatches uint64 `protobuf:"varint,6,opt,name=num_batches,proto3" json:"num_batches,omitempty"`
}
...
type BatchInfo struct {
	...
	BatchDenom string `protobuf:"bytes,2,opt,name=batch_denom,proto3" json:"batch_denom,omitempty"`
	...
	// were issued.
	TotalAmount string `protobuf:"bytes,4,opt,name=total_amount,proto3" json:"total_amount,omitempty"`
	...
	// amount_cancelled will always sum to the original amount of credits that
	// were issued.
	AmountCancelled string `protobuf:"bytes,6,opt,name=amount_cancelled,proto3" json:"amount_cancelled,omitempty"`
	// start_date is the beginning of the period during which this credit batch
	// was quantified and verified.
	StartDate *time.Time `protobuf:"bytes,7,opt,name=start_date,proto3,stdtime" json:"start_date,omitempty"`
	// end_date is the end of the period during which this credit batch was
	// quantified and verified.
	EndDate *time.Time `protobuf:"bytes,8,opt,name=end_date,proto3,stdtime" json:"end_date,omitempty"`
	// project_location is the location of the project backing the credits in this
	// batch. Full documentation can be found in MsgCreateBatch.project_location.
	ProjectLocation string `protobuf:"bytes,9,opt,name=project_location,proto3" json:"project_location,omitempty"`
}
...
type Params struct {
	...
	CreditClassFee github_com_cosmos_cosmos_sdk_types.Coins `protobuf:"bytes,1,rep,name=credit_class_fee,proto3,castrepeated=github.com/cosmos/cosmos-sdk/types.Coins" json:"credit_class_fee"`
	// allowed_class_designers is an allowlist defining the addresses with
	// the required permissions to create credit classes
	AllowedClassDesigners []string `protobuf:"bytes,2,rep,name=allowed_class_designers,proto3" json:"allowed_class_designers,omitempty"`
	// allowlist_enabled is a param that enables/disables the allowlist for credit
	// creation
	AllowlistEnabled bool `protobuf:"varint,3,opt,name=allowlist_enabled,proto3" json:"allowlist_enabled,omitempty"`
	// credit_types is a list of definitions for credit types
	CreditTypes []*CreditType `protobuf:"bytes,4,rep,name=credit_types,proto3" json:"credit_types,omitempty"`
}
...
func (m *Params) GetAllowedClassDesigners() []string {
	if m != nil {
...
type CreditTypeSeq struct {
	...
	SeqNumber uint64 `protobuf:"varint,2,opt,name=seq_number,proto3" json:"seq_number,omitempty"`
}
...
var fileDescriptor_5342f4dcaeff1a84 = []byte{
	...
	,
}
...
func (m *Params) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.AllowedClassDesigners) > 0 {
		for iNdEx := len(m.AllowedClassDesigners) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.AllowedClassDesigners[iNdEx])
			copy(dAtA[i:], m.AllowedClassDesigners[iNdEx])
			i = encodeVarintTypes(dAtA, i, uint64(len(m.AllowedClassDesigners[iNdEx])))
			i--
			dAtA[i] = 0x12
		}
	}
...
func (m *Params) Size() (n int) {
	...
	if len(m.AllowedClassDesigners) > 0 {
		for _, s := range m.AllowedClassDesigners {
			l = len(s)
			n += 1 + l + sovTypes(uint64(l))
		}
	}
...
func (m *Params) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field AllowedClassDesigners", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.AllowedClassDesigners = append(m.AllowedClassDesigners, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		case 3:
			if wireType != 0 {
