...
type Filter_ClassId struct {
	ClassId string `protobuf:"bytes,3,opt,name=class_id,json=classId,proto3,oneof" json:"class_id,omitempty"`
}
...
type Filter_BatchDenom struct {
	BatchDenom string `protobuf:"bytes,5,opt,name=batch_denom,json=batchDenom,proto3,oneof" json:"batch_denom,omitempty"`
}
type Filter_ClassAdmin struct {
	ClassAdmin string `protobuf:"bytes,6,opt,name=class_admin,json=classAdmin,proto3,oneof" json:"class_admin,omitempty"`
}
type Filter_Issuer struct {
	Issuer string `protobuf:"bytes,7,opt,name=issuer,proto3,oneof" json:"issuer,omitempty"`
}
...
type Filter_ProjectLocation struct {
	ProjectLocation string `protobuf:"bytes,9,opt,name=project_location,json=projectLocation,proto3,oneof" json:"project_location,omitempty"`
}
type Filter_DateRange_ struct {
	DateRange *Filter_DateRange `protobuf:"bytes,10,opt,name=date_range,json=dateRange,proto3,oneof" json:"date_range,omitempty"`
}
type Filter_Tag struct {
	Tag string `protobuf:"bytes,11,opt,name=tag,proto3,oneof" json:"tag,omitempty"`
}
...
func (*Filter_And) Descriptor() ([]byte, []int) {
	return fileDescriptor_d49f179dcaefe4e9, []int{10, 0}
}
...
func (*Filter_Or) Descriptor() ([]byte, []int) {
	return fileDescriptor_d49f179dcaefe4e9, []int{10, 1}
}
...
func (*Filter_DateRange) Descriptor() ([]byte, []int) {
	return fileDescriptor_d49f179dcaefe4e9, []int{10, 2}
}
...
type Basket struct {
	...
	// basket_denom is the denom of the basket's coin
	...
	BasketCriteria *Filter `protobuf:"bytes,7,opt,name=basket_criteria,json=basketCriteria,proto3" json:"basket_criteria,omitempty"`
	// disable_auto_retire disables the auto-retirement of credits upon taking from the basket.
	// set to true to allow credits to be taken without retiring.
	DisableAutoRetire bool `protobuf:"varint,8,opt,name=disable_auto_retire,json=disableAutoRetire,proto3" json:"disable_auto_retire,omitempty"`
	// allow_picking allows the picking of specific credits from the basket
	AllowPicking bool `protobuf:"varint,9,opt,name=allow_picking,json=allowPicking,proto3" json:"allow_picking,omitempty"`
	// credit_type is the type of credit this basket will hold
	CreditTypeName string `protobuf:"bytes,10,opt,name=credit_type_name,json=creditTypeName,proto3" json:"credit_type_name,omitempty"`
}
...
func (m *Basket) GetBasketId() uint64 {
	if m != nil {
		return m.BasketId
	}
	return 0
...
func (m *Basket) GetBasketCriteria() *Filter {
	if m != nil {
...
func (*BasketCredits) Descriptor() ([]byte, []int) {
	return fileDescriptor_d49f179dcaefe4e9, []int{12}
}
...
func init() {
	...
	proto.RegisterType((*BasketCredits)(nil), "regen.ecocredit.v1alpha2.BasketCredits")
}
...
var fileDescriptor_d49f179dcaefe4e9 = []byte{
	...
	,
}
