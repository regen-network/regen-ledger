...
func (m *AskDenom) GetOrderId() uint64 {
	if m != nil {
		return m.OrderId
	}
	return 0
...
func (m *AskDenom) GetBatchDenom() string {
	if m != nil {
		return m.BatchDenom
	}
	return ""
...
func (m *AskDenom) GetQuantity() string {
	if m != nil {
		return m.Quantity
	}
	return ""
...
func (m *AskDenom) GetAskPrice() *types1.Coin {
	if m != nil {
		return m.AskPrice
	}
	return nil
...
func (m *AskDenom) GetDisableAutoRetire() bool {
	if m != nil {
		return m.DisableAutoRetire
	}
	return false
...
var fileDescriptor_5342f4dcaeff1a84 = []byte{
	...
	,
}
