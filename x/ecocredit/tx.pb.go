...
type MsgCreateClass struct {
	...
	CreditType string `protobuf:"bytes,4,opt,name=credit_type,proto3" json:"credit_type,omitempty"`
}
...
type MsgCreateClassResponse struct {
	...
	ClassId string `protobuf:"bytes,1,opt,name=class_id,proto3" json:"class_id,omitempty"`
}
...
type MsgCreateBatch struct {
	...
	ClassId string `protobuf:"bytes,2,opt,name=class_id,proto3" json:"class_id,omitempty"`
	...
	StartDate *time.Time `protobuf:"bytes,5,opt,name=start_date,proto3,stdtime" json:"start_date,omitempty"`
	// end_date is the end of the period during which this credit batch was
	// quantified and verified.
	EndDate *time.Time `protobuf:"bytes,6,opt,name=end_date,proto3,stdtime" json:"end_date,omitempty"`
	...
	ProjectLocation string `protobuf:"bytes,7,opt,name=project_location,proto3" json:"project_location,omitempty"`
}
...
type MsgCreateBatch_BatchIssuance struct {
	...
	TradableAmount string `protobuf:"bytes,2,opt,name=tradable_amount,proto3" json:"tradable_amount,omitempty"`
	...
	RetirementLocation string `protobuf:"bytes,4,opt,name=retirement_location,proto3" json:"retirement_location,omitempty"`
}
...
type MsgCreateBatchResponse struct {
	...
	BatchDenom string `protobuf:"bytes,1,opt,name=batch_denom,proto3" json:"batch_denom,omitempty"`
}
...
var fileDescriptor_96891bdd11ac56ed = []byte{
	...
	,
}
