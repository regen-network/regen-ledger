...
type MsgCreateBasket struct {
	...
	BasketCriteria *Filter `protobuf:"bytes,4,opt,name=basket_criteria,json=basketCriteria,proto3" json:"basket_criteria,omitempty"`
	...
	AllowPicking bool `protobuf:"varint,6,opt,name=allow_picking,json=allowPicking,proto3" json:"allow_picking,omitempty"`
	// credit_type is the type of credit this basket will hold
	CreditTypeName string `protobuf:"bytes,7,opt,name=credit_type_name,json=creditTypeName,proto3" json:"credit_type_name,omitempty"`
}
...
func (m *MsgCreateBasket) GetBasketCriteria() *Filter {
	if m != nil {
...
type MsgCreateBasketResponse struct {
	...
	// basket_address is the derived address of the newly created basket.
	BasketAddress string `protobuf:"bytes,2,opt,name=basket_address,json=basketAddress,proto3" json:"basket_address,omitempty"`
}
...
func (m *MsgCreateBasketResponse) GetBasketAddress() string {
	if m != nil {
		return m.BasketAddress
	}
	return ""
}
...
var fileDescriptor_e82815fbf9298ddc = []byte{
	...
	,
}
...
func (m *MsgCreateBasketResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.BasketAddress) > 0 {
		i -= len(m.BasketAddress)
		copy(dAtA[i:], m.BasketAddress)
		i = encodeVarintTx(dAtA, i, uint64(len(m.BasketAddress)))
		i--
		dAtA[i] = 0x12
	}
...
func (m *MsgCreateBasketResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field BasketAddress", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.BasketAddress = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTx(dAtA[iNdEx:])
