...
func TestQueryBalances(t *testing.T) {
	...
	// query all
	res, err := s.k.BasketBalances(s.ctx, &types.QueryBasketBalancesRequest{BasketDenom: testBasketDenom})
	...
	// paginate
	res, err = s.k.BasketBalances(s.ctx, &types.QueryBasketBalancesRequest{
		BasketDenom: testBasketDenom,
	...
	// bad query
	_, err = s.k.BasketBalances(s.ctx, &types.QueryBasketBalancesRequest{BasketDenom: "nope"})
	require.Error(t, err)
