...
If a user tries to create a credit class and their address is on the list of approved credit class creators, then the transaction is successful and the credit class is created.
...
If a user tries to create a credit class and their address is NOT on the list of approved credit class creators, then the transaction fails and the credit class is NOT created.
