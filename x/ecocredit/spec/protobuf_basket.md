...
- [regen/ecocredit/basket/v1/state.proto](#regen/ecocredit/basket/v1/state.proto)
    - [Basket](#regen.ecocredit.basket.v1.Basket)
    - [BasketBalance](#regen.ecocredit.basket.v1.BasketBalance)
    - [BasketClass](#regen.ecocredit.basket.v1.BasketClass)
...
<a name="regen/ecocredit/basket/v1/state.proto"></a>
<p align="right"><a href="#top">Top</a></p>

## regen/ecocredit/basket/v1/state.proto
...
<a name="regen.ecocredit.basket.v1.BasketClass"></a>
...
| ----- | ---- | ----- | ----------- |
| basket_id | [uint64](#uint64) |  | basket_id is the ID of the basket |
| class_id | [string](#string) |  | class_id is the id of the credit class that is allowed to be deposited in the basket |
...
The exponent will be used to form the prefix part of the the bank denom and will be mapped as follows: 0 - no prefix 1 - d (deci) 2 - c (centi) 3 - m (milli) 6 - u (micro) 9 - n (nano) 12 - p (pico) 15 - f (femto) 18 - a (atto) 21 - z (zepto) 24 - y (yocto) |
