...
- [Protobuf Documentation](#protobuf-documentation)
  ...
  - [regen/ecocredit/v1alpha1/events.proto](#regenecocreditv1alpha1eventsproto)
    - [EventAllowAskDenom](#eventallowaskdenom)
    - [EventBuyOrderCreated](#eventbuyordercreated)
    - [EventBuyOrderFilled](#eventbuyorderfilled)
    - [EventCancel](#eventcancel)
    - [EventCreateBatch](#eventcreatebatch)
    - [EventCreateClass](#eventcreateclass)
    - [EventReceive](#eventreceive)
    - [EventRetire](#eventretire)
    - [EventSell](#eventsell)
    - [EventUpdateSellOrder](#eventupdatesellorder)
  - [regen/ecocredit/v1alpha1/types.proto](#regenecocreditv1alpha1typesproto)
    - [AskDenom](#askdenom)
    - [BatchInfo](#batchinfo)
    - [BuyOrder](#buyorder)
    - [BuyOrder.Selection](#buyorderselection)
    - [ClassInfo](#classinfo)
    - [CreditType](#credittype)
    - [CreditTypeSeq](#credittypeseq)
    - [Params](#params)
    - [SellOrder](#sellorder)
  - [regen/ecocredit/v1alpha1/genesis.proto](#regenecocreditv1alpha1genesisproto)
    - [Balance](#balance)
    - [GenesisState](#genesisstate)
    - [Supply](#supply)
  - [regen/ecocredit/v1alpha1/query.proto](#regenecocreditv1alpha1queryproto)
    - [QueryBalanceRequest](#querybalancerequest)
    - [QueryBalanceResponse](#querybalanceresponse)
    - [QueryBatchInfoRequest](#querybatchinforequest)
    - [QueryBatchInfoResponse](#querybatchinforesponse)
    - [QueryBatchesRequest](#querybatchesrequest)
    - [QueryBatchesResponse](#querybatchesresponse)
    - [QueryClassInfoRequest](#queryclassinforequest)
    - [QueryClassInfoResponse](#queryclassinforesponse)
    ...
    - [Query](#query)
  - [regen/ecocredit/v1alpha1/tx.proto](#regenecocreditv1alpha1txproto)
    - [MsgAllowAskDenom](#msgallowaskdenom)
    - [MsgAllowAskDenomResponse](#msgallowaskdenomresponse)
    - [MsgBuy](#msgbuy)
    - [MsgBuy.Order](#msgbuyorder)
    - [MsgBuy.Order.Selection](#msgbuyorderselection)
    - [MsgBuyResponse](#msgbuyresponse)
    - [MsgCancel](#msgcancel)
    - [MsgCancel.CancelCredits](#msgcancelcancelcredits)
    - [MsgCancelResponse](#msgcancelresponse)
    - [MsgCreateBatch](#msgcreatebatch)
    - [MsgCreateBatch.BatchIssuance](#msgcreatebatchbatchissuance)
    - [MsgCreateBatchResponse](#msgcreatebatchresponse)
    - [MsgCreateClass](#msgcreateclass)
    - [MsgCreateClassResponse](#msgcreateclassresponse)
    - [MsgRetire](#msgretire)
    - [MsgRetire.RetireCredits](#msgretireretirecredits)
    - [MsgRetireResponse](#msgretireresponse)
    - [MsgSell](#msgsell)
    - [MsgSell.Order](#msgsellorder)
    - [MsgSellResponse](#msgsellresponse)
    - [MsgSend](#msgsend)
    - [MsgSend.SendCredits](#msgsendsendcredits)
    - [MsgSendResponse](#msgsendresponse)
    - [MsgUpdateClassAdmin](#msgupdateclassadmin)
    - [MsgUpdateClassAdminResponse](#msgupdateclassadminresponse)
    - [MsgUpdateClassIssuers](#msgupdateclassissuers)
    - [MsgUpdateClassIssuersResponse](#msgupdateclassissuersresponse)
    - [MsgUpdateClassMetadata](#msgupdateclassmetadata)
    - [MsgUpdateClassMetadataResponse](#msgupdateclassmetadataresponse)
    - [MsgUpdateSellOrders](#msgupdatesellorders)
    - [MsgUpdateSellOrders.Update](#msgupdatesellordersupdate)
    - [MsgUpdateSellOrdersResponse](#msgupdatesellordersresponse)
    - [Msg](#msg)
