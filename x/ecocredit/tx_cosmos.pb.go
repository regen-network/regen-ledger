// Code generated by protoc-gen-go-cosmos. DO NOT EDIT.
...
type MsgCreateClassRequest struct {
	Designer MsgCreateClassRequest_Designer
	Issuers  MsgCreateClassRequest_Issuers
	Metadata MsgCreateClassRequest_Metadata
}

type MsgCreateClassResponse struct {
	ClassId MsgCreateClassResponse_ClassId
}

type MsgCreateBatchRequest struct {
	Issuer   MsgCreateBatchRequest_Issuer
	ClassId  MsgCreateBatchRequest_ClassId
	Issuance MsgCreateBatchRequest_Issuance
	Metadata MsgCreateBatchRequest_Metadata
}

type MsgCreateBatchResponse struct {
	BatchDenom MsgCreateBatchResponse_BatchDenom
}

type MsgSendRequest struct {
	Sender    MsgSendRequest_Sender
	Recipient MsgSendRequest_Recipient
	Credits   MsgSendRequest_Credits
}
...
type MsgRetireRequest struct {
	Holder  MsgRetireRequest_Holder
	Credits MsgRetireRequest_Credits
}
...
type MsgSetPrecisionRequest struct {
	Issuer           MsgSetPrecisionRequest_Issuer
	BatchDenom       MsgSetPrecisionRequest_BatchDenom
	MaxDecimalPlaces MsgSetPrecisionRequest_MaxDecimalPlaces
}
