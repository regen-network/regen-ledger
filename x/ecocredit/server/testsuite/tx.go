...
func (s *IntegrationTestSuite) TestScenarioCreateSellOrders() {
	...
	_, batchDenom := s.createClassAndIssueBatch(addr1, addr1, "C", "2.0", "2020-01-01", "2022-01-01")

	askPrice1 := sdk.NewInt64Coin(sdk.DefaultBondDenom, 1000000)
	...
	for _, tc := range testCases {
		...
		s.Run(tc.name, func() {
			...
			res, err := s.marketServer.Sell(s.ctx, &marketplace.MsgSell{
				Owner:  tc.owner,
				Orders: tc.orders,
			})
			...
			if tc.wantErr {
				...
				_, sellError1 := s.marketServer.SellOrder(s.ctx, &marketplace.QuerySellOrderRequest{
					SellOrderId: res.SellOrderIds[0],
				})

				// query second sell order
				_, sellError2 := s.marketServer.SellOrder(s.ctx, &marketplace.QuerySellOrderRequest{
...
func (s *IntegrationTestSuite) TestScenarioUpdateSellOrders() {
	...
	// create sell order
	sellRes, err := s.marketServer.Sell(s.ctx, &marketplace.MsgSell{
		Owner: addr1.String(),
		Orders: []*marketplace.MsgSell_Order{
			{
				BatchDenom:        batchDenom,
	...
	for _, tc := range testCases {
		...
		s.Run(tc.name, func() {
			...
			_, err := s.marketServer.UpdateSellOrders(s.ctx, &marketplace.MsgUpdateSellOrders{
				Owner:   tc.owner,
				Updates: tc.updates,
			})
			...
			if tc.wantErr {
				...
				// query first sell order
				sellResponse1, sellError1 := s.marketServer.SellOrder(s.ctx, &marketplace.QuerySellOrderRequest{
					SellOrderId: tc.updates[0].SellOrderId,
				})

				// query second sell order
				sellResponse2, sellError2 := s.marketServer.SellOrder(s.ctx, &marketplace.QuerySellOrderRequest{
...
//
//	// create credit class and issue credits to addr1
//	_, batchDenom := s.createClassAndIssueBatch(addr1, addr1, "C", "6.0", "2020-01-01", "2022-01-01")
//
...
//			orders: []*marketplace.MsgBuy_Order{
//				{
//					Selection:         &marketplace.MsgBuy_Order_Selection{Sum: &marketplace.MsgBuy_Order_Selection_SellOrderId{SellOrderId: 99}},
//					Quantity:          "1.0",
//					BidPrice:          &bidPrice1,
//					DisableAutoRetire: true,
//					Expiration:        &expiration,
//				},
//				{
//					Selection:         &marketplace.MsgBuy_Order_Selection{Sum: &marketplace.MsgBuy_Order_Selection_SellOrderId{SellOrderId: 100}},
//					Quantity:          "1.0",
//					BidPrice:          &bidPrice1,
//					DisableAutoRetire: true,
//					Expiration:        &expiration,
...
//			orders: []*marketplace.MsgBuy_Order{
//				{
//					Selection:         &marketplace.MsgBuy_Order_Selection{Sum: &marketplace.MsgBuy_Order_Selection_SellOrderId{SellOrderId: sellRes.SellOrderIds[0]}},
//					Quantity:          "99.99",
//					BidPrice:          &bidPrice1,
//					DisableAutoRetire: true,
//					Expiration:        &expiration,
//				},
//				{
//					Selection:         &marketplace.MsgBuy_Order_Selection{Sum: &marketplace.MsgBuy_Order_Selection_SellOrderId{SellOrderId: sellRes.SellOrderIds[1]}},
//					Quantity:          "99.99",
//					BidPrice:          &bidPrice1,
//					DisableAutoRetire: true,
//					Expiration:        &expiration,
...
//			orders: []*marketplace.MsgBuy_Order{
//				{
//					Selection:         &marketplace.MsgBuy_Order_Selection{Sum: &marketplace.MsgBuy_Order_Selection_SellOrderId{SellOrderId: sellRes.SellOrderIds[2]}},
//					Quantity:          "1.0",
//					BidPrice:          &bidPrice1,
//					DisableAutoRetire: true,
//				},
//				{
//					Selection:         &marketplace.MsgBuy_Order_Selection{Sum: &marketplace.MsgBuy_Order_Selection_SellOrderId{SellOrderId: sellRes.SellOrderIds[3]}},
//					Quantity:          "1.0",
//					BidPrice:          &bidPrice1,
//					DisableAutoRetire: true,
//				},
...
//			orders: []*marketplace.MsgBuy_Order{
//				{
//					Selection:         &marketplace.MsgBuy_Order_Selection{Sum: &marketplace.MsgBuy_Order_Selection_SellOrderId{SellOrderId: sellRes.SellOrderIds[4]}},
//					Quantity:          "0.5",
//					BidPrice:          &bidPrice1,
//					DisableAutoRetire: true,
//					Expiration:        &expiration,
//				},
//				{
//					Selection:         &marketplace.MsgBuy_Order_Selection{Sum: &marketplace.MsgBuy_Order_Selection_SellOrderId{SellOrderId: sellRes.SellOrderIds[5]}},
//					Quantity:          "0.5",
//					BidPrice:          &bidPrice1,
//					DisableAutoRetire: true,
//					Expiration:        &expiration,
...
//			creditBalanceBefore, _ := s.queryClient.Balance(s.ctx, &core.QueryBalanceRequest{
//				Account:    addr2.String(),
//				BatchDenom: batchDenom,
//			})
//
//			// process buy orders
//			res, err := s.marketServer.Buy(s.ctx, &marketplace.MsgBuy{
//				Buyer:  tc.buyer,
//				Orders: tc.orders,
//			})
//
...
//			creditBalanceAfter, _ := s.queryClient.Balance(s.ctx, &core.QueryBalanceRequest{
//				Account:    addr2.String(),
//				BatchDenom: batchDenom,
//			})
//
