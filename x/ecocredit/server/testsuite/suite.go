...
func (s *IntegrationTestSuite) TestScenario() {
	...
	s.paramSpace.Set(s.sdkCtx, ecocredit.KeyAllowedClassDesigners, []string{designer.String()})
	...
	s.paramSpace.Set(s.sdkCtx, ecocredit.KeyAllowedClassDesigners, []string{})
