...
func (s *GenesisTestSuite) TestInitExportGenesis() {
	...
	projects := []api.Project{
		{Id: "P01", Admin: sdk.AccAddress("addr1"), ClassKey: 1, ProjectJurisdiction: "AQ", Metadata: "metadata"},
		{Id: "P02", Admin: sdk.AccAddress("addr2"), ClassKey: 2, ProjectJurisdiction: "AQ", Metadata: "metadata"},
	}
