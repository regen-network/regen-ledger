...
// SendBulk sends credits to a recipient.
// SendBulk also retires credits if the amount to retire is specified in the request.
func (k Keeper) SendBulk(ctx context.Context, req *core.MsgSendBulk) (*core.MsgSendBulkResponse, error) {
	...
	for _, credit := range req.Credits {
		...
		sdkCtx.GasMeter().ConsumeGas(ecocredit.GasCostPerIteration, "ecocredit/core/MsgSendBulk credit iteration")
	}
	return &core.MsgSendBulkResponse{}, nil
}

func (k Keeper) sendEcocredits(ctx context.Context, credit *core.MsgSendBulk_SendCredits, to, from sdk.AccAddress) error {
