...
func (k Keeper) Put(ctx context.Context, req *baskettypes.MsgPut) (*baskettypes.MsgPutResponse, error) {
	...
	if err = k.bankKeeper.MintCoins(sdkCtx, baskettypes.BasketModuleName, coinsToSend); err != nil {
		return nil, err
	}
	if err = k.bankKeeper.SendCoinsFromModuleToAccount(sdkCtx, baskettypes.BasketModuleName, ownerAddr, coinsToSend); err != nil {
		return nil, err
	}
