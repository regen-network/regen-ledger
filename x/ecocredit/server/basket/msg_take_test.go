...
func (s *takeSuite) ABasketWithDenomAndDisableAutoRetire(a string, b string) {
...
func (s *takeSuite) AliceOwnsBasketTokensFromBasket(a string) {
	amount, ok := sdk.NewIntFromString(s.tokenAmount)
	require.True(s.t, ok)

	s.aliceTokenBalance = sdk.NewCoin(a, amount)
}
func (s *takeSuite) AliceOwnsBasketTokenAmountFromBasket(a string, b string) {
	amount, ok := sdk.NewIntFromString(a)
	require.True(s.t, ok)

	s.aliceTokenBalance = sdk.NewCoin(b, amount)
}

func (s *takeSuite) AliceAttemptsToTakeCreditsFromBasket(a string) {
	var coins sdk.Coins
...
func (s *takeSuite) AliceAttemptsToTakeCreditsFromTheBasketWithTokenAmount(a string) {
	amount, ok := sdk.NewIntFromString(a)
	require.True(s.t, ok)
...
func (s *takeSuite) AliceAttemptsToTakeCreditsFromBasketWithTokenAmount(a string, b string) {
	amount, ok := sdk.NewIntFromString(b)
	require.True(s.t, ok)

	coins := sdk.NewCoins(sdk.NewCoin(a, amount))
...
func (s *takeSuite) AliceAttemptsToTakeCreditsFromBasketWithRetireOnTake(a string, b string) {
