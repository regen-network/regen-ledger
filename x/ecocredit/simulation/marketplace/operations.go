...
func WeightedOperations(
	...
	qryClient basetypes.QueryServer, mktQryClient marketplace.QueryServer) simulation.WeightedOperations {
...
func SimulateMsgBuyDirect(ak ecocredit.AccountKeeper, bk ecocredit.BankKeeper,
	qryClient basetypes.QueryServer, mktQryClient marketplace.QueryServer) simtypes.Operation {
	return func(
...
func SimulateMsgUpdateSellOrder(ak ecocredit.AccountKeeper, bk ecocredit.BankKeeper,
	coreQryClient basetypes.QueryServer, mktQryClient marketplace.QueryServer) simtypes.Operation {
	return func(
		r *rand.Rand, app *baseapp.BaseApp, sdkCtx sdk.Context, accs []simtypes.Account, chainID string,
	) (simtypes.OperationMsg, []simtypes.FutureOperation, error) {
		seller, _ := simtypes.RandomAcc(r, accs)
