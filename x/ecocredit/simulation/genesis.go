...
func genGenesisState(ctx context.Context, r *rand.Rand, simState *module.SimulationState, ss api.StateStore) error {
	...
	denom, err := ecocredit.FormatDenom("C01-001", 1, &startDate, &endDate)
	if err != nil {
		return err
	}
	...
	denom, err = ecocredit.FormatDenom("C02-001", 2, &startDate, &endDate)
	if err != nil {
		return err
	}
	...
	denom, err = ecocredit.FormatDenom("C03-002", 1, &startDate, &endDate)
	if err != nil {
		return err
	}
