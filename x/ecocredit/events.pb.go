...
type EventReceive struct {
	...
	// amountTradable is the decimal number of tradable credits received.
	AmountTradable string `protobuf:"bytes,4,opt,name=amountTradable,proto3" json:"amountTradable,omitempty"`
	// amountRetired is the decimal number of retired credits received.
	AmountRetired string `protobuf:"bytes,5,opt,name=amountRetired,proto3" json:"amountRetired,omitempty"`
}
...
func (m *EventReceive) GetAmountTradable() string {
	if m != nil {
		return m.AmountTradable
	}
	return ""
}

func (m *EventReceive) GetAmountRetired() string {
	if m != nil {
		return m.AmountRetired
	}
	return ""
}
...
var fileDescriptor_5b6a013b00aef3af = []byte{
	...
	,
}
...
func (m *EventReceive) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.AmountRetired) > 0 {
		i -= len(m.AmountRetired)
		copy(dAtA[i:], m.AmountRetired)
		i = encodeVarintEvents(dAtA, i, uint64(len(m.AmountRetired)))
		i--
		dAtA[i] = 0x2a
	}
	if len(m.AmountTradable) > 0 {
		i -= len(m.AmountTradable)
		copy(dAtA[i:], m.AmountTradable)
		i = encodeVarintEvents(dAtA, i, uint64(len(m.AmountTradable)))
		i--
		dAtA[i] = 0x22
	}
	if len(m.BatchDenom) > 0 {
...
func (m *EventReceive) Size() (n int) {
	...
	l = len(m.AmountTradable)
	if l > 0 {
		n += 1 + l + sovEvents(uint64(l))
	}
	l = len(m.AmountRetired)
	if l > 0 {
		n += 1 + l + sovEvents(uint64(l))
	}
	return n
...
func (m *EventReceive) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field AmountTradable", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.AmountTradable = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field AmountRetired", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.AmountRetired = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipEvents(dAtA[iNdEx:])
