...
func SimulateMsgCreateClass(txCfg client.TxConfig, ak ecocredit.AccountKeeper, bk ecocredit.BankKeeper,
	...
	return func(
		...
		spendable, neg := bk.SpendableCoins(ctx, admin.Address).SafeSub(params.CreditClassFee...)
		if neg {
