Feature: MsgRemoveAllowedBridgeChain
  ...
  Scenario: a valid amino message
    ...
    """
    {"type":"regen/MsgRemoveAllowedBridgeChain","value":{"authority":"regen1depk54cuajgkzea6zpgkq36tnjwdzv4ak663u6","chain_name":"polygon"}}
    """
