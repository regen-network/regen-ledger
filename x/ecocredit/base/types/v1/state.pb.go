...
var ProjectEnrollmentStatus_name = map[int32]string{
...
var ProjectEnrollmentStatus_value = map[string]int32{
...
func (x ProjectEnrollmentStatus) String() string {
	return proto.EnumName(ProjectEnrollmentStatus_name, int32(x))
}
...
type Project struct {
	...
	ClassKey uint64 `protobuf:"varint,4,opt,name=class_key,json=classKey,proto3" json:"class_key,omitempty"` // Deprecated: Do not use.
...
func (m *Batch) GetClassKey() uint64 {
	if m != nil {
		return m.ClassKey
	}
	return 0
...
func (m *ProjectEnrollment) Reset()         { *m = ProjectEnrollment{} }
func (m *ProjectEnrollment) String() string { return proto.CompactTextString(m) }
func (*ProjectEnrollment) ProtoMessage()    {}
func (*ProjectEnrollment) Descriptor() ([]byte, []int) {
	return fileDescriptor_6cfdca0a4aaabb36, []int{16}
}
func (m *ProjectEnrollment) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ProjectEnrollment) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ProjectEnrollment.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ProjectEnrollment) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ProjectEnrollment.Merge(m, src)
}
func (m *ProjectEnrollment) XXX_Size() int {
	return m.Size()
}
func (m *ProjectEnrollment) XXX_DiscardUnknown() {
	xxx_messageInfo_ProjectEnrollment.DiscardUnknown(m)
}

var xxx_messageInfo_ProjectEnrollment proto.InternalMessageInfo

func (m *ProjectEnrollment) GetProjectKey() uint64 {
	if m != nil {
		return m.ProjectKey
	}
	return 0
...
func (m *ProjectEnrollment) GetClassKey() uint64 {
	if m != nil {
		return m.ClassKey
	}
	return 0
...
func (m *ProjectEnrollment) GetStatus() ProjectEnrollmentStatus {
	if m != nil {
		return m.Status
	}
...
func (m *ProjectEnrollment) GetApplicationMetadata() string {
	if m != nil {
...
func (m *ProjectEnrollment) GetEnrollmentMetadata() string {
	if m != nil {
...
func (m *ProjectFee) Reset()         { *m = ProjectFee{} }
func (m *ProjectFee) String() string { return proto.CompactTextString(m) }
func (*ProjectFee) ProtoMessage()    {}
func (*ProjectFee) Descriptor() ([]byte, []int) {
	return fileDescriptor_6cfdca0a4aaabb36, []int{17}
}
func (m *ProjectFee) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ProjectFee) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ProjectFee.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ProjectFee) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ProjectFee.Merge(m, src)
}
func (m *ProjectFee) XXX_Size() int {
	return m.Size()
}
func (m *ProjectFee) XXX_DiscardUnknown() {
	xxx_messageInfo_ProjectFee.DiscardUnknown(m)
}

var xxx_messageInfo_ProjectFee proto.InternalMessageInfo

func (m *ProjectFee) GetFee() *types1.Coin {
	if m != nil {
		return m.Fee
	}
	return nil
...
func init() {
	proto.RegisterEnum("regen.ecocredit.v1.ProjectEnrollmentStatus", ProjectEnrollmentStatus_name, ProjectEnrollmentStatus_value)
	...
	proto.RegisterType((*ProjectEnrollment)(nil), "regen.ecocredit.v1.ProjectEnrollment")
	proto.RegisterType((*ProjectFee)(nil), "regen.ecocredit.v1.ProjectFee")
}
...
var fileDescriptor_6cfdca0a4aaabb36 = []byte{
	...
	,
}
...
func (m *ProjectEnrollment) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ProjectEnrollment) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ProjectEnrollment) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.EnrollmentMetadata) > 0 {
		...
		i = encodeVarintState(dAtA, i, uint64(len(m.EnrollmentMetadata)))
		i--
		dAtA[i] = 0x32
	}
	if len(m.ApplicationMetadata) > 0 {
		...
		i = encodeVarintState(dAtA, i, uint64(len(m.ApplicationMetadata)))
		i--
		dAtA[i] = 0x2a
	}
	if m.Status != 0 {
...
func (m *ProjectFee) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ProjectFee) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ProjectFee) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *ProjectEnrollment) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ProjectEnrollment) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ProjectEnrollment: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ProjectEnrollment: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *ProjectFee) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ProjectFee: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ProjectFee: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
