...
var (
	...
	pattern_Query_ProjectEnrollment_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 2, 5, 1, 0, 4, 1, 5, 6}, []string{"regen", "ecocredit", "v1", "project", "project_id", "enrollment", "class_id"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_ProjectEnrollments_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 2, 5}, []string{"regen", "ecocredit", "v1", "project", "project_id", "enrollment"}, "", runtime.AssumeColonVerbOpt(false)))
)
