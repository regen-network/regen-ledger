...
//
// Since Revision 3
type QueryProjectClassRequest struct {
	// project_id is the unique identifier of the project to query.
	ProjectId string `protobuf:"bytes,1,opt,name=project_id,json=projectId,proto3" json:"project_id,omitempty"`
	// class_id is the unique identifier of the credit class to query.
...
func (m *QueryProjectClassRequest) Reset()         { *m = QueryProjectClassRequest{} }
func (m *QueryProjectClassRequest) String() string { return proto.CompactTextString(m) }
func (*QueryProjectClassRequest) ProtoMessage()    {}
func (*QueryProjectClassRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_c85efa417eafb74b, []int{56}
}
func (m *QueryProjectClassRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryProjectClassRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryProjectClassRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryProjectClassRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryProjectClassRequest.Merge(m, src)
}
func (m *QueryProjectClassRequest) XXX_Size() int {
	return m.Size()
}
func (m *QueryProjectClassRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryProjectClassRequest.DiscardUnknown(m)
}

var xxx_messageInfo_QueryProjectClassRequest proto.InternalMessageInfo

func (m *QueryProjectClassRequest) GetProjectId() string {
	if m != nil {
		return m.ProjectId
	}
	return ""
...
func (m *QueryProjectClassRequest) GetClassId() string {
	if m != nil {
		return m.ClassId
	}
	return ""
...
//
// Since Revision 3
type QueryProjectClassResponse struct {
	// project_class is the fetched project class relationship.
	ProjectClass *ProjectClass `protobuf:"bytes,1,opt,name=project_class,json=projectClass,proto3" json:"project_class,omitempty"`
}

func (m *QueryProjectClassResponse) Reset()         { *m = QueryProjectClassResponse{} }
func (m *QueryProjectClassResponse) String() string { return proto.CompactTextString(m) }
func (*QueryProjectClassResponse) ProtoMessage()    {}
func (*QueryProjectClassResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_c85efa417eafb74b, []int{57}
}
func (m *QueryProjectClassResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryProjectClassResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryProjectClassResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryProjectClassResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryProjectClassResponse.Merge(m, src)
}
func (m *QueryProjectClassResponse) XXX_Size() int {
	return m.Size()
}
func (m *QueryProjectClassResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryProjectClassResponse.DiscardUnknown(m)
}

var xxx_messageInfo_QueryProjectClassResponse proto.InternalMessageInfo

func (m *QueryProjectClassResponse) GetProjectClass() *ProjectClass {
	if m != nil {
...
//
// Since Revision 3
type QueryProjectClassesRequest struct {
	// project_id is the unique identifier of the project to query.
	ProjectId string `protobuf:"bytes,1,opt,name=project_id,json=projectId,proto3" json:"project_id,omitempty"`
	// pagination defines an optional pagination for the request.
	Pagination *query.PageRequest `protobuf:"bytes,2,opt,name=pagination,proto3" json:"pagination,omitempty"`
...
func (m *QueryProjectClassesRequest) Reset()         { *m = QueryProjectClassesRequest{} }
func (m *QueryProjectClassesRequest) String() string { return proto.CompactTextString(m) }
func (*QueryProjectClassesRequest) ProtoMessage()    {}
func (*QueryProjectClassesRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_c85efa417eafb74b, []int{58}
}
func (m *QueryProjectClassesRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryProjectClassesRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryProjectClassesRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryProjectClassesRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryProjectClassesRequest.Merge(m, src)
}
func (m *QueryProjectClassesRequest) XXX_Size() int {
	return m.Size()
}
func (m *QueryProjectClassesRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryProjectClassesRequest.DiscardUnknown(m)
}

var xxx_messageInfo_QueryProjectClassesRequest proto.InternalMessageInfo

func (m *QueryProjectClassesRequest) GetProjectId() string {
	if m != nil {
		return m.ProjectId
	}
	return ""
...
func (m *QueryProjectClassesRequest) GetPagination() *query.PageRequest {
	if m != nil {
		return m.Pagination
	}
	return nil
...
//
// Since Revision 3
type QueryProjectClassesResponse struct {
	// classes are the fetched credit classes.
	Classes []*ClassInfo `protobuf:"bytes,1,rep,name=classes,proto3" json:"classes,omitempty"`
	// pagination defines the pagination in the response.
	Pagination *query.PageResponse `protobuf:"bytes,2,opt,name=pagination,proto3" json:"pagination,omitempty"`
...
func (m *QueryProjectClassesResponse) Reset()         { *m = QueryProjectClassesResponse{} }
func (m *QueryProjectClassesResponse) String() string { return proto.CompactTextString(m) }
func (*QueryProjectClassesResponse) ProtoMessage()    {}
func (*QueryProjectClassesResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_c85efa417eafb74b, []int{59}
}
func (m *QueryProjectClassesResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryProjectClassesResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryProjectClassesResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryProjectClassesResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryProjectClassesResponse.Merge(m, src)
}
func (m *QueryProjectClassesResponse) XXX_Size() int {
	return m.Size()
}
func (m *QueryProjectClassesResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryProjectClassesResponse.DiscardUnknown(m)
}

var xxx_messageInfo_QueryProjectClassesResponse proto.InternalMessageInfo

func (m *QueryProjectClassesResponse) GetClasses() []*ClassInfo {
	if m != nil {
		return m.Classes
	}
	return nil
...
func (m *QueryProjectClassesResponse) GetPagination() *query.PageResponse {
	if m != nil {
		return m.Pagination
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*QueryProjectClassRequest)(nil), "regen.ecocredit.v1.QueryProjectClassRequest")
	proto.RegisterType((*QueryProjectClassResponse)(nil), "regen.ecocredit.v1.QueryProjectClassResponse")
	proto.RegisterType((*QueryProjectClassesRequest)(nil), "regen.ecocredit.v1.QueryProjectClassesRequest")
	proto.RegisterType((*QueryProjectClassesResponse)(nil), "regen.ecocredit.v1.QueryProjectClassesResponse")
}
...
var fileDescriptor_c85efa417eafb74b = []byte{
	...
	,
}
...
func (c *queryClient) ProjectClass(ctx context.Context, in *QueryProjectClassRequest, opts ...grpc.CallOption) (*QueryProjectClassResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/regen.ecocredit.v1.Query/ProjectClass", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) ProjectClasses(ctx context.Context, in *QueryProjectClassesRequest, opts ...grpc.CallOption) (*QueryProjectClassesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/regen.ecocredit.v1.Query/ProjectClasses", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedQueryServer) ProjectClass(ctx context.Context, req *QueryProjectClassRequest) (*QueryProjectClassResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ProjectClass not implemented")
}
func (*UnimplementedQueryServer) ProjectClasses(ctx context.Context, req *QueryProjectClassesRequest) (*QueryProjectClassesResponse, error) {
...
func _Query_ProjectClass_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/regen.ecocredit.v1.Query/ProjectClass",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_ProjectClasses_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/regen.ecocredit.v1.Query/ProjectClasses",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func (m *QueryProjectClassRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryProjectClassRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryProjectClassRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *QueryProjectClassResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryProjectClassResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryProjectClassResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *QueryProjectClassesRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryProjectClassesRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryProjectClassesRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *QueryProjectClassesResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryProjectClassesResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryProjectClassesResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *QueryProjectClassRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *QueryProjectClassResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *QueryProjectClassesRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *QueryProjectClassesResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *QueryProjectClassRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryProjectClassRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryProjectClassRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *QueryProjectClassResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryProjectClassResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryProjectClassResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *QueryProjectClassesRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryProjectClassesRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryProjectClassesRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *QueryProjectClassesResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryProjectClassesResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryProjectClassesResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
