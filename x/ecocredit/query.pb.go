...
type QueryBalanceResponse struct {
	...
	TradableAmount string `protobuf:"bytes,1,opt,name=tradable_amount,proto3" json:"tradable_amount,omitempty"`
	// retired_amount is the decimal number of retired credits.
	RetiredAmount string `protobuf:"bytes,2,opt,name=retired_amount,proto3" json:"retired_amount,omitempty"`
}
...
type QuerySupplyResponse struct {
	...
	// supply.
	TradableSupply string `protobuf:"bytes,1,opt,name=tradable_supply,proto3" json:"tradable_supply,omitempty"`
	// retired_supply is the decimal number of retired credits in the batch
	// supply.
	RetiredSupply string `protobuf:"bytes,2,opt,name=retired_supply,proto3" json:"retired_supply,omitempty"`
}
...
type QueryCreditTypesResponse struct {
	...
	CreditTypes []*CreditType `protobuf:"bytes,1,rep,name=credit_types,proto3" json:"credit_types,omitempty"`
}
...
var fileDescriptor_6a16cc4c1db940dc = []byte{
	...
	,
}
