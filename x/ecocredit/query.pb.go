...
func (m *QueryClassesResponse) GetClasses() []string {
	if m != nil {
		return m.Classes
	}
	return nil
...
func (m *QueryBatchesResponse) GetBatches() []string {
	if m != nil {
		return m.Batches
	}
	return nil
...
var fileDescriptor_6a16cc4c1db940dc = []byte{
	...
	,
}
...
func (m *QueryBatchesResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Batches) > 0 {
		for iNdEx := len(m.Batches) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.Batches[iNdEx])
			copy(dAtA[i:], m.Batches[iNdEx])
			i = encodeVarintQuery(dAtA, i, uint64(len(m.Batches[iNdEx])))
			i--
			dAtA[i] = 0xa
		}
	}
...
func (m *QueryBatchesResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.Batches = append(m.Batches, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Pagination", wireType)
