...
type MsgAnchorDataRequest struct {
	Sender MsgAnchorDataRequest_Sender
	Cid    MsgAnchorDataRequest_Cid
}

type MsgAnchorDataResponse struct {
	Timestamp MsgAnchorDataResponse_Timestamp
}

type MsgSignDataRequest struct {
	Signers MsgSignDataRequest_Signers
	Cid     MsgSignDataRequest_Cid
}
...
type MsgStoreDataRequest struct {
	Sender  MsgStoreDataRequest_Sender
	Cid     MsgStoreDataRequest_Cid
	Content MsgStoreDataRequest_Content
}
