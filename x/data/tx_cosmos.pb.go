...
type MsgClient interface {
	...
	AnchorData(ctx types.HasContext, in *MsgAnchorDataRequest, opts ...grpc.CallOption) (*MsgAnchorDataResponse, error)
	...
	SignData(ctx types.HasContext, in *MsgSignDataRequest, opts ...grpc.CallOption) (*MsgSignDataResponse, error)
	...
	// SignData should be used to create a digital signature attesting to the
	// veracity of some piece of data.
	StoreData(ctx types.HasContext, in *MsgStoreDataRequest, opts ...grpc.CallOption) (*MsgStoreDataResponse, error)
}
...
func (c *msgClient) AnchorData(ctx types.HasContext, in *MsgAnchorDataRequest, opts ...grpc.CallOption) (*MsgAnchorDataResponse, error) {
	out := new(MsgAnchorDataResponse)
	err := c.cc.Invoke(ctx.Context(), "/regen.data.v1alpha1.Msg/AnchorData", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) SignData(ctx types.HasContext, in *MsgSignDataRequest, opts ...grpc.CallOption) (*MsgSignDataResponse, error) {
	out := new(MsgSignDataResponse)
	err := c.cc.Invoke(ctx.Context(), "/regen.data.v1alpha1.Msg/SignData", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) StoreData(ctx types.HasContext, in *MsgStoreDataRequest, opts ...grpc.CallOption) (*MsgStoreDataResponse, error) {
	out := new(MsgStoreDataResponse)
	err := c.cc.Invoke(ctx.Context(), "/regen.data.v1alpha1.Msg/StoreData", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MsgServer interface {
	...
	// SignData should be used to create a digital signature attesting to the
	// veracity of some piece of data.
	AnchorData(types1.Context, *MsgAnchorDataRequest) (*MsgAnchorDataResponse, error)
	// SignData allows for signing of an arbitrary piece of data on the
	// blockchain. By "signing" data the signers are making a statement about the
	// veracity of the data itself. It is like signing a legal document, meaning
	// that I agree to all conditions and to the best of my knowledge everything
	...
	// SignData can be called multiple times for the same CID with different
	// signers and those signers will be appended to the list of signers.
	SignData(types1.Context, *MsgSignDataRequest) (*MsgSignDataResponse, error)
	// StoreData stores a piece of data corresponding to a CID on the blockchain.
	//
	// Currently only data for CID's using sha2-256 and blake2b-256 hash
	// algorithms can be stored on-chain.
	...
	// SignData should be used to create a digital signature attesting to the
	// veracity of some piece of data.
	StoreData(types1.Context, *MsgStoreDataRequest) (*MsgStoreDataResponse, error)
}
...
func _Msg_AnchorData_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	if interceptor == nil {
		return srv.(MsgServer).AnchorData(types1.UnwrapSDKContext(ctx), in)
	}
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MsgServer).AnchorData(types1.UnwrapSDKContext(ctx), req.(*MsgAnchorDataRequest))
	}
...
func _Msg_SignData_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	if interceptor == nil {
		return srv.(MsgServer).SignData(types1.UnwrapSDKContext(ctx), in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MsgServer).SignData(types1.UnwrapSDKContext(ctx), req.(*MsgSignDataRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Msg_StoreData_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	if interceptor == nil {
		return srv.(MsgServer).StoreData(types1.UnwrapSDKContext(ctx), in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MsgServer).StoreData(types1.UnwrapSDKContext(ctx), req.(*MsgStoreDataRequest))
	}
	return interceptor(ctx, in, info, handler)
}
