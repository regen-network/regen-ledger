...
func TestQuery_AnchorByIRI(t *testing.T) {
	...
	require.EqualError(t, err, "rpc error: code = InvalidArgument desc = failed to parse IRI: failed to parse IRI foo: regen: prefix required: invalid IRI")
	...
	require.EqualError(t, err, "rpc error: code = NotFound desc = data record with IRI: regen:13toVfvdftodu8c1Jc4TXxCnq7XLRAe4p9MgDKF2VeFKMx9eZXMgGnB.rdf")
}
