...
type QueryByCidRequest struct {
	Cid QueryByCidRequest_Cid
}

type QueryByCidResponse struct {
	Timestamp QueryByCidResponse_Timestamp
	Signers   QueryByCidResponse_Signers
	Content   QueryByCidResponse_Content
}

type QueryBySignerRequest struct {
	Signer     QueryBySignerRequest_Signer
	Pagination QueryBySignerRequest_Pagination
}

type QueryBySignerResponse struct {
	Cids       QueryBySignerResponse_Cids
	Pagination QueryBySignerResponse_Pagination
}
