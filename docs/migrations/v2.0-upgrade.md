...
Please update to the latest version of Go `1.17`. For more information, see [Go](https://golang.org/).

### Option 1: Using Cosmovisor

Please use **Cosmovisor v1.0 with the auto-download option disabled**. Node operators must prepare the upgrade binary in advance.
