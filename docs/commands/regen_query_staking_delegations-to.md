## regen query staking delegations-to
...
Example:
$ regen query staking delegations-to regenvaloper1gghjut3ccd8ay0zduzj64hwre2fxs9ldmqhffj

```
regen query staking delegations-to [validator-addr] [flags]
```
