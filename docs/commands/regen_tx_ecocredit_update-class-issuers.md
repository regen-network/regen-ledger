...
Update the list of issuers for a specific credit class

### Synopsis

Update the list of issuers for a specific credit class. the '--from' flag must equal the current credit class admin.
...
```
  ...
  -h, --help                     help for update-class-issuers
