## regen query staking redelegations-from
...
Example:
$ regen query staking redelegations-from regenvaloper1gghjut3ccd8ay0zduzj64hwre2fxs9ldmqhffj

```
regen query staking redelegations-from [validator-addr] [flags]
```
