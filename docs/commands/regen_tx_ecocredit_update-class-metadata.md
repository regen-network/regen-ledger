...
Updates the metadata for a specific credit class

### Synopsis

Updates the metadata for a specific credit class. the '--from' flag must equal the credit class admin.
...
```
  ...
  -h, --help                     help for update-class-metadata
