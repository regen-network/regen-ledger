...
Updates the admin for a specific credit class

### Synopsis

Updates the admin for a specific credit class. the '--from' flag must equal the current credit class admin.
...
```
  ...
  -h, --help                     help for update-class-admin
