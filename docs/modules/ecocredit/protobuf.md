...
| allowed_class_designer_addresses | [string](#string) | repeated | allowed_class_creator_addresses is an allowlist defining the addresses with the required permissions to create credit classes |
