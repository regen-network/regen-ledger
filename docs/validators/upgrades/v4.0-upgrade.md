...
*Update: A patch release (`v4.1.0`) was released soon-after the v4.0 upgrade. This document has been updated to use the `v4.1.0` as the upgrade binary rather than `v4.0.0`.*
...
Build the upgrade binary (`v4.1.0`) from source:
...
Create a `v4.0.0` directory and copy the upgrade binary (`v4.1.0`) to the directory:
