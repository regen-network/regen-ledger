...
This document provides instructions for running a validator node for a [live network](../../ledger/getting-started/live-networks.md). With Regen Mainnet, Redwood Testnet, and Hambach Testnet already launched and running, this document will focus on how to become a validator for a network post-genesis.
...
For more information (including hardware recommendations), see [Prerequisites](../../ledger/getting-started/prerequisites.md). 
