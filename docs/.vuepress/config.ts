      ...
      '/ledger/': [
        ...
        },
        {
          ...
          children: [
            ...
            '/ledger/migrations/v7.0-migration',
          ],
        },
      ],
      '/modules/': [
      ...
      '/validators/': [
        ...
        },
        {
          ...
          children: [
            ...
            '/validators/upgrades/v7.0-upgrade',
          ],
        },
      ],
      '/commands/': [
        ...
        },
        {
          ...
          children: [
            ...
            { text: 'regen comet', link: '/commands/regen_comet' },
            ...
            { text: 'regen genesis', link: '/commands/regen_genesis' },
            { text: 'regen init', link: '/commands/regen_init' },
            { text: 'regen keys', link: '/commands/regen_keys' },
            { text: 'regen module-hash-by-height', link: '/commands/regen_module-hash-by-height' },
            { text: 'regen prune', link: '/commands/regen_prune' },
            { text: 'regen query', link: '/commands/regen_query' },
            { text: 'regen rollback', link: '/commands/regen_rollback' },
            { text: 'regen snapshots', link: '/commands/regen_snapshots' },
