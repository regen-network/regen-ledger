...
func newTableBuilder(prefixData byte, storeKey storetypes.StoreKey, model codec.ProtoMarshaler, cdc codec.Codec) (*tableBuilder, error) {
	if model == nil {
...
func TestTableBuilder(prefixData byte, storeKey storetypes.StoreKey, model codec.ProtoMarshaler, cdc codec.Codec) (*tableBuilder, error) {
...
func (a tableBuilder) StoreKey() storetypes.StoreKey {
	return a.storeKey
}
