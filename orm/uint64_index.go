...
// func NewUInt64Index(builder Indexable, prefix byte, indexerF UInt64IndexerFunc) (UInt64Index, error) {
// 	indexer, err := NewIndexer(UInt64MultiKeyAdapter(indexerF))
// 	if err != nil {
// 		return UInt64Index{}, err
// 	}
// 	indexKeyCodec := FixLengthIndexKeyCodec{}
// 	multiKeyIndex, err := newIndex(builder, prefix, indexer, indexKeyCodec)
// 	if err != nil {
// 		return UInt64Index{}, err
// 	}
// 	return UInt64Index{
