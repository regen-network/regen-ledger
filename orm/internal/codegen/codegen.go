...
const (
	...
	ormListPkg  = protogen.GoImportPath("github.com/regen-network/regen-ledger/orm/model/ormlist")
	ormErrPkg   = protogen.GoImportPath("github.com/regen-network/regen-ledger/orm/types/ormerrors")
