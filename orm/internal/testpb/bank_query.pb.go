...
func (x *ListBalanceRequest) GetPrefixQuery() *ListBalanceRequest_IndexKey {
	if x != nil {
		if x, ok := x.Query.(*ListBalanceRequest_PrefixQuery); ok {
...
func (x *ListBalanceRequest) GetRangeQuery() *ListBalanceRequest_RangeQuery {
	if x != nil {
		if x, ok := x.Query.(*ListBalanceRequest_RangeQuery_); ok {
			return x.RangeQuery
		}
	}
	return nil
...
func (x *ListSupplyRequest) GetPrefixQuery() *ListSupplyRequest_IndexKey {
	if x != nil {
		if x, ok := x.Query.(*ListSupplyRequest_PrefixQuery); ok {
			return x.PrefixQuery
		}
	}
	return nil
...
func (x *ListSupplyRequest) GetRangeQuery() *ListSupplyRequest_RangeQuery {
	if x != nil {
		if x, ok := x.Query.(*ListSupplyRequest_RangeQuery_); ok {
			return x.RangeQuery
		}
	}
	return nil
...
func (x *ListBalanceRequest_IndexKey) GetKey() isListBalanceRequest_IndexKey_Key {
	if x != nil {
		return x.Key
	}
	return nil
...
func (x *ListBalanceRequest_IndexKey) GetAddressDenom() *ListBalanceRequest_IndexKey_AddressDenom {
	if x != nil {
		if x, ok := x.Key.(*ListBalanceRequest_IndexKey_AddressDenom_); ok {
...
func (x *ListBalanceRequest_IndexKey) GetDenom() *ListBalanceRequest_IndexKey_Denom {
	if x != nil {
		if x, ok := x.Key.(*ListBalanceRequest_IndexKey_Denom_); ok {
			return x.Denom
		}
	}
	return nil
...
func (x *ListSupplyRequest_IndexKey) GetKey() isListSupplyRequest_IndexKey_Key {
	if x != nil {
		return x.Key
	}
	return nil
...
func (x *ListSupplyRequest_IndexKey) GetDenom() *ListSupplyRequest_IndexKey_Denom {
	if x != nil {
		if x, ok := x.Key.(*ListSupplyRequest_IndexKey_Denom_); ok {
			return x.Denom
		}
	}
	return nil
...
var file_testpb_bank_query_proto_rawDesc = string([]byte{
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x8f, 0x01, 0x0a, 0x0a, 0x63, 0x6f, 0x6d, 0x2e,
...
var (
	...
	file_testpb_bank_query_proto_rawDescData []byte
)

func file_testpb_bank_query_proto_rawDescGZIP() []byte {
	file_testpb_bank_query_proto_rawDescOnce.Do(func() {
		file_testpb_bank_query_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_testpb_bank_query_proto_rawDesc), len(file_testpb_bank_query_proto_rawDesc)))
	})
	return file_testpb_bank_query_proto_rawDescData
}

var file_testpb_bank_query_proto_msgTypes = make([]protoimpl.MessageInfo, 15)
var file_testpb_bank_query_proto_goTypes = []any{
...
func file_testpb_bank_query_proto_init() {
	...
	file_testpb_bank_query_proto_msgTypes[2].OneofWrappers = []any{
		(*ListBalanceRequest_PrefixQuery)(nil),
		(*ListBalanceRequest_RangeQuery_)(nil),
	}
	file_testpb_bank_query_proto_msgTypes[6].OneofWrappers = []any{
		(*ListSupplyRequest_PrefixQuery)(nil),
		(*ListSupplyRequest_RangeQuery_)(nil),
	}
	file_testpb_bank_query_proto_msgTypes[8].OneofWrappers = []any{
		(*ListBalanceRequest_IndexKey_AddressDenom_)(nil),
		(*ListBalanceRequest_IndexKey_Denom_)(nil),
	}
	file_testpb_bank_query_proto_msgTypes[10].OneofWrappers = []any{}
	file_testpb_bank_query_proto_msgTypes[11].OneofWrappers = []any{}
	file_testpb_bank_query_proto_msgTypes[12].OneofWrappers = []any{
		(*ListSupplyRequest_IndexKey_Denom_)(nil),
	}
	file_testpb_bank_query_proto_msgTypes[14].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_testpb_bank_query_proto_rawDesc), len(file_testpb_bank_query_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   15,
			NumExtensions: 0,
			NumServices:   1,
